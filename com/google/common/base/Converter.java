...
/*     */   {
/* 319 */     return new ConverterComposition(this, (Converter)Preconditions.checkNotNull(secondConverter));
/*     */   }
/*     */   
...
/*     */     {
/* 352 */       return (C)this.second.correctedDoForward(this.first.correctedDoForward(a));
/*     */     }
/*     */     
/*     */ 
/*     */     A correctedDoBackward(C c)
/*     */     {
/* 358 */       return (A)this.first.correctedDoBackward(this.second.correctedDoBackward(c));
/*     */     }
/*     */     
/*     */     public boolean equals(Object object)
/*     */     {
...
/*     */   {
/* 428 */     return new FunctionBasedConverter(forwardFunction, backwardFunction, null);
/*     */   }
/*     */   
...
/*     */     {
/* 439 */       this.forwardFunction = ((Function)Preconditions.checkNotNull(forwardFunction));
/* 440 */       this.backwardFunction = ((Function)Preconditions.checkNotNull(backwardFunction));
/*     */     }
/*     */     
/*     */     protected B doForward(A a)
/*     */     {
/* 445 */       return (B)this.forwardFunction.apply(a);
/*     */     }
/*     */     
/*     */     protected A doBackward(B b)
/*     */     {
/* 450 */       return (A)this.backwardFunction.apply(b);
/*     */     }
/*     */     
/*     */     public boolean equals(Object object)
/*     */     {
...
/* 457 */         return (this.forwardFunction.equals(that.forwardFunction)) && 
/* 458 */           (this.backwardFunction.equals(that.backwardFunction));
/*     */       }
/* 460 */       return false;
/*     */     }
/*     */     
...
/*     */     {
/* 504 */       return (Converter)Preconditions.checkNotNull(otherConverter, "otherConverter");
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\base\Converter.class
