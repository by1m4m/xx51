...
/*  80 */     for (T enumInstance : EnumSet.allOf(enumClass)) {
/*  81 */       result.put(enumInstance.name(), new WeakReference(enumInstance));
/*     */     }
...
/*  91 */       Map<String, WeakReference<? extends Enum<?>>> constants = (Map)enumConstantCache.get(enumClass);
...
/* 117 */       this.enumClass = ((Class)Preconditions.checkNotNull(enumClass));
/*     */     }
/*     */     
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\base\Enums.class
