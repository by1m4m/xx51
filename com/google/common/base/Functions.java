...
/*     */     
/*  69 */     public String apply(Object o) { Preconditions.checkNotNull(o);
...
/*     */     
/*  92 */     public Object apply(Object o) { return o; }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
...
/*     */     
/* 139 */     FunctionForMapNoDefault(Map<K, V> map) { this.map = ((Map)Preconditions.checkNotNull(map)); }
/*     */     
/*     */ 
...
/* 176 */       this.map = ((Map)Preconditions.checkNotNull(map));
...
/*     */ 
/*     */ 
/* 222 */   public static <A, B, C> Function<A, C> compose(Function<B, C> g, Function<A, ? extends B> f) { return new FunctionComposition(g, f); }
/*     */   
...
/* 230 */       this.g = ((Function)Preconditions.checkNotNull(g));
/* 231 */       this.f = ((Function)Preconditions.checkNotNull(f));
/*     */     }
/*     */     
/*     */     public C apply(A a)
/*     */     {
/* 236 */       return (C)this.g.apply(this.f.apply(a));
/*     */     }
/*     */     
...
/*     */   {
/* 271 */     return new PredicateFunction(predicate, null);
/*     */   }
/*     */   
...
/* 279 */       this.predicate = ((Predicate)Preconditions.checkNotNull(predicate));
/*     */     }
/*     */     
...
/*     */     private static final long serialVersionUID = 0L;
/*     */     
/* 325 */     public ConstantFunction(E value) { this.value = value; }
/*     */     
/*     */ 
/*     */     public E apply(Object from)
/*     */     {
/* 330 */       return (E)this.value;
/*     */     }
/*     */     
/*     */     public boolean equals(Object obj)
/*     */     {
...
/*     */   {
/* 363 */     return new SupplierFunction(supplier, null);
/*     */   }
/*     */   
...
/* 372 */       this.supplier = ((Supplier)Preconditions.checkNotNull(supplier));
/*     */     }
/*     */     
/*     */     public T apply(Object input)
/*     */     {
/* 377 */       return (T)this.supplier.get();
/*     */     }
/*     */     
/*     */     public boolean equals(Object obj)
/*     */     {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\base\Functions.class
