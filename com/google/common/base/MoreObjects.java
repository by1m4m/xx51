...
/*     */   {
/* 105 */     return new ToStringHelper(self.getClass().getSimpleName(), null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 119 */     return new ToStringHelper(clazz.getSimpleName(), null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 131 */     return new ToStringHelper(className, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/*     */ 
/* 142 */     private final ValueHolder holderHead = new ValueHolder(null);
/* 143 */     private ValueHolder holderTail = this.holderHead;
/* 144 */     private boolean omitNullValues = false;
/*     */     
/*     */     private ToStringHelper(String className)
/*     */     {
/* 148 */       this.className = ((String)Preconditions.checkNotNull(className));
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/* 337 */       for (ValueHolder valueHolder = this.holderHead.next; 
...
/* 361 */       ValueHolder valueHolder = new ValueHolder(null);
...
/* 375 */       valueHolder.name = ((String)Preconditions.checkNotNull(name));
/* 376 */       return this;
/*     */     }
/*     */     
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\base\MoreObjects.class
