...
/*     */   {
/*  94 */     return new AndPredicate(defensiveCopy(components), null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 115 */     return new AndPredicate(asList((Predicate)Preconditions.checkNotNull(first), (Predicate)Preconditions.checkNotNull(second)), null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 126 */     return new OrPredicate(defensiveCopy(components), null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 138 */     return new OrPredicate(defensiveCopy(components), null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 147 */     return new OrPredicate(asList((Predicate)Preconditions.checkNotNull(first), (Predicate)Preconditions.checkNotNull(second)), null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 155 */     return target == null ? isNull() : new IsEqualToPredicate(target, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 173 */     return new InstanceOfPredicate(clazz, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 193 */     return new SubtypeOfPredicate(clazz, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 208 */     return new InPredicate(target, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 219 */     return new CompositionPredicate(predicate, function, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 311 */       this.predicate = ((Predicate)Preconditions.checkNotNull(predicate));
/*     */     }
/*     */     
...
/* 353 */         if (!((Predicate)this.components.get(i)).apply(t)) {
/* 354 */           return false;
/*     */         }
/*     */       }
/* 357 */       return true;
...
/* 395 */         if (((Predicate)this.components.get(i)).apply(t)) {
/* 396 */           return true;
/*     */         }
/*     */       }
/* 399 */       return false;
...
/*     */     {
/* 479 */       this.clazz = ((Class)Preconditions.checkNotNull(clazz));
/*     */     }
/*     */     
...
/*     */     {
/* 515 */       this.clazz = ((Class)Preconditions.checkNotNull(clazz));
/*     */     }
/*     */     
...
/*     */     {
/* 550 */       this.target = ((Collection)Preconditions.checkNotNull(target));
/*     */     }
/*     */     
/*     */     public boolean apply(T t)
/*     */     {
...
/*     */     {
/* 590 */       this.p = ((Predicate)Preconditions.checkNotNull(p));
/* 591 */       this.f = ((Function)Preconditions.checkNotNull(f));
/*     */     }
/*     */     
...
/*     */     {
/* 628 */       this.pattern = ((CommonPattern)Preconditions.checkNotNull(pattern));
/*     */     }
/*     */     
...
/*     */ 
/*     */ 
/* 651 */         return (Objects.equal(this.pattern.pattern(), that.pattern.pattern())) && 
/* 652 */           (this.pattern.flags() == that.pattern.flags());
/*     */       }
/* 654 */       return false;
/*     */     }
/*     */     
...
/*     */   {
/* 689 */     return Arrays.asList(new Predicate[] { first, second });
/*     */   }
/*     */   
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\base\Predicates.class
