...
/*     */         
/*  86 */         thread = (Thread)bigThreadConstructor.newInstance(new Object[] { (ThreadGroup)null, finalizer, threadName, 
/*  87 */           Long.valueOf(defaultStackSize), Boolean.valueOf(inheritThreadLocals) });
/*     */       } catch (Throwable t) {
...
/*     */ 
/*     */     }
/* 189 */     while ((reference = this.queue.poll()) != null);
/* 190 */     return true;
/*     */   }
/*     */   
/*     */   private Method getFinalizeReferentMethod()
/*     */   {
/* 195 */     Class<?> finalizableReferenceClass = (Class)this.finalizableReferenceClassReference.get();
...
/*     */   {
/*     */     try {
/* 228 */       return Thread.class.getConstructor(new Class[] { ThreadGroup.class, Runnable.class, String.class, Long.TYPE, Boolean.TYPE });
/*     */     }
/*     */     catch (Throwable t) {}
/*     */     
/* 232 */     return null;
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\base\internal\Finalizer.class
