...
/*     */   Boolean recordStats;
/*     */   
/* 127 */   private CacheBuilderSpec(String specification) { this.specification = specification; }
/*     */   
/*     */   @VisibleForTesting
...
/*     */   
/* 136 */   public static CacheBuilderSpec parse(String cacheBuilderSpecification) { CacheBuilderSpec spec = new CacheBuilderSpec(cacheBuilderSpecification);
...
/* 140 */         Preconditions.checkArgument(!keyAndValue.isEmpty(), "blank key-value pair");
/* 141 */         Preconditions.checkArgument(keyAndValue
/* 142 */           .size() <= 2, "key-value pair %s with more than one equals sign", keyValuePair);
/*     */         
/*     */ 
/*     */ 
/*     */ 
...
/* 259 */     if ((Objects.equal(this.initialCapacity, that.initialCapacity)) && 
...
/*     */   
/* 282 */   private static Long durationInNanos(long duration, TimeUnit unit) { return unit == null ? null : Long.valueOf(unit.toNanos(duration)); }
/*     */   
/*     */   @VisibleForTesting
/*     */   TimeUnit refreshTimeUnit;
/*     */   private final String specification;
/*     */   private static abstract interface ValueParser { public abstract void parse(CacheBuilderSpec paramCacheBuilderSpec, String paramString1, String paramString2); }
/*     */   
...
/*     */     
/* 291 */     public void parse(CacheBuilderSpec spec, String key, String value) { Preconditions.checkArgument((value != null) && (!value.isEmpty()), "value of key %s omitted", key);
/*     */       try {
/* 293 */         parseInteger(spec, Integer.parseInt(value));
/*     */       }
/*     */       catch (NumberFormatException e) {
/* 296 */         throw new IllegalArgumentException(CacheBuilderSpec.format("key %s value set to %s, must be integer", new Object[] { key, value }), e);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */       }
/*     */       catch (NumberFormatException e) {
/* 312 */         throw new IllegalArgumentException(CacheBuilderSpec.format("key %s value set to %s, must be integer", new Object[] { key, value }), e);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */     public void parse(CacheBuilderSpec spec, String key, String value)
/*     */     {
/* 414 */       Preconditions.checkArgument((value != null) && (!value.isEmpty()), "value of key %s omitted", key);
/*     */       try {
/* 416 */         char lastChar = value.charAt(value.length() - 1);
/*     */         TimeUnit timeUnit;
/* 418 */         TimeUnit timeUnit; TimeUnit timeUnit; TimeUnit timeUnit; switch (lastChar) {
/*     */         case 'd': 
...
/*     */         
/*     */         default: 
/* 433 */           throw new IllegalArgumentException(CacheBuilderSpec.format("key %s invalid format.  was %s, must end with one of [dDhHmMsS]", new Object[] { key, value }));
/*     */         }
/*     */         
/*     */         TimeUnit timeUnit;
...
/*     */       }
/*     */       catch (NumberFormatException e) {
/* 441 */         throw new IllegalArgumentException(CacheBuilderSpec.format("key %s value set to %s, must be integer", new Object[] { key, value }));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\cache\CacheBuilderSpec.class
