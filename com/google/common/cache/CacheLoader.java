...
/* 160 */       this.computingFunction = ((Function)Preconditions.checkNotNull(computingFunction));
/*     */     }
/*     */     
/*     */     public V load(K key)
/*     */     {
...
/* 188 */         return (V)this.val$loader.load(key);
/*     */       }
/*     */       
...
/*     */           {
/* 198 */             return (V)CacheLoader.1.this.val$loader.reload(key, oldValue).get();
/*     */           }
/* 200 */         });
...
/*     */       {
/* 207 */         return this.val$loader.loadAll(keys);
/*     */       }
/*     */     };
/*     */   }
/*     */   
...
/* 217 */       this.computingSupplier = ((Supplier)Preconditions.checkNotNull(computingSupplier));
/*     */     }
/*     */     
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\cache\CacheLoader.class
