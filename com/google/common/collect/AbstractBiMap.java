...
/*     */   {
/* 119 */     return (V)putInBothMaps(key, value, false);
/*     */   }
/*     */   
/*     */   @CanIgnoreReturnValue
/*     */   public V forcePut(K key, V value)
/*     */   {
/* 125 */     return (V)putInBothMaps(key, value, true);
/*     */   }
/*     */   
...
/*     */     }
/* 149 */     this.inverse.delegate.put(newValue, key);
/*     */   }
/*     */   
/*     */   @CanIgnoreReturnValue
/*     */   public V remove(Object key)
/*     */   {
/* 155 */     return (V)(containsKey(key) ? removeFromBothMaps(key) : null);
/*     */   }
/*     */   
/*     */   @CanIgnoreReturnValue
...
/* 185 */       Map.Entry<K, V> entry = (Map.Entry)itr.next();
/* 186 */       K k = entry.getKey();
/* 187 */       V v = entry.getValue();
/* 188 */       K conflict = this.inverse.delegate.putIfAbsent(v, k);
...
/* 219 */     return result == null ? (this.keySet = new KeySet(null)) : result;
/*     */   }
/*     */   
...
/* 268 */     return result == null ? (this.valueSet = new ValueSet(null)) : result;
/*     */   }
/*     */   
...
/*     */     private ValueSet() {}
/*     */     
/* 277 */     protected Set<V> delegate() { return this.valuesDelegate; }
/*     */     
/*     */ 
...
/*     */     {
/* 292 */       return standardToArray(array);
/*     */     }
/*     */     
...
/* 306 */     return result == null ? (this.entrySet = new EntrySet(null)) : result;
/*     */   }
/*     */   
...
/*     */       {
/* 350 */         this.entry = ((Map.Entry)iterator.next());
/* 351 */         return new AbstractBiMap.BiMapEntry(AbstractBiMap.this, this.entry);
/*     */       }
/*     */       
/*     */       public void remove()
/*     */       {
...
/*     */     private EntrySet() {}
/*     */     
/* 371 */     protected Set<Map.Entry<K, V>> delegate() { return this.esDelegate; }
/*     */     
/*     */ 
/*     */     public void clear()
/*     */     {
...
/*     */     public <T> T[] toArray(T[] array)
/*     */     {
/* 411 */       return standardToArray(array);
/*     */     }
/*     */     
...
/*     */ 
/*     */ 
/* 431 */     public boolean retainAll(Collection<?> c) { return standardRetainAll(c); }
/*     */   }
/*     */   
...
/*     */     private static final long serialVersionUID = 0L;
/*     */     
/* 438 */     Inverse(Map<K, V> backward, AbstractBiMap<V, K> forward) { super(forward, null); }
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */     K checkKey(K key)
/*     */     {
/* 452 */       return (K)this.inverse.checkValue(key);
/*     */     }
/*     */     
/*     */     V checkValue(V value)
/*     */     {
/* 457 */       return (V)this.inverse.checkKey(value);
/*     */     }
/*     */     
/*     */     @GwtIncompatible
...
/* 471 */       setInverse((AbstractBiMap)stream.readObject());
/*     */     }
/*     */     
/*     */     @GwtIncompatible
/*     */     Object readResolve() {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\AbstractBiMap.class
