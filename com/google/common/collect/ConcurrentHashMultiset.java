...
/*     */     
/* 408 */     AtomicInteger existingCounter = (AtomicInteger)Maps.safeGet(this.countMap, element);
...
/* 428 */         return (this.countMap.putIfAbsent(element, newCounter) == null) || 
/* 429 */           (this.countMap.replace(element, existingCounter, newCounter));
/*     */       }
/*     */       
...
/*     */   {
/* 504 */     final Iterator<Multiset.Entry<E>> readOnlyIterator = new AbstractIterator()
/*     */     {
/*     */ 
/* 507 */       private final Iterator<Map.Entry<E, AtomicInteger>> mapEntries = ConcurrentHashMultiset.this.countMap.entrySet().iterator();
/*     */       
/*     */       protected Multiset.Entry<E> computeNext()
/*     */       {
/*     */         for (;;) {
/* 512 */           if (!this.mapEntries.hasNext()) {
/* 513 */             return (Multiset.Entry)endOfData();
/*     */           }
/* 515 */           Map.Entry<E, AtomicInteger> mapEntry = (Map.Entry)this.mapEntries.next();
...
/*     */       {
/* 534 */         this.last = ((Multiset.Entry)super.next());
...
/*     */     
/*     */ 
/* 597 */     ConcurrentMap<E, Integer> deserializedCountMap = (ConcurrentMap)stream.readObject();
/* 598 */     FieldSettersHolder.COUNT_MAP_FIELD_SETTER.set(this, deserializedCountMap);
/*     */   }
/*     */ }


/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\ConcurrentHashMultiset.class
