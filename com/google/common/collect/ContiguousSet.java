...
/*  67 */         effectiveRange = effectiveRange.intersection(Range.atLeast(domain.minValue()));
/*     */       }
/*  69 */       if (!range.hasUpperBound()) {
/*  70 */         effectiveRange = effectiveRange.intersection(Range.atMost(domain.maxValue()));
/*     */       }
...
/*     */ 
/*     */ 
/*  79 */     boolean empty = (effectiveRange.isEmpty()) || (Range.compareOrThrow(range.lowerBound
/*  80 */       .leastValueAbove(domain), range.upperBound
...
/*     */   {
/* 150 */     return headSetImpl((Comparable)Preconditions.checkNotNull(toElement), false);
/*     */   }
/*     */   
/*     */ 
/*     */   @GwtIncompatible
...
/*     */   {
/* 157 */     return headSetImpl((Comparable)Preconditions.checkNotNull(toElement), inclusive);
/*     */   }
/*     */   
...
/*     */   {
/* 181 */     return tailSetImpl((Comparable)Preconditions.checkNotNull(fromElement), true);
/*     */   }
/*     */   
/*     */ 
/*     */   @GwtIncompatible
...
/*     */   {
/* 188 */     return tailSetImpl((Comparable)Preconditions.checkNotNull(fromElement), inclusive);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\ContiguousSet.class
