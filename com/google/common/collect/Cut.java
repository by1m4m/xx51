...
/*     */   {
/* 120 */     private static final BelowAll INSTANCE = new BelowAll();
/*     */     private static final long serialVersionUID = 0L;
/*     */     
/* 123 */     private BelowAll() { super(); }
/*     */     
/*     */ 
/*     */     Comparable<?> endpoint()
/*     */     {
...
/* 219 */     private static final AboveAll INSTANCE = new AboveAll();
/*     */     private static final long serialVersionUID = 0L;
/*     */     
/* 222 */     private AboveAll() { super(); }
/*     */     
/*     */ 
/*     */     Comparable<?> endpoint()
/*     */     {
...
/*     */ 
/*     */ 
/* 300 */   static <C extends Comparable> Cut<C> belowValue(C endpoint) { return new BelowValue(endpoint); }
/*     */   
/*     */   private static final class BelowValue<C extends Comparable> extends Cut<C> {
/*     */     private static final long serialVersionUID = 0L;
/*     */     
/* 305 */     BelowValue(C endpoint) { super(); }
/*     */     
/*     */ 
/*     */     boolean isLessThan(C value)
/*     */     {
/* 310 */       return Range.compareOrThrow(this.endpoint, value) <= 0;
/*     */     }
/*     */     
/*     */     BoundType typeAsLowerBound()
/*     */     {
...
/* 327 */         return this;
/*     */       case 2: 
/* 329 */         C previous = domain.previous(this.endpoint);
/* 330 */         return previous == null ? Cut.belowAll() : new Cut.AboveValue(previous);
/*     */       }
...
/*     */     {
/* 338 */       switch (Cut.1.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()]) {
/*     */       case 1: 
/* 340 */         C previous = domain.previous(this.endpoint);
/* 341 */         return previous == null ? Cut.aboveAll() : new Cut.AboveValue(previous);
/*     */       case 2: 
/* 343 */         return this;
/*     */       }
...
/*     */ 
/*     */ 
/* 383 */   static <C extends Comparable> Cut<C> aboveValue(C endpoint) { return new AboveValue(endpoint); }
/*     */   
/*     */   private static final class AboveValue<C extends Comparable> extends Cut<C> {
/*     */     private static final long serialVersionUID = 0L;
/*     */     
/* 388 */     AboveValue(C endpoint) { super(); }
/*     */     
/*     */ 
/*     */     boolean isLessThan(C value)
/*     */     {
/* 393 */       return Range.compareOrThrow(this.endpoint, value) < 0;
/*     */     }
/*     */     
/*     */     BoundType typeAsLowerBound()
/*     */     {
...
/*     */     Cut<C> withLowerBoundType(BoundType boundType, DiscreteDomain<C> domain)
/*     */     {
/* 408 */       switch (Cut.1.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()]) {
/*     */       case 2: 
/* 410 */         return this;
/*     */       case 1: 
/* 412 */         C next = domain.next(this.endpoint);
/* 413 */         return next == null ? Cut.belowAll() : belowValue(next);
/*     */       }
...
/*     */     Cut<C> withUpperBoundType(BoundType boundType, DiscreteDomain<C> domain)
/*     */     {
/* 421 */       switch (Cut.1.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()]) {
/*     */       case 2: 
/* 423 */         C next = domain.next(this.endpoint);
/* 424 */         return next == null ? Cut.aboveAll() : belowValue(next);
/*     */       case 1: 
/* 426 */         return this;
/*     */       }
...
/* 455 */       return next != null ? belowValue(next) : Cut.aboveAll();
/*     */     }
/*     */     
/*     */     public int hashCode()
/*     */     {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\Cut.class
