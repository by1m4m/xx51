...
/* 128 */     return (Iterable)this.iterableDelegate.or(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 139 */     (iterable instanceof FluentIterable) ? (FluentIterable)iterable : new FluentIterable(iterable)
/*     */     {
/*     */ 
...
/*     */   {
/* 174 */     return (FluentIterable)Preconditions.checkNotNull(iterable);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 191 */     return concatNoDefensiveCopy(new Iterable[] { a, b });
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 210 */     return concatNoDefensiveCopy(new Iterable[] { a, b, c });
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 233 */     return concatNoDefensiveCopy(new Iterable[] { a, b, c, d });
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 253 */     return concatNoDefensiveCopy((Iterable[])Arrays.copyOf(inputs, inputs.length));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 274 */     new FluentIterable()
/*     */     {
/*     */       public Iterator<T> iterator() {
/* 277 */         return Iterators.concat(Iterators.transform(this.val$inputs.iterator(), Iterables.toIterator()));
/*     */       }
/*     */     };
/*     */   }
/*     */   
...
/*     */     }
/* 288 */     new FluentIterable()
/*     */     {
/*     */       public Iterator<T> iterator() {
/* 291 */         Iterators.concat(new AbstractIndexedListIterator(this.val$inputs.length)
/*     */         {
/*     */ 
/*     */           public Iterator<? extends T> get(int i)
/*     */           {
/* 296 */             return FluentIterable.3.this.val$inputs[i].iterator();
/*     */           }
/*     */         });
/*     */       }
/*     */     };
...
/* 549 */       SortedSet<E> sortedSet = (SortedSet)iterable;
...
/*     */   {
/* 827 */     return (E)Iterables.get(getDelegate(), position);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\FluentIterable.class
