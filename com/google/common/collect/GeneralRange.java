...
/*     */   {
/*  42 */     T lowerEndpoint = range.hasLowerBound() ? range.lowerEndpoint() : null;
/*  43 */     BoundType lowerBoundType = range.hasLowerBound() ? range.lowerBoundType() : BoundType.OPEN;
/*     */     
/*  45 */     T upperEndpoint = range.hasUpperBound() ? range.upperEndpoint() : null;
...
/*  49 */       .hasLowerBound(), lowerEndpoint, lowerBoundType, range
/*     */       
/*     */ 
/*  52 */       .hasUpperBound(), upperEndpoint, upperBoundType);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 109 */     this.comparator = ((Comparator)Preconditions.checkNotNull(comparator));
...
/*     */       
/* 128 */       if (cmp == 0) {
/* 129 */         Preconditions.checkArgument((lowerBoundType != BoundType.OPEN ? 1 : 0) | (upperBoundType != BoundType.OPEN ? 1 : 0));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* 157 */     return (cmp < 0 ? 1 : 0) | (cmp == 0 ? 1 : 0) & (getLowerBoundType() == BoundType.OPEN ? 1 : 0);
/*     */   }
/*     */   
/*     */   boolean tooHigh(T t) {
...
/* 166 */     return (cmp > 0 ? 1 : 0) | (cmp == 0 ? 1 : 0) & (getUpperBoundType() == BoundType.OPEN ? 1 : 0);
/*     */   }
/*     */   
...
/* 227 */       if ((this.comparator.equals(r.comparator)) && (this.hasLowerBound == r.hasLowerBound) && (this.hasUpperBound == r.hasUpperBound)) {} return 
/*     */       
/*     */ 
...
/*     */ 
/*     */ 
/* 262 */       result = new GeneralRange(Ordering.from(this.comparator).reverse(), this.hasUpperBound, getUpperEndpoint(), getUpperBoundType(), this.hasLowerBound, getLowerEndpoint(), getLowerBoundType());
...
/*     */   {
/* 271 */     return this.comparator + ":" + (this.lowerBoundType == BoundType.CLOSED ? '[' : '(') + (this.hasLowerBound ? this.lowerEndpoint : "-∞") + ',' + (this.hasUpperBound ? this.upperEndpoint : "∞") + (this.upperBoundType == BoundType.CLOSED ? ']' : ')');
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   T getLowerEndpoint()
/*     */   {
/* 281 */     return (T)this.lowerEndpoint;
/*     */   }
/*     */   
...
/*     */   
/*     */   T getUpperEndpoint() {
/* 289 */     return (T)this.upperEndpoint;
/*     */   }
/*     */   
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\GeneralRange.class
