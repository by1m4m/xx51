...
/*     */       }
/*  84 */       return new Interners.InternerImpl(this.mapMaker, null);
/*     */     }
/*     */   }
/*     */   
/*     */   public static InternerBuilder newBuilder()
/*     */   {
/*  90 */     return new InternerBuilder(null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 120 */       this.map = MapMakerInternalMap.createWithDummyValues(mapMaker.keyEquivalence(Equivalence.equals()));
/*     */     }
/*     */     
...
/*     */       for (;;)
/*     */       {
/* 127 */         MapMakerInternalMap.InternalEntry<E, MapMaker.Dummy, ?> entry = this.map.getEntry(sample);
/* 128 */         if (entry != null) {
...
/*     */         
/*     */ 
/* 136 */         MapMaker.Dummy sneaky = (MapMaker.Dummy)this.map.putIfAbsent(sample, MapMaker.Dummy.VALUE);
/* 137 */         if (sneaky == null) {
/* 138 */           return sample;
/*     */         }
/*     */       }
...
/*     */   {
/* 157 */     return new InternerFunction((Interner)Preconditions.checkNotNull(interner));
/*     */   }
/*     */   
...
/*     */     {
/* 170 */       return (E)this.interner.intern(input);
/*     */     }
/*     */     
/*     */     public int hashCode()
/*     */     {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\Interners.class
