...
/*  40 */       if (oldValue != null) {
/*  41 */         throw conflictException("key", e.getKey() + "=" + oldValue, entryArray[i]);
/*     */       }
/*  43 */       K oldKey = backwardDelegate.putIfAbsent(e.getValue(), e.getKey());
/*  44 */       if (oldKey != null) {
/*  45 */         throw conflictException("value", oldKey + "=" + e.getValue(), entryArray[i]);
/*     */       }
/*     */     }
/*  48 */     ImmutableList<Map.Entry<K, V>> entryList = ImmutableList.asImmutableList(entryArray, n);
...
/*  73 */     if (result == null) {
/*  74 */       this.inverse = (result = new JdkBackedImmutableBiMap(new InverseEntries(null), this.backwardDelegate, this.forwardDelegate));
/*     */       
/*     */ 
/*     */ 
...
/*  87 */       Map.Entry<K, V> entry = (Map.Entry)JdkBackedImmutableBiMap.this.entries.get(index);
...
/*     */   {
/* 104 */     return (V)this.forwardDelegate.get(key);
/*     */   }
/*     */   
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\JdkBackedImmutableBiMap.class
