...
/*    */   {
/* 39 */     Multiset.Entry<E>[] entriesArray = (Multiset.Entry[])entries.toArray(new Multiset.Entry[0]);
/* 40 */     Map<E, Integer> delegateMap = Maps.newHashMapWithExpectedSize(entriesArray.length);
/* 41 */     long size = 0L;
/* 42 */     for (int i = 0; i < entriesArray.length; i++) {
/* 43 */       Multiset.Entry<E> entry = entriesArray[i];
/* 44 */       int count = entry.getCount();
/* 45 */       size += count;
/* 46 */       E element = Preconditions.checkNotNull(entry.getElement());
...
/* 53 */       ImmutableList.asImmutableList(entriesArray), size);
/*    */   }
/*    */   
...
/*    */   {
/* 78 */     return (Multiset.Entry)this.entries.get(index);
/*    */   }
/*    */   
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\JdkBackedImmutableMultiset.class
