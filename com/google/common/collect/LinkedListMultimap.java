...
/*     */     public K getKey()
/*     */     {
/* 123 */       return (K)this.key;
/*     */     }
/*     */     
/*     */     public V getValue()
/*     */     {
/* 128 */       return (V)this.value;
/*     */     }
/*     */     
...
/* 221 */       this.tail = node;
/* 222 */       KeyList<K, V> keyList = (KeyList)this.keyToKeyList.get(key);
/* 223 */       if (keyList == null) {
...
/*     */       }
/*     */     } else {
/* 234 */       KeyList<K, V> keyList = (KeyList)this.keyToKeyList.get(key);
/* 235 */       keyList.count += 1;
...
/* 273 */       KeyList<K, V> keyList = (KeyList)this.keyToKeyList.remove(node.key);
/* 274 */       keyList.count = 0;
/* 275 */       this.modCount += 1;
/*     */     } else {
/* 277 */       KeyList<K, V> keyList = (KeyList)this.keyToKeyList.get(node.key);
/* 278 */       keyList.count -= 1;
/*     */       
...
/* 316 */       int size = LinkedListMultimap.this.size();
/* 317 */       Preconditions.checkPositionIndex(index, size);
/* 318 */       if (index >= size / 2) {
/* 319 */         this.previous = LinkedListMultimap.this.tail;
/* 320 */         this.nextIndex = size;
/* 321 */         while (index++ < size) {
/* 322 */           previous();
/*     */         }
/*     */       }
/* 325 */       this.next = LinkedListMultimap.this.head;
/* 326 */       while (index-- > 0) {
/* 327 */         next();
/*     */       }
/*     */       
...
/* 409 */       Preconditions.checkState(this.current != null);
/* 410 */       this.current.value = value;
/*     */     }
/*     */   }
/*     */   
/*     */   private class DistinctKeyIterator implements Iterator<K> { private DistinctKeyIterator() {}
/*     */     
...
/*     */     {
/* 465 */       this.key = key;
/* 466 */       LinkedListMultimap.KeyList<K, V> keyList = (LinkedListMultimap.KeyList)LinkedListMultimap.this.keyToKeyList.get(key);
...
/*     */     {
/* 479 */       LinkedListMultimap.KeyList<K, V> keyList = (LinkedListMultimap.KeyList)LinkedListMultimap.this.keyToKeyList.get(key);
...
/* 509 */       this.nextIndex += 1;
/* 510 */       return (V)this.current.value;
/*     */     }
/*     */     
/*     */     public boolean hasPrevious()
/*     */     {
...
/* 524 */       this.nextIndex -= 1;
/* 525 */       return (V)this.current.value;
/*     */     }
/*     */     
/*     */     public int nextIndex()
/*     */     {
...
/*     */     {
/* 560 */       this.previous = LinkedListMultimap.this.addNode(this.key, value, this.next);
/* 561 */       this.nextIndex += 1;
...
/*     */   {
/* 680 */     new AbstractSequentialList()
/*     */     {
/*     */       public int size() {
/* 683 */         LinkedListMultimap.KeyList<K, V> keyList = (LinkedListMultimap.KeyList)LinkedListMultimap.this.keyToKeyList.get(key);
/* 684 */         return keyList == null ? 0 : keyList.count;
/*     */       }
/*     */       
/*     */       public ListIterator<V> listIterator(int index)
/*     */       {
/* 689 */         return new LinkedListMultimap.ValueForKeyIterator(LinkedListMultimap.this, key, index);
/*     */       }
/*     */     };
/*     */   }
/*     */   
...
/*     */   Set<K> createKeySet()
/*     */   {
/* 718 */     new Sets.ImprovedAbstractSet()
/*     */     {
/*     */       public int size()
/*     */       {
...
/*     */       {
/* 705 */         return new LinkedListMultimap.DistinctKeyIterator(LinkedListMultimap.this, null);
/*     */       }
/*     */       
...
/*     */   List<V> createValues()
/*     */   {
/* 764 */     new AbstractSequentialList()
/*     */     {
/*     */       public int size()
/*     */       {
...
/*     */       public ListIterator<V> listIterator(int index)
/*     */       {
/* 750 */         final LinkedListMultimap<K, V>.NodeIterator nodeItr = new LinkedListMultimap.NodeIterator(LinkedListMultimap.this, index);
/* 751 */         new TransformedListIterator(nodeItr)
/*     */         {
/*     */           V transform(Map.Entry<K, V> entry) {
/* 754 */             return (V)entry.getValue();
/*     */           }
/*     */           
/*     */           public void set(V value)
/*     */           {
...
/*     */   {
/* 810 */     new AbstractSequentialList()
/*     */     {
/*     */       public int size()
/*     */       {
...
/*     */       {
/* 799 */         return new LinkedListMultimap.NodeIterator(LinkedListMultimap.this, index);
/*     */       }
/*     */       
...
/*     */     {
/* 845 */       K key = stream.readObject();
/*     */       
/* 847 */       V value = stream.readObject();
/* 848 */       put(key, value);
/*     */     }
/*     */   }
/*     */ }
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\LinkedListMultimap.class
