...
/*     */   {
/* 109 */     return new Builder(Ordering.natural(), null).create();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 118 */     return new Builder(Ordering.natural(), null).create(initialContents);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 126 */     return new Builder(comparator, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 134 */     return new Builder(Ordering.natural(), null).expectedSize(expectedSize);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 144 */     return new Builder(Ordering.natural(), null).maximumSize(maximumSize);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 170 */       this.comparator = ((Comparator)Preconditions.checkNotNull(comparator));
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 212 */       MinMaxPriorityQueue<T> queue = new MinMaxPriorityQueue(this, MinMaxPriorityQueue.initialQueueSize(this.expectedSize, this.maximumSize, initialContents), null);
...
/*     */     }
/* 370 */     return (E)removeAndGet(getMaxElementIndex());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 432 */     MinMaxPriorityQueue<E>.Heap heap = heapForIndex(index);
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/* 774 */         return (E)MinMaxPriorityQueue.this.elementData(this.cursor); }
...
/* 780 */           return (E)this.lastFromForgetMeNot;
/*     */         }
/*     */       }
...
/*     */   {
/* 880 */     return new QueueIterator(null);
/*     */   }
/*     */   
/*     */   public void clear()
/*     */   {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\MinMaxPriorityQueue.class
