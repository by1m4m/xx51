...
/* 137 */             return false;
/*     */           }
/* 139 */           current = thisIterator.next();
/* 140 */         } else if (cmp == 0) {
/* 141 */           if (!thatIterator.hasNext()) {
/* 142 */             return true;
/*     */           }
/* 144 */           target = thatIterator.next();
/*     */         }
/* 146 */         else if (cmp > 0) {
/* 147 */           return false;
/*     */         }
...
/* 156 */     return Collections.binarySearch(this.elements, key, unsafeComparator());
/*     */   }
/*     */   
...
/*     */     }
/* 211 */     return (E)this.elements.get(0);
/*     */   }
/*     */   
/*     */   public E last()
/*     */   {
...
/*     */     }
/* 219 */     return (E)this.elements.get(size() - 1);
/*     */   }
/*     */   
...
/* 252 */     int index = Collections.binarySearch(this.elements, Preconditions.checkNotNull(toElement), comparator());
/* 253 */     if (index >= 0) {
...
/* 272 */     int index = Collections.binarySearch(this.elements, Preconditions.checkNotNull(fromElement), comparator());
/* 273 */     if (index >= 0) {
...
/*     */     try
/*     */     {
/* 306 */       position = Collections.binarySearch(this.elements, target, unsafeComparator());
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\RegularImmutableSortedSet.class
