...
/*     */     {
/*  83 */       K key = stream.readObject();
/*     */       
/*  85 */       V value = stream.readObject();
...
/*     */     {
/* 127 */       E element = stream.readObject();
...
/* 144 */     for (Map.Entry<K, Collection<V>> entry : multimap.asMap().entrySet()) {
/* 145 */       stream.writeObject(entry.getKey());
/* 146 */       stream.writeInt(((Collection)entry.getValue()).size());
/* 147 */       for (V value : (Collection)entry.getValue()) {
...
/* 188 */       return new FieldSetter(field, null);
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\Serialization.class
