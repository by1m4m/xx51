...
/*     */   {
/*  95 */     return new TreeMultimap((Comparator)Preconditions.checkNotNull(keyComparator), (Comparator)Preconditions.checkNotNull(valueComparator));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 167 */     return (NavigableSet)super.get(key);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 181 */     return (NavigableSet)super.keySet();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 195 */     return (NavigableMap)super.asMap();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 214 */     this.keyComparator = ((Comparator)Preconditions.checkNotNull((Comparator)stream.readObject()));
/* 215 */     this.valueComparator = ((Comparator)Preconditions.checkNotNull((Comparator)stream.readObject()));
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\TreeMultimap.class
