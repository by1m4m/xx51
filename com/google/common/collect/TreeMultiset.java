...
/*      */     {
/*  236 */       E e = (E)element;
/*  237 */       AvlNode<E> root = (AvlNode)this.rootReference.get();
...
/*  255 */     AvlNode<E> root = (AvlNode)this.rootReference.get();
/*  256 */     if (root == null) {
/*  257 */       comparator().compare(element, element);
/*  258 */       AvlNode<E> newRoot = new AvlNode(element, occurrences);
/*  259 */       successor(this.header, newRoot, this.header);
/*  260 */       this.rootReference.checkAndSet(root, newRoot);
/*  261 */       return 0;
/*      */     }
...
/*      */     }
/*  276 */     AvlNode<E> root = (AvlNode)this.rootReference.get();
...
/*      */     } catch (ClassCastException|NullPointerException e) { AvlNode<E> newRoot;
/*  287 */       return 0; }
/*      */     AvlNode<E> newRoot;
...
/*  364 */     new Multisets.AbstractEntry()
/*      */     {
/*      */       public E getElement() {
/*  367 */         return (E)baseEntry.getElement();
/*      */       }
/*      */       
/*      */       public int getCount()
/*      */       {
...
/*      */   {
/*  384 */     AvlNode<E> root = (AvlNode)this.rootReference.get();
/*  385 */     if (root == null) {
/*  386 */       return null;
/*      */     }
/*      */     AvlNode<E> node;
...
/*  391 */       AvlNode<E> node = ((AvlNode)this.rootReference.get()).ceiling(comparator(), endpoint);
/*  392 */       if (node == null) {
/*  393 */         return null;
/*      */       }
...
/*  406 */     AvlNode<E> root = (AvlNode)this.rootReference.get();
/*  407 */     if (root == null) {
/*  408 */       return null;
/*      */     }
/*      */     AvlNode<E> node;
...
/*  413 */       AvlNode<E> node = ((AvlNode)this.rootReference.get()).floor(comparator(), endpoint);
/*  414 */       if (node == null) {
/*  415 */         return null;
/*      */       }
...
/*  520 */         (node != this.header) && (node != null) && (!this.range.tooHigh(node.getElement())); 
/*  521 */         node = node.succ) {
...
/*  728 */           this.distinctElements -= 1;
/*  729 */         } else if ((count > 0) && (result[0] == 0)) {
/*  730 */           this.distinctElements += 1;
/*      */         }
/*      */         
...
/*  745 */           this.distinctElements -= 1;
/*  746 */         } else if ((count > 0) && (result[0] == 0)) {
/*  747 */           this.distinctElements += 1;
/*      */         }
/*      */         
...
/*  785 */             this.distinctElements -= 1;
/*  786 */           } else if ((newCount > 0) && (result[0] == 0)) {
/*  787 */             this.distinctElements += 1;
/*      */           }
...
/*  836 */         AvlNode<E> newTop = this.pred;
/*      */         
/*  838 */         newTop.left = this.left.removeMax(newTop);
/*  839 */         newTop.right = this.right;
/*  840 */         this.distinctElements -= 1;
...
/*      */     {
/*  879 */       this.distinctElements = (1 + TreeMultiset.distinctElements(this.left) + TreeMultiset.distinctElements(this.right));
...
/*  948 */       if (cmp < 0)
/*  949 */         return this.left == null ? this : (AvlNode)MoreObjects.firstNonNull(this.left.ceiling(comparator, e), this);
/*  950 */       if (cmp == 0) {
/*  951 */         return this;
/*      */       }
...
/*  959 */       if (cmp > 0)
/*  960 */         return this.right == null ? this : (AvlNode)MoreObjects.firstNonNull(this.right.floor(comparator, e), this);
/*  961 */       if (cmp == 0) {
/*  962 */         return this;
/*      */       }
...
/*      */     
/*      */ 
/* 1014 */     Comparator<? super E> comparator = (Comparator)stream.readObject();
...
/* 1019 */       .set(this, new Reference(null));
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\collect\TreeMultiset.class
