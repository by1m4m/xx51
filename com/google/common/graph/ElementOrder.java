...
/*     */     private Type() {} }
/*     */   
/*  71 */   private ElementOrder(Type type, Comparator<T> comparator) { this.type = ((Type)Preconditions.checkNotNull(type));
/*  72 */     this.comparator = comparator;
/*  73 */     Preconditions.checkState((type == Type.SORTED ? 1 : 0) == (comparator != null ? 1 : 0));
/*     */   }
/*     */   
...
/*     */   {
/*  90 */     return new ElementOrder(Type.SORTED, Ordering.natural());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\graph\ElementOrder.class
