...
/*  66 */     Multiset<N> adjacentNodes = (Multiset)getReference(this.adjacentNodesReference);
/*  67 */     if (adjacentNodes == null) {
/*  68 */       adjacentNodes = HashMultiset.create(this.incidentEdgeMap.values());
/*  69 */       this.adjacentNodesReference = new SoftReference(adjacentNodes);
/*     */     }
...
/*     */   {
/*  76 */     new MultiEdgesConnecting(this.incidentEdgeMap, node)
/*     */     {
/*     */       public int size() {
...
/*     */   {
/*  86 */     if (!isSelfLoop) {
/*  87 */       return (N)removeOutEdge(edge);
/*     */     }
/*  89 */     return null;
/*     */   }
/*     */   
...
/*  95 */     Multiset<N> adjacentNodes = (Multiset)getReference(this.adjacentNodesReference);
...
/* 112 */     Multiset<N> adjacentNodes = (Multiset)getReference(this.adjacentNodesReference);
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\graph\UndirectedMultiNetworkConnections.class
