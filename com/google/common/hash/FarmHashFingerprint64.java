...
/* 128 */       long a = LittleEndianByteArray.load32(bytes, offset) & 0xFFFFFFFF;
/* 129 */       return hashLength16(length + (a << 3), LittleEndianByteArray.load32(bytes, offset + length - 4) & 0xFFFFFFFF, mul);
/*     */     }
/* 131 */     if (length > 0) {
...
/* 198 */     long mul = -5435081209227447693L + ((z & 0xFF) << 1);
/*     */     
/* 200 */     offset = last64offset;
/* 201 */     w[0] += (length - 1 & 0x3F);
/* 202 */     v[0] += w[0];
/* 203 */     w[0] += v[0];
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\hash\FarmHashFingerprint64.class
