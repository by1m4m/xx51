...
/*     */     
/* 124 */     IntHashCode(int hash) { this.hash = hash; }
/*     */     
/*     */ 
/*     */     public int bits()
/*     */     {
...
/*     */     private static final long serialVersionUID = 0L;
/*     */     
/* 181 */     LongHashCode(long hash) { this.hash = hash; }
/*     */     
/*     */ 
/*     */     public int bits()
/*     */     {
...
/*     */     public byte[] asBytes()
/*     */     {
/* 191 */       return new byte[] { (byte)(int)this.hash, (byte)(int)(this.hash >> 8), (byte)(int)(this.hash >> 16), (byte)(int)(this.hash >> 24), (byte)(int)(this.hash >> 32), (byte)(int)(this.hash >> 40), (byte)(int)(this.hash >> 48), (byte)(int)(this.hash >> 56) };
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     private static final long serialVersionUID = 0L;
/*     */     
/* 256 */     BytesHashCode(byte[] bytes) { this.bytes = ((byte[])Preconditions.checkNotNull(bytes)); }
/*     */     
/*     */ 
/*     */     public int bits()
/*     */     {
...
/* 294 */         retVal |= (this.bytes[i] & 0xFF) << i * 8;
/*     */       }
/* 296 */       return retVal;
/*     */     }
/*     */     
...
/* 340 */     Preconditions.checkArgument(string
/* 341 */       .length() % 2 == 0, "input string (%s) must have an even number of characters", string);
/*     */     
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\hash\HashCode.class
