...
/*     */       case 15: 
/* 130 */         k2 ^= UnsignedBytes.toInt(bb.get(14)) << 48;
/*     */       case 14: 
/* 132 */         k2 ^= UnsignedBytes.toInt(bb.get(13)) << 40;
/*     */       case 13: 
/* 134 */         k2 ^= UnsignedBytes.toInt(bb.get(12)) << 32;
/*     */       case 12: 
/* 136 */         k2 ^= UnsignedBytes.toInt(bb.get(11)) << 24;
/*     */       case 11: 
/* 138 */         k2 ^= UnsignedBytes.toInt(bb.get(10)) << 16;
/*     */       case 10: 
/* 140 */         k2 ^= UnsignedBytes.toInt(bb.get(9)) << 8;
/*     */       case 9: 
...
/* 145 */         break;
/*     */       case 7: 
/* 147 */         k1 ^= UnsignedBytes.toInt(bb.get(6)) << 48;
/*     */       case 6: 
/* 149 */         k1 ^= UnsignedBytes.toInt(bb.get(5)) << 40;
/*     */       case 5: 
/* 151 */         k1 ^= UnsignedBytes.toInt(bb.get(4)) << 32;
/*     */       case 4: 
/* 153 */         k1 ^= UnsignedBytes.toInt(bb.get(3)) << 24;
/*     */       case 3: 
/* 155 */         k1 ^= UnsignedBytes.toInt(bb.get(2)) << 16;
/*     */       case 2: 
/* 157 */         k1 ^= UnsignedBytes.toInt(bb.get(1)) << 8;
/*     */       case 1: 
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\hash\Murmur3_128HashFunction.class
