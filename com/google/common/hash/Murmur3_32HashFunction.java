...
/* 128 */       int k1 = input.charAt(i - 1) | input.charAt(i) << '\020';
/* 129 */       k1 = mixK1(k1);
/* 130 */       h1 = mixH1(h1, k1);
/*     */     }
/*     */     
...
/* 158 */         if ((c0 >= '') || (c1 >= '') || (c2 >= '') || (c3 >= '')) break;
/* 159 */         int k1 = c0 | c1 << '\b' | c2 << '\020' | c3 << '\030';
/* 160 */         k1 = mixK1(k1);
/* 161 */         h1 = mixH1(h1, k1);
/* 162 */         i += 4;
/* 163 */         len += 4;
...
/*     */     
/* 217 */     for (int i = 0; i + 4 <= len; i += 4) {
/* 218 */       int k1 = mixK1(getIntLittleEndian(input, off + i));
/* 219 */       h1 = mixH1(h1, k1);
/*     */     }
/*     */     
/* 222 */     int k1 = 0;
/* 223 */     for (int shift = 0; i < len; shift += 8) {
/* 224 */       k1 ^= UnsignedBytes.toInt(input[(off + i)]) << shift;i++;
/*     */     }
/* 226 */     h1 ^= mixK1(k1);
...
/*     */     {
/* 275 */       this.buffer |= (update & 0xFFFFFFFF) << this.shift;
/* 276 */       this.shift += nBytes * 8;
/* 277 */       this.length += nBytes;
/*     */       
/* 279 */       if (this.shift >= 32) {
/* 280 */         this.h1 = Murmur3_32HashFunction.mixH1(this.h1, Murmur3_32HashFunction.access$000((int)this.buffer));
/* 281 */         this.buffer >>>= 32;
/* 282 */         this.shift -= 32;
/*     */       }
/*     */     }
...
/* 351 */           if ((c0 >= '') || (c1 >= '') || (c2 >= '') || (c3 >= '')) break;
/* 352 */           update(4, c0 | c1 << '\b' | c2 << '\020' | c3 << '\030');
/* 353 */           i += 4;
/*     */         }
/* 359 */         for (; 
/*     */             
...
/* 394 */     return (0xF0 | codePoint >>> 18) & 0xFF | (0x80 | 0x3F & codePoint >>> 12) << 8 | (0x80 | 0x3F & codePoint >>> 6) << 16 | (0x80 | 0x3F & codePoint) << 24;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 401 */     return (0x1E0 | c >>> '\f') & 0xFF | (0x80 | 0x3F & c >>> '\006') << 8 | (0x80 | 0x3F & c) << '\020';
/*     */   }
/*     */   
/*     */ 
/*     */   private static long charToTwoUtf8Bytes(char c)
/*     */   {
/* 407 */     return (0x3C0 | c >>> '\006') & 0xFF | (0x80 | 0x3F & c) << '\b';
/*     */   }
/*     */ }


/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\hash\Murmur3_32HashFunction.class
