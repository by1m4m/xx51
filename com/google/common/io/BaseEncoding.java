...
/*      */   
/*      */   abstract int decodeTo(byte[] paramArrayOfByte, CharSequence paramCharSequence) throws BaseEncoding.DecodingException;
/*      */   
...
/*  465 */       for (int i = 0; i < this.bytesPerChunk; i++) {
/*  466 */         validPadding[IntMath.divide(i * 8, this.bitsPerChar, RoundingMode.CEILING)] = true;
/*      */       }
...
/*  638 */       Preconditions.checkPositionIndexes(off, off + len, bytes.length);
/*  639 */       for (int i = 0; i < len; i += this.alphabet.bytesPerChunk) {
...
/*      */       
/*  682 */       for (int l = chars.length() - 1; l >= 0; l--) {
...
/*  713 */       for (int charIdx = 0; charIdx < chars.length(); charIdx += this.alphabet.charsPerChunk) {
/*  714 */         long chunk = 0L;
...
/*  724 */           target[(bytesWritten++)] = ((byte)(int)(chunk >>> offset & 0xFF));
/*      */         }
/*      */       }
...
/*      */               }
/*  757 */               this.hitPadding = true;
/*  758 */             } else { if (this.hitPadding) {
...
/*      */     {
/*  788 */       if ((8 % this.alphabet.bitsPerChar == 0) || ((this.paddingChar != null) && 
/*  789 */         (this.paddingChar.charValue() == padChar))) {
/*  790 */         return this;
/*      */       }
...
/*  871 */     final char[] encoding = new char['Ȁ'];
/*      */     
...
/*  878 */       super(null);
/*  879 */       Preconditions.checkArgument(BaseEncoding.Alphabet.access$000(alphabet).length == 16);
...
/*  923 */       super(paddingChar);
/*  924 */       Preconditions.checkArgument(BaseEncoding.Alphabet.access$000(alphabet).length == 64);
/*      */     }
/*      */     
/*      */     void encodeTo(Appendable target, byte[] bytes, int off, int len) throws IOException
/*      */     {
...
/*      */   
/*      */   @GwtIncompatible
/*      */   static Reader ignoringReader(Reader delegate, final String toIgnore) {
...
/*      */         int readChar;
/*      */         do {
/*  983 */           readChar = this.val$delegate.read();
...
/* 1005 */     new Appendable() {
/* 1006 */       int charsUntilSeparator = this.val$afterEveryChars;
/*      */       
/*      */       public Appendable append(char c) throws IOException
/*      */       {
/* 1010 */         if (this.charsUntilSeparator == 0) {
/* 1011 */           delegate.append(separator);
/* 1012 */           this.charsUntilSeparator = this.val$afterEveryChars;
/*      */         }
/* 1014 */         delegate.append(c);
/* 1015 */         this.charsUntilSeparator -= 1;
/* 1016 */         return this;
/*      */       }
/*      */       
...
/*      */   {
/* 1035 */     Appendable seperatingAppendable = separatingAppendable(delegate, separator, afterEveryChars);
/* 1036 */     new Writer()
/*      */     {
/*      */       public void write(int c) throws IOException {
/* 1039 */         this.val$seperatingAppendable.append((char)c);
/*      */       }
/*      */       
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\io\BaseEncoding.class
