...
/*     */       
/*     */ 
/* 243 */       boolean sqrtFloorIsExact = (sqrtFloorInt * sqrtFloorInt == x.intValue()) && (sqrtFloor.pow(2).equals(x));
...
/* 283 */     BigInteger sqrt0; BigInteger sqrt0; if (log2 < 1023) {
...
/*     */     
/*     */ 
/* 361 */     for (long num = startingNumber; num <= n; num += 1L)
/*     */     {
...
/*     */     case 1: 
/* 399 */       return (BigInteger)nums.get(start);
/*     */     case 2: 
/* 401 */       return ((BigInteger)nums.get(start)).multiply((BigInteger)nums.get(start + 1));
/*     */     case 3: 
/* 403 */       return ((BigInteger)nums.get(start)).multiply((BigInteger)nums.get(start + 1)).multiply((BigInteger)nums.get(start + 2));
/*     */     }
/*     */     
...
/* 462 */     return 
/*     */     
/* 464 */       accum.multiply(BigInteger.valueOf(numeratorAccum)).divide(BigInteger.valueOf(denominatorAccum));
/*     */   }
/*     */   
/*     */   @GwtIncompatible
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\math\BigIntegerMath.class
