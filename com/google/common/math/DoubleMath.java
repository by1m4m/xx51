...
/* 133 */     MathPreconditions.checkInRangeForRoundingInputs((z > -2.147483649E9D ? 1 : 0) & (z < 2.147483648E9D ? 1 : 0), x, mode);
/*     */     
/* 135 */     return (int)z;
/*     */   }
/*     */   
...
/* 158 */     MathPreconditions.checkInRangeForRoundingInputs((-9.223372036854776E18D - z < 1.0D ? 1 : 0) & (z < 9.223372036854776E18D ? 1 : 0), x, mode);
/*     */     
/* 160 */     return z;
/*     */   }
/*     */   
...
/* 186 */       return BigInteger.valueOf(x);
/*     */     }
...
/*     */     boolean increment;
/*     */     boolean increment;
/* 247 */     boolean increment; switch (mode) {
/*     */     case UNNECESSARY: 
...
/* 256 */       break;
/*     */     case DOWN: 
/* 258 */       increment = (exponent < 0 ? 1 : 0) & (!isPowerOfTwo(x) ? 1 : 0);
/* 259 */       break;
/*     */     case UP: 
/* 261 */       increment = (exponent >= 0 ? 1 : 0) & (!isPowerOfTwo(x) ? 1 : 0);
/* 262 */       break;
/*     */     case HALF_EVEN: 
/*     */     case HALF_UP: 
/*     */     case HALF_DOWN: 
/* 266 */       double xScaled = DoubleUtils.scaleNormalize(x);
/*     */       
/*     */ 
...
/*     */   {
/* 287 */     return (DoubleUtils.isFinite(x)) && ((x == 0.0D) || 
/*     */     
/* 289 */       (52 - Long.numberOfTrailingZeros(DoubleUtils.getSignificand(x)) <= Math.getExponent(x)));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */   @VisibleForTesting
/* 319 */   static final double[] everySixteenthFactorial = { 1.0D, 2.0922789888E13D, 2.631308369336935E35D, 1.2413915592536073E61D, 1.2688693218588417E89D, 7.156945704626381E118D, 9.916779348709496E149D, 1.974506857221074E182D, 3.856204823625804E215D, 5.5502938327393044E249D, 4.7147236359920616E284D };
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\math\DoubleMath.class
