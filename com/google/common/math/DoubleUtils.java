...
/*  66 */     bits &= 0xFFFFFFFFFFFFF;
/*  67 */     return exponent == 64513 ? bits << 1 : bits | 0x10000000000000;
/*     */   }
/*     */   
...
/*  75 */     return Math.getExponent(d) >= 64514;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/*  83 */     long significand = Double.doubleToRawLongBits(x) & 0xFFFFFFFFFFFFF;
/*  84 */     return Double.longBitsToDouble(significand | 0x3FF0000000000000);
/*     */   }
/*     */   
...
/* 108 */     long signifFloor = twiceSignifFloor >> 1;
/* 109 */     signifFloor &= 0xFFFFFFFFFFFFF;
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 117 */     boolean increment = ((twiceSignifFloor & 1L) != 0L) && (((signifFloor & 1L) != 0L) || (absX.getLowestSetBit() < shift));
/* 118 */     long signifRounded = increment ? signifFloor + 1L : signifFloor;
/* 119 */     long bits = exponent + 1023 << 52;
...
/*     */ 
/*     */ 
/* 127 */     bits |= x.signum() & 0x8000000000000000;
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\math\DoubleUtils.class
