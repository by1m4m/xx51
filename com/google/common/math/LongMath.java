...
/*      */   {
/*  546 */     long result = a + b;
/*  547 */     MathPreconditions.checkNoOverflow(((a ^ b) < 0L ? 1 : 0) | ((a ^ result) >= 0L ? 1 : 0), "checkedAdd", a, b);
/*  548 */     return result;
/*      */   }
/*      */   
/*      */ 
...
/*      */   {
/*  558 */     long result = a - b;
/*  559 */     MathPreconditions.checkNoOverflow(((a ^ b) >= 0L ? 1 : 0) | ((a ^ result) >= 0L ? 1 : 0), "checkedSubtract", a, b);
/*  560 */     return result;
/*      */   }
/*      */   
/*      */ 
...
/*      */   {
/*  574 */     int leadingZeros = Long.numberOfLeadingZeros(a) + Long.numberOfLeadingZeros(a ^ 0xFFFFFFFFFFFFFFFF) + Long.numberOfLeadingZeros(b) + Long.numberOfLeadingZeros(b ^ 0xFFFFFFFFFFFFFFFF);
/*      */     
/*      */ 
/*      */ 
/*      */ 
...
/*  589 */     MathPreconditions.checkNoOverflow((a >= 0L ? 1 : 0) | (b != Long.MIN_VALUE ? 1 : 0), "checkedMultiply", a, b);
/*  590 */     long result = a * b;
...
/*      */ 
/*      */ 
/*  884 */   static final int[] biggestBinomials = { Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, 206, 169, 143, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66 };
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   @VisibleForTesting
/*  926 */   static final int[] biggestSimpleBinomials = { Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, 287, 214, 169, 139, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61 };
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\math\LongMath.class
