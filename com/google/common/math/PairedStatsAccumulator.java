...
/*     */       }
/*     */     } else {
/*  61 */       this.sumOfProductsOfDeltas = NaN.0D;
/*     */     }
...
/*     */ 
/*     */ 
/*  86 */       this.sumOfProductsOfDeltas = (this.sumOfProductsOfDeltas + (values.sumOfProductsOfDeltas() + (values.xStats().mean() - this.xStats.mean()) * (values.yStats().mean() - this.yStats.mean()) * values.count()));
/*     */     }
...
/* 219 */         return 
/* 220 */           LinearTransformation.mapping(this.xStats.mean(), this.yStats.mean()).withSlope(this.sumOfProductsOfDeltas / xSumOfSquaresOfDeltas);
/*     */       }
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\math\PairedStatsAccumulator.class
