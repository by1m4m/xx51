...
/*     */   {
/* 155 */     return new Scale(scale, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     {
/* 179 */       return new Quantiles.ScaleAndIndex(this.scale, index, null);
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 191 */       return new Quantiles.ScaleAndIndexes(this.scale, (int[])indexes.clone(), null);
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 203 */       return new Quantiles.ScaleAndIndexes(this.scale, Ints.toArray(indexes), null);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 388 */           nanMap.put(Integer.valueOf(index), Double.valueOf(NaN.0D));
/*     */         }
...
/* 426 */       for (int i = 0; i < this.indexes.length; i++) {
/* 427 */         int quotient = quotients[i];
/* 428 */         int remainder = remainders[i];
/* 429 */         if (remainder == 0) {
/* 430 */           ret.put(Integer.valueOf(this.indexes[i]), Double.valueOf(dataset[quotient]));
/*     */         } else {
/* 432 */           ret.put(
/* 433 */             Integer.valueOf(this.indexes[i]), Double.valueOf(Quantiles.interpolate(dataset[quotient], dataset[(quotient + 1)], remainder, this.scale)));
/*     */         }
/*     */       }
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\math\Quantiles.class
