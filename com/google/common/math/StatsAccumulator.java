...
/*  55 */         this.sumOfSquaresOfDeltas = NaN.0D;
/*     */       }
/*     */     } else {
/*  58 */       this.count += 1L;
...
/*  66 */         this.sumOfSquaresOfDeltas = NaN.0D;
/*     */       }
...
/*     */         
/* 153 */         this.sumOfSquaresOfDeltas = (this.sumOfSquaresOfDeltas + (values.sumOfSquaresOfDeltas() + delta * (values.mean() - this.mean) * values.count()));
/*     */       } else {
/* 155 */         this.mean = calculateNewMeanNonFinite(this.mean, values.mean());
/* 156 */         this.sumOfSquaresOfDeltas = NaN.0D;
/*     */       }
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\math\StatsAccumulator.class
