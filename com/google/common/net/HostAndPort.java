...
/* 214 */     Preconditions.checkArgument(hostPortString
/* 215 */       .charAt(0) == '[', "Bracketed host-port string must start with a bracket: %s", hostPortString);
/*     */     
/*     */ 
