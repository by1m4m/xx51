...
/* 228 */     if (skipIndex >= 0)
/*     */     {
/* 230 */       int partsHi = skipIndex;
/* 231 */       int partsLo = parts.size() - skipIndex - 1;
/* 232 */       if (((String)parts.get(0)).length() == 0) { partsHi--; if (partsHi != 0)
/* 233 */           return null;
/*     */       }
/* 235 */       if (((String)Iterables.getLast(parts)).length() == 0) { partsLo--; if (partsLo != 0) {
/* 236 */           return null;
/*     */         }
/*     */       }
/*     */     }
...
/*     */     
/*     */ 
/* 253 */     ByteBuffer rawBytes = ByteBuffer.allocate(16);
/*     */     try {
/* 255 */       for (int i = 0; i < partsHi; i++) {
/* 256 */         rawBytes.putShort(parseHextet((String)parts.get(i)));
/*     */       }
/* 258 */       for (int i = 0; i < partsSkipped; i++) {
/* 259 */         rawBytes.putShort((short)0);
/*     */       }
/* 261 */       for (int i = partsLo; i > 0; i--) {
/* 262 */         rawBytes.putShort(parseHextet((String)parts.get(parts.size() - i)));
/*     */       }
/*     */     } catch (NumberFormatException ex) {
/* 265 */       return null;
/*     */     }
...
/* 346 */       hextets[i] = Ints.fromBytes(0, 0, bytes[(2 * i)], bytes[(2 * i + 1)]);
/*     */     }
...
/* 471 */       String ipString = hostAddr.substring(1, hostAddr.length() - 1);
/* 472 */       expectBytes = 16;
/*     */     } else {
...
/*     */     }
/*     */     
/* 938 */     Preconditions.checkArgument(i >= 0, "Decrementing %s would wrap.", address); int 
/*     */     
/* 940 */       tmp47_46 = i; byte[] tmp47_45 = addr;tmp47_45[tmp47_46] = ((byte)(tmp47_45[tmp47_46] - 1));
...
/*     */     }
/*     */     
/* 961 */     Preconditions.checkArgument(i >= 0, "Incrementing %s would wrap.", address); int 
/*     */     
/* 963 */       tmp48_47 = i; byte[] tmp48_46 = addr;tmp48_46[tmp48_47] = ((byte)(tmp48_46[tmp48_47] + 1));
