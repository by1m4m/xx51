...
/* 149 */     Preconditions.checkArgument(validateSyntax(this.parts), "Not a valid domain name: '%s'", name);
/*     */     
...
/* 168 */       String ancestorName = DOT_JOINER.join(this.parts.subList(i, partsSize));
/*     */       
...
/*     */ 
/*     */ 
/* 224 */     if (!validatePart((String)parts.get(lastIndex), true)) {
/* 225 */       return false;
/*     */     }
/*     */     
/* 228 */     for (int i = 0; i < lastIndex; i++) {
/* 229 */       String part = (String)parts.get(i);
...
/*     */   {
/* 539 */     return from(DOT_JOINER.join(this.parts.subList(levels, this.parts.size())));
/*     */   }
/*     */   
/*     */ 
/*     */ 
