...
/* 113 */     char[] arrayOfChar1 = safeCharArray;int i = arrayOfChar1.length; for (char c1 = '\000'; c1 < i; c1++) { c = arrayOfChar1[c1];
/* 114 */       maxChar = Math.max(c, maxChar);
/*     */     }
/* 116 */     boolean[] octets = new boolean[maxChar + 1];
/* 117 */     char[] arrayOfChar2 = safeCharArray;c1 = arrayOfChar2.length; for (char c = '\000'; c < c1; c++) { char c = arrayOfChar2[c];
/* 118 */       octets[c] = true;
/*     */     }
/* 120 */     return octets;
/*     */   }
...
/* 132 */       if ((c >= this.safeOctets.length) || (this.safeOctets[c] == 0)) {
/*     */         break;
/*     */       }
/*     */     }
/* 136 */     return index;
...
/* 149 */       if ((c >= this.safeOctets.length) || (this.safeOctets[c] == 0)) {
...
/*     */   {
/* 161 */     if ((cp < this.safeOctets.length) && (this.safeOctets[cp] != 0))
/* 162 */       return null;
