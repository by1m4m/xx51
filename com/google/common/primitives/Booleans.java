...
/*     */   {
/* 235 */     int length = 0;
/* 236 */     for (array : arrays) {
/* 237 */       length += array.length;
/*     */     }
/* 239 */     boolean[] result = new boolean[length];
/* 240 */     int pos = 0;
/* 241 */     boolean[][] arrayOfBoolean2 = arrays;boolean[] array = arrayOfBoolean2.length; for (boolean[] arrayOfBoolean3 = 0; arrayOfBoolean3 < array; arrayOfBoolean3++) { boolean[] array = arrayOfBoolean2[arrayOfBoolean3];
...
/*     */     
/* 313 */     public int compare(boolean[] left, boolean[] right) { int minLength = Math.min(left.length, right.length);
...
/* 414 */         (Booleans.indexOf(this.array, ((Boolean)target).booleanValue(), this.start, this.end) != -1);
/*     */     }
/*     */     
/*     */ 
...
/* 493 */       builder.append(this.array[this.start] != 0 ? "[true" : "[false");
/* 494 */       for (int i = this.start + 1; i < this.end; i++) {
/* 495 */         builder.append(this.array[i] != 0 ? ", true" : ", false");
/*     */       }
/* 497 */       return ']';
/*     */     }
/*     */     
...
/* 547 */     int i = fromIndex; for (int j = toIndex - 1; i < j; j--) {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\primitives\Booleans.class
