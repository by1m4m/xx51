...
/*     */   {
/* 160 */     int length = 0;
/* 161 */     for (array : arrays) {
/* 162 */       length += array.length;
/*     */     }
/* 164 */     byte[] result = new byte[length];
/* 165 */     int pos = 0;
/* 166 */     byte[][] arrayOfByte2 = arrays;byte[] array = arrayOfByte2.length; for (byte[] arrayOfByte3 = 0; arrayOfByte3 < array; arrayOfByte3++) { byte[] array = arrayOfByte2[arrayOfByte3];
...
/* 392 */     int i = fromIndex; for (int j = toIndex - 1; i < j; j--) {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\primitives\Bytes.class
