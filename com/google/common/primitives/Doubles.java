...
/*     */   {
/* 267 */     int length = 0;
/* 268 */     for (array : arrays) {
/* 269 */       length += array.length;
/*     */     }
/* 271 */     double[] result = new double[length];
/* 272 */     int pos = 0;
/* 273 */     double[][] arrayOfDouble2 = arrays;double[] array = arrayOfDouble2.length; for (double[] arrayOfDouble3 = 0; arrayOfDouble3 < array; arrayOfDouble3++) { double[] array = arrayOfDouble2[arrayOfDouble3];
...
/*     */     
/* 385 */     public int compare(double[] left, double[] right) { int minLength = Math.min(left.length, right.length);
...
/* 454 */     int i = fromIndex; for (int j = toIndex - 1; i < j; j--) {
...
/* 556 */         (Doubles.indexOf(this.array, ((Double)target).doubleValue(), this.start, this.end) != -1);
/*     */     }
/*     */     
/*     */ 
...
/*     */ 
/*     */   @GwtIncompatible
/* 657 */   static final Pattern FLOATING_POINT_PATTERN = ;
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\primitives\Doubles.class
