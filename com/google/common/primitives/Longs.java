...
/*     */   {
/* 252 */     int length = 0;
/* 253 */     for (array : arrays) {
/* 254 */       length += array.length;
/*     */     }
/* 256 */     long[] result = new long[length];
/* 257 */     int pos = 0;
/* 258 */     long[][] arrayOfLong2 = arrays;long[] array = arrayOfLong2.length; for (long[] arrayOfLong3 = 0; arrayOfLong3 < array; arrayOfLong3++) { long[] array = arrayOfLong2[arrayOfLong3];
...
/* 280 */       result[i] = ((byte)(int)(value & 0xFF));
/* 281 */       value >>= 8;
/*     */     }
/* 283 */     return result;
/*     */   }
...
/*     */   {
/* 311 */     return (b1 & 0xFF) << 56 | (b2 & 0xFF) << 48 | (b3 & 0xFF) << 40 | (b4 & 0xFF) << 32 | (b5 & 0xFF) << 24 | (b6 & 0xFF) << 16 | (b7 & 0xFF) << 8 | b8 & 0xFF;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 536 */     public int compare(long[] left, long[] right) { int minLength = Math.min(left.length, right.length);
...
/* 599 */     int i = fromIndex; for (int j = toIndex - 1; i < j; j--) {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\primitives\Longs.class
