...
/* 267 */     return value < max ? value : value < min ? min : max;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 279 */     int length = 0;
/* 280 */     for (array : arrays) {
/* 281 */       length += array.length;
/*     */     }
/* 283 */     short[] result = new short[length];
/* 284 */     int pos = 0;
/* 285 */     short[][] arrayOfShort2 = arrays;short[] array = arrayOfShort2.length; for (short[] arrayOfShort3 = 0; arrayOfShort3 < array; arrayOfShort3++) { short[] array = arrayOfShort2[arrayOfShort3];
...
/*     */     
/* 440 */     public int compare(short[] left, short[] right) { int minLength = Math.min(left.length, right.length);
...
/* 503 */     int i = fromIndex; for (int j = toIndex - 1; i < j; j--) {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\primitives\Shorts.class
