...
/*     */   {
/*  94 */     Preconditions.checkArgument(value >> 32 == 0L, "out of range: %s", value);
/*  95 */     return (int)value;
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/* 199 */     public int compare(int[] left, int[] right) { int minLength = Math.min(left.length, right.length);
...
/* 232 */     Preconditions.checkPositionIndexes(fromIndex, toIndex, array.length);
...
/* 261 */     Preconditions.checkPositionIndexes(fromIndex, toIndex, array.length);
/* 262 */     for (int i = fromIndex; i < toIndex; i++) {
/* 263 */       array[i] ^= 0x7FFFFFFF;
/*     */     }
/* 265 */     Arrays.sort(array, fromIndex, toIndex);
/* 266 */     for (int i = fromIndex; i < toIndex; i++) {
/* 267 */       array[i] ^= 0x7FFFFFFF;
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 359 */     if ((result & 0xFFFFFFFF) != result) {
...
/*     */   {
/* 387 */     long asLong = x & 0xFFFFFFFF;
/* 388 */     return Long.toString(asLong, radix);
/*     */   }
/*     */ }


/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\primitives\UnsignedInts.class
