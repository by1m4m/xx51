...
/*     */   {
/*  64 */     return a ^ 0x8000000000000000;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 165 */     public int compare(long[] left, long[] right) { int minLength = Math.min(left.length, right.length);
...
/* 198 */     Preconditions.checkPositionIndexes(fromIndex, toIndex, array.length);
...
/* 227 */     Preconditions.checkPositionIndexes(fromIndex, toIndex, array.length);
/* 228 */     for (int i = fromIndex; i < toIndex; i++) {
/* 229 */       array[i] ^= 0x7FFFFFFFFFFFFFFF;
/*     */     }
/* 231 */     Arrays.sort(array, fromIndex, toIndex);
/* 232 */     for (int i = fromIndex; i < toIndex; i++) {
/* 233 */       array[i] ^= 0x7FFFFFFFFFFFFFFF;
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\primitives\UnsignedLongs.class
