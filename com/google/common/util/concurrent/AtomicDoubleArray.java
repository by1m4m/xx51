...
/*     */   {
/* 210 */     int iMax = length() - 1;
/* 211 */     if (iMax == -1) {
/* 212 */       return "[]";
/*     */     }
/*     */     
/*     */ 
/* 216 */     StringBuilder b = new StringBuilder(19 * (iMax + 1));
/* 217 */     b.append('[');
/* 218 */     for (int i = 0;; i++) {
/* 219 */       b.append(Double.longBitsToDouble(this.longs.get(i)));
/* 220 */       if (i == iMax) {
/* 221 */         return ']';
/*     */       }
/* 223 */       b.append(',').append(' ');
...
/*     */     
/*     */ 
/* 237 */     int length = length();
/* 238 */     s.writeInt(length);
/*     */     
/*     */ 
/* 241 */     for (int i = 0; i < length; i++) {
/* 242 */       s.writeDouble(get(i));
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/* 249 */     s.defaultReadObject();
/*     */     
/* 251 */     int length = s.readInt();
/* 252 */     ImmutableLongArray.Builder builder = ImmutableLongArray.builder();
/* 253 */     for (int i = 0; i < length; i++) {
/* 254 */       builder.add(Double.doubleToRawLongBits(s.readDouble()));
/*     */     }
/* 256 */     this.longs = new AtomicLongArray(builder.build().toArray());
/*     */   }
/*     */ }


/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\util\concurrent\AtomicDoubleArray.class
