...
/*     */           {
/*     */             try {
/*  95 */               return method.invoke(SimpleTimeLimiter.1.this.val$target, args);
/*     */             } catch (InvocationTargetException e) {
/*  97 */               throw SimpleTimeLimiter.throwCause(e, false);
/*     */             }
/*     */           }
/* 100 */         };
/* 101 */         return SimpleTimeLimiter.this.callWithTimeout(callable, timeoutDuration, interruptibleMethods, this.val$interruptibleMethods
/* 102 */           .contains(method));
/*     */       }
/* 104 */     };
/* 105 */     return (T)newProxy(interfaceType, handler);
/*     */   }
/*     */   
/*     */ 
...
/* 113 */     return (T)interfaceType.cast(object);
/*     */   }
/*     */   
/*     */ 
/*     */   private <T> T callWithTimeout(Callable<T> callable, long timeoutDuration, TimeUnit timeoutUnit, boolean amInterruptible)
/*     */     throws Exception
/*     */   {
...
/*     */         try {
/* 129 */           return (T)future.get(timeoutDuration, timeoutUnit);
/*     */         } catch (InterruptedException e) {
/* 131 */           future.cancel(true);
/* 132 */           throw e;
/*     */         }
/*     */       }
/* 135 */       return (T)Uninterruptibles.getUninterruptibly(future, timeoutDuration, timeoutUnit);
/*     */     }
...
/*     */     try
/*     */     {
/* 156 */       return (T)future.get(timeoutDuration, timeoutUnit);
...
/*     */     try
/*     */     {
/* 178 */       return (T)Uninterruptibles.getUninterruptibly(future, timeoutDuration, timeoutUnit);
/*     */     } catch (TimeoutException e) {
...
/*     */     {
/* 235 */       StackTraceElement[] combined = (StackTraceElement[])ObjectArrays.concat(cause.getStackTrace(), e.getStackTrace(), StackTraceElement.class);
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\util\concurrent\SimpleTimeLimiter.class
