...
/*     */ 
/*     */ 
/* 158 */     ThreadFactory backingThreadFactory = builder.backingThreadFactory != null ? builder.backingThreadFactory : Executors.defaultThreadFactory();
/* 159 */     final AtomicLong count = nameFormat != null ? new AtomicLong(0L) : null;
/* 160 */     new ThreadFactory()
/*     */     {
/*     */       public Thread newThread(Runnable runnable) {
/* 163 */         Thread thread = this.val$backingThreadFactory.newThread(runnable);
/* 164 */         if (nameFormat != null) {
/* 165 */           thread.setName(ThreadFactoryBuilder.format(nameFormat, new Object[] { Long.valueOf(count.getAndIncrement()) }));
/*     */         }
/* 167 */         if (daemon != null) {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\util\concurrent\ThreadFactoryBuilder.class
