...
/* 115 */       this.callable = ((Callable)Preconditions.checkNotNull(callable));
/*     */     }
/*     */     
...
/*     */     {
/* 125 */       return (V)this.callable.call();
/*     */     }
/*     */     
...
/*     */     {
/* 149 */       this.callable = ((AsyncCallable)Preconditions.checkNotNull(callable));
/*     */     }
/*     */     
/*     */     final boolean isDone()
/*     */     {
...
/*     */     {
/* 159 */       return (ListenableFuture)Preconditions.checkNotNull(this.callable
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\google\common\util\concurrent\TrustedListenableFutureTask.class
