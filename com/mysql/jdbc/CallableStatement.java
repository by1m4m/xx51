...
/*      */       }
/*      */       
/*  311 */       return ResultSetMetaData.getClassNameForJavaType(getParameterType(arg0), isUnsigned, mysqlTypeIfKnown, isBinaryOrBlob, false, CallableStatement.this.connection.getYearIsDateType());
/*      */     }
/*      */     
...
/*      */     throws SQLException
/*      */   {
/*  549 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/*  657 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/*  714 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */   {
/*  735 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/*  755 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */       }
/*      */       
/*  782 */       ArrayList<ResultSetRow> resultRows = new ArrayList();
/*      */       
...
/*  820 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/*  946 */     synchronized (checkClosed().getConnectionMutex())
/*      */     {
...
/*      */     throws SQLException
/*      */   {
/*  969 */     synchronized (checkClosed().getConnectionMutex()) {
/*  970 */       int returnVal = -1;
/*      */       
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 1070 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1086 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1103 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1182 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1199 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1232 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1248 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1264 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1281 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1297 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1313 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1362 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1380 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1397 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1414 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1430 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1447 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1463 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1479 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1511 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1574 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1611 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1629 */     synchronized (checkClosed().getConnectionMutex()) {
...
/* 1657 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1680 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */   {
/* 1704 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1717 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1733 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1749 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1783 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1800 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1833 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1849 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1867 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1901 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1936 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1969 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1984 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 2042 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 2073 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 2243 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */               
/*      */ 
/* 2270 */               if (this.isNull[inParamInfo.index] != 0) {
/* 2271 */                 setPstmt.setBytesNoEscapeNoQuotes(1, "NULL".getBytes());
/*      */               }
/*      */               else {
/* 2274 */                 byte[] parameterAsBytes = getBytesRepresentation(inParamInfo.index);
/*      */                 
/*      */ 
/* 2277 */                 if (parameterAsBytes != null) {
/* 2278 */                   if ((parameterAsBytes.length > 8) && (parameterAsBytes[0] == 95) && (parameterAsBytes[1] == 98) && (parameterAsBytes[2] == 105) && (parameterAsBytes[3] == 110) && (parameterAsBytes[4] == 97) && (parameterAsBytes[5] == 114) && (parameterAsBytes[6] == 121) && (parameterAsBytes[7] == 39))
/*      */                   {
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/* 2287 */                     setPstmt.setBytesNoEscapeNoQuotes(1, parameterAsBytes);
/*      */                   }
/*      */                   else {
/* 2290 */                     int sqlType = inParamInfo.desiredJdbcType;
/*      */                     
/* 2292 */                     switch (sqlType) {
/*      */                     case -7: 
/*      */                     case -4: 
...
/*      */                     case 2000: 
/*      */                     case 2004: 
/* 2299 */                       setPstmt.setBytes(1, parameterAsBytes);
/* 2300 */                       break;
/*      */                     
/*      */ 
/*      */                     default: 
/* 2304 */                       setPstmt.setBytesNoEscape(1, parameterAsBytes);
/*      */                     }
/*      */                   }
/*      */                 } else {
/* 2308 */                   setPstmt.setNull(1, 0);
/*      */                 }
/*      */               }
/*      */               
/* 2312 */               setPstmt.executeUpdate();
/*      */             } finally {
/* 2314 */               if (setPstmt != null) {
/* 2315 */                 setPstmt.close();
/*      */               }
/*      */             }
/*      */           }
...
/*      */     throws SQLException
/*      */   {
/* 2328 */     setInt(getNamedParamIndex(parameterName, false), x);
/*      */   }
/*      */   
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2335 */     setLong(getNamedParamIndex(parameterName, false), x);
/*      */   }
/*      */   
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2342 */     setNull(getNamedParamIndex(parameterName, false), sqlType);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2351 */     setNull(getNamedParamIndex(parameterName, false), sqlType, typeName);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2359 */     setObject(getNamedParamIndex(parameterName, false), x);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2368 */     setObject(getNamedParamIndex(parameterName, false), x, targetSqlType);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2380 */     synchronized (checkClosed().getConnectionMutex()) {
/* 2381 */       if (this.paramInfo.numParameters > 0) {
/* 2382 */         Iterator<CallableStatementParam> paramIter = this.paramInfo.iterator();
/* 2383 */         while (paramIter.hasNext()) {
/* 2384 */           CallableStatementParam outParamInfo = (CallableStatementParam)paramIter.next();
/*      */           
/*      */ 
/* 2387 */           if ((!this.callingStoredFunction) && (outParamInfo.isOut))
/*      */           {
/* 2389 */             if ((outParamInfo.paramName == null) && (hasParametersView())) {
/* 2390 */               outParamInfo.paramName = ("nullnp" + outParamInfo.index);
/*      */             }
/*      */             
/* 2393 */             String outParameterName = mangleParameterName(outParamInfo.paramName);
/*      */             
/* 2395 */             int outParamIndex = 0;
/*      */             
/* 2397 */             if (this.placeholderToParameterIndexMap == null) {
/* 2398 */               outParamIndex = outParamInfo.index + 1;
/*      */             }
/*      */             else {
/* 2401 */               boolean found = false;
/*      */               
/* 2403 */               for (int i = 0; i < this.placeholderToParameterIndexMap.length; i++) {
/* 2404 */                 if (this.placeholderToParameterIndexMap[i] == outParamInfo.index) {
/* 2405 */                   outParamIndex = i + 1;
/* 2406 */                   found = true;
/* 2407 */                   break;
/*      */                 }
/*      */               }
/*      */               
/* 2411 */               if (!found) {
/* 2412 */                 throw SQLError.createSQLException("boo!", "S1000", this.connection.getExceptionInterceptor());
/*      */               }
/*      */             }
/*      */             
/* 2416 */             setBytesNoEscapeNoQuotes(outParamIndex, StringUtils.getBytes(outParameterName, this.charConverter, this.charEncoding, this.connection.getServerCharacterEncoding(), this.connection.parserKnowsUnicode(), getExceptionInterceptor()));
/*      */           }
/*      */         }
/*      */       }
/*      */     }
...
/*      */     throws SQLException
/*      */   {
/* 2432 */     setShort(getNamedParamIndex(parameterName, false), x);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2440 */     setString(getNamedParamIndex(parameterName, false), x);
/*      */   }
/*      */   
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2447 */     setTime(getNamedParamIndex(parameterName, false), x);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2456 */     setTime(getNamedParamIndex(parameterName, false), x, cal);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2465 */     setTimestamp(getNamedParamIndex(parameterName, false), x);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2474 */     setTimestamp(getNamedParamIndex(parameterName, false), x, cal);
/*      */   }
/*      */   
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2481 */     setURL(getNamedParamIndex(parameterName, false), val);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2494 */     if (this.hasOutputParams) {
/* 2495 */       throw SQLError.createSQLException("Can't call executeBatch() on CallableStatement with OUTPUT parameters", "S1009", getExceptionInterceptor());
/*      */     }
/*      */     
/*      */ 
/* 2499 */     return super.executeBatch();
/*      */   }
/*      */   
/*      */   protected int getParameterIndexOffset() {
/* 2503 */     if (this.callingStoredFunction) {
/* 2504 */       return -1;
/*      */     }
/*      */     
/* 2507 */     return super.getParameterIndexOffset();
/*      */   }
/*      */   
/*      */   public void setAsciiStream(String parameterName, InputStream x) throws SQLException {
/* 2511 */     setAsciiStream(getNamedParamIndex(parameterName, false), x);
/*      */   }
/*      */   
/*      */   public void setAsciiStream(String parameterName, InputStream x, long length) throws SQLException
/*      */   {
/* 2516 */     setAsciiStream(getNamedParamIndex(parameterName, false), x, length);
/*      */   }
/*      */   
/*      */   public void setBinaryStream(String parameterName, InputStream x) throws SQLException
/*      */   {
/* 2521 */     setBinaryStream(getNamedParamIndex(parameterName, false), x);
/*      */   }
/*      */   
/*      */   public void setBinaryStream(String parameterName, InputStream x, long length) throws SQLException
/*      */   {
/* 2526 */     setBinaryStream(getNamedParamIndex(parameterName, false), x, length);
/*      */   }
/*      */   
/*      */   public void setBlob(String parameterName, Blob x) throws SQLException
/*      */   {
/* 2531 */     setBlob(getNamedParamIndex(parameterName, false), x);
/*      */   }
/*      */   
/*      */   public void setBlob(String parameterName, InputStream inputStream) throws SQLException
/*      */   {
/* 2536 */     setBlob(getNamedParamIndex(parameterName, false), inputStream);
/*      */   }
/*      */   
/*      */   public void setBlob(String parameterName, InputStream inputStream, long length) throws SQLException
/*      */   {
/* 2541 */     setBlob(getNamedParamIndex(parameterName, false), inputStream, length);
/*      */   }
/*      */   
/*      */   public void setCharacterStream(String parameterName, Reader reader) throws SQLException
/*      */   {
/* 2546 */     setCharacterStream(getNamedParamIndex(parameterName, false), reader);
/*      */   }
/*      */   
/*      */   public void setCharacterStream(String parameterName, Reader reader, long length) throws SQLException
/*      */   {
/* 2551 */     setCharacterStream(getNamedParamIndex(parameterName, false), reader, length);
/*      */   }
/*      */   
/*      */   public void setClob(String parameterName, Clob x) throws SQLException
/*      */   {
/* 2556 */     setClob(getNamedParamIndex(parameterName, false), x);
/*      */   }
/*      */   
/*      */   public void setClob(String parameterName, Reader reader) throws SQLException
/*      */   {
/* 2561 */     setClob(getNamedParamIndex(parameterName, false), reader);
/*      */   }
/*      */   
/*      */   public void setClob(String parameterName, Reader reader, long length) throws SQLException
/*      */   {
/* 2566 */     setClob(getNamedParamIndex(parameterName, false), reader, length);
/*      */   }
/*      */   
/*      */   public void setNCharacterStream(String parameterName, Reader value) throws SQLException
/*      */   {
/* 2571 */     setNCharacterStream(getNamedParamIndex(parameterName, false), value);
/*      */   }
/*      */   
/*      */   public void setNCharacterStream(String parameterName, Reader value, long length) throws SQLException
/*      */   {
/* 2576 */     setNCharacterStream(getNamedParamIndex(parameterName, false), value, length);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2587 */     synchronized (checkClosed().getConnectionMutex()) {
/* 2588 */       if (this.connection.getNoAccessToProcedureBodies()) {
/* 2589 */         return false;
/*      */       }
/*      */       
/* 2592 */       if (this.paramInfo.isReadOnlySafeChecked) {
/* 2593 */         return this.paramInfo.isReadOnlySafeProcedure;
/*      */       }
/*      */       
/* 2596 */       ResultSet rs = null;
/* 2597 */       java.sql.PreparedStatement ps = null;
/*      */       try
/*      */       {
/* 2600 */         String procName = extractProcedureName();
/*      */         
/* 2602 */         String catalog = this.currentCatalog;
/*      */         
/* 2604 */         if (procName.indexOf(".") != -1) {
/* 2605 */           catalog = procName.substring(0, procName.indexOf("."));
/*      */           
/* 2607 */           if ((StringUtils.startsWithIgnoreCaseAndWs(catalog, "`")) && (catalog.trim().endsWith("`"))) {
/* 2608 */             catalog = catalog.substring(1, catalog.length() - 1);
/*      */           }
/*      */           
/* 2611 */           procName = procName.substring(procName.indexOf(".") + 1);
/* 2612 */           procName = StringUtils.toString(StringUtils.stripEnclosure(StringUtils.getBytes(procName), "`", "`"));
/*      */         }
/*      */         
/* 2615 */         ps = this.connection.prepareStatement("SELECT SQL_DATA_ACCESS FROM  information_schema.routines  WHERE routine_schema = ?  AND routine_name = ?");
/*      */         
/*      */ 
/*      */ 
/*      */ 
/* 2620 */         ps.setMaxRows(0);
/* 2621 */         ps.setFetchSize(0);
/*      */         
/* 2623 */         ps.setString(1, catalog);
/* 2624 */         ps.setString(2, procName);
/* 2625 */         rs = ps.executeQuery();
/* 2626 */         if (rs.next()) {
/* 2627 */           String sqlDataAccess = rs.getString(1);
/* 2628 */           if (("READS SQL DATA".equalsIgnoreCase(sqlDataAccess)) || ("NO SQL".equalsIgnoreCase(sqlDataAccess)))
/*      */           {
/* 2630 */             synchronized (this.paramInfo) {
/* 2631 */               this.paramInfo.isReadOnlySafeChecked = true;
/* 2632 */               this.paramInfo.isReadOnlySafeProcedure = true;
/*      */             }
/* 2634 */             ??? = 1;jsr 30;return ???;
/*      */           }
/*      */         }
/*      */       }
/*      */       catch (SQLException e) {}finally
/*      */       {
/* 2640 */         jsr 6; } localObject3 = returnAddress; if (rs != null) {
/* 2641 */         rs.close();
/*      */       }
/* 2643 */       if (ps != null)
/* 2644 */         ps.close(); ret;
...
/*      */ 
/*      */ 
/* 2648 */       this.paramInfo.isReadOnlySafeChecked = false;
/* 2649 */       this.paramInfo.isReadOnlySafeProcedure = false;
/*      */     }
/* 2651 */     return false;
/*      */   }
/*      */   
...
/*      */   {
/* 2656 */     return (super.checkReadOnlySafeStatement()) || (checkReadOnlyProcedure());
/*      */   }
/*      */   
/*      */   private boolean hasParametersView() throws SQLException {
/* 2660 */     synchronized (checkClosed().getConnectionMutex()) {
/*      */       try {
/* 2662 */         if (this.connection.versionMeetsMinimum(5, 5, 0)) {
/* 2663 */           java.sql.DatabaseMetaData dbmd1 = new DatabaseMetaDataUsingInfoSchema(this.connection, this.connection.getCatalog());
/* 2664 */           return ((DatabaseMetaDataUsingInfoSchema)dbmd1).gethasParametersView();
/*      */         }
/*      */         
/* 2667 */         return false;
...
/*      */     //   23: athrow
/*      */     // Line number table:
/*      */     //   Java source line #2488	-> byte code offset #0
/*      */     //   Java source line #2489	-> byte code offset #12
/*      */     //   Java source line #2490	-> byte code offset #19
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\mysql\jdbc\CallableStatement.class
