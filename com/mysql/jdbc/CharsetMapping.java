...
/*     */   static
/*     */   {
/* 152 */     HashMap<String, Integer> tempNumBytesMap = new HashMap();
...
/*     */ 
/*     */ 
/* 292 */     HashMap<String, List<VersionedStringProperty>> javaToMysqlMap = new HashMap();
/*     */     
...
/*     */     
/*     */ 
/* 298 */     HashMap<String, String> mysqlToJavaMap = new HashMap();
/*     */     
...
/* 304 */       List<VersionedStringProperty> mysqlEncodingList = (List)JAVA_TO_MYSQL_CHARSET_MAP.get(javaEncodingName);
/*     */       
...
/*     */     
/*     */ 
/* 326 */     TreeMap<String, List<VersionedStringProperty>> ucMap = new TreeMap(String.CASE_INSENSITIVE_ORDER);
...
/*     */ 
/*     */ 
/* 338 */     HashMap<String, String> tempMapMulti = new HashMap();
/*     */     
...
/* 637 */     Map<Integer, String> indexToMysqlCharset = new HashMap();
/* 638 */     Map<String, Integer> indexMap = new TreeMap(String.CASE_INSENSITIVE_ORDER);
/*     */     
...
/*     */     
/* 658 */     Map<String, String> tempMap = new HashMap();
/*     */     
...
/*     */     try
/*     */     {
/* 693 */       List<VersionedStringProperty> mysqlEncodings = (List)JAVA_UC_TO_MYSQL_CHARSET_MAP.get(javaEncodingUC);
/*     */       
...
/* 737 */       SQLException sqlEx = SQLError.createSQLException(ex.toString(), "S1009", null);
...
/*     */       
/* 877 */       List<VersionedStringProperty> versionedProperties = (List)mapToPopulate.get(key);
/*     */       
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\mysql\jdbc\CharsetMapping.class
