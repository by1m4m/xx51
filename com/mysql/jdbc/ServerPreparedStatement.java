...
/*      */   {
/*  469 */     synchronized (checkClosed().getConnectionMutex())
/*      */     {
...
/*      */     throws SQLException
/*      */   {
/*  550 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*  616 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*  628 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*  676 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*  692 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */ 
/*      */ 
/*  833 */       int nbrCommands = updateCounts != null ? updateCounts : new int[0];jsr 16;return nbrCommands;
/*      */     } finally {
...
/*  838 */     clearBatch();ret;
/*      */     
/*  840 */     localObject9 = finally;throw ((Throwable)localObject9);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/*  852 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/*  935 */     synchronized (checkClosed().getConnectionMutex())
/*      */     {
...
/*      */     throws SQLException
/*      */   {
/* 1022 */     synchronized (checkClosed().getConnectionMutex())
/*      */     {
/* 1024 */       if (this.resultFields == null) {
/* 1025 */         return null;
/*      */       }
/*      */       
/* 1028 */       return new ResultSetMetaData(this.resultFields, this.connection.getUseOldAliasMetadataBehavior(), this.connection.getYearIsDateType(), getExceptionInterceptor());
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 1037 */     synchronized (checkClosed().getConnectionMutex())
/*      */     {
...
/*      */     }
/*      */     
/* 1075 */     synchronized (locallyScopedConn.getConnectionMutex())
/*      */     {
...
/* 1096 */           synchronized (this.connection.getConnectionMutex())
/*      */           {
/*      */             try {
...
/*      */     throws SQLException
/*      */   {
/* 1137 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 1230 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */ 
/*      */ 
/* 1315 */           packet.writeByte((byte)1);
/*      */         }
/*      */         else {
/* 1318 */           packet.writeByte((byte)0);
/*      */         }
/*      */         
...
/* 1334 */         packet.writeByte((byte)0);
/*      */       }
/*      */       
/* 1337 */       byte[] nullBitsBuffer = new byte[nullCount];
/*      */       
/*      */ 
/* 1340 */       packet.writeByte((byte)(this.sendTypesToServer ? 1 : 0));
/*      */       
...
/*      */           } else {
/* 1360 */             int tmp589_588 = (i / 8); byte[] tmp589_582 = nullBitsBuffer;tmp589_582[tmp589_588] = ((byte)(tmp589_582[tmp589_588] | 1 << (i & 0x7)));
/*      */           }
/*      */         }
/*      */       }
/*      */       
...
/*      */             
/* 1469 */             this.eventSink.consumeEvent(new ProfilerEvent((byte)6, "", this.currentCatalog, this.connection.getId(), getId(), 0, System.currentTimeMillis(), elapsedTime, mysql.getQueryTimingUnits(), null, LogUtils.findCallingClassAndMethod(new Throwable()), mesgBuf.toString()));
/*      */           }
/*      */           
/*      */ 
/*      */ 
...
/*      */           
/*      */ 
/* 1490 */           this.eventSink.consumeEvent(new ProfilerEvent((byte)4, "", this.currentCatalog, this.connectionId, this.statementId, -1, System.currentTimeMillis(), mysql.getCurrentTimeNanosOrMillis() - begin, mysql.getQueryTimingUnits(), null, LogUtils.findCallingClassAndMethod(new Throwable()), truncateQueryToLog(asSql(true))));
/*      */         }
/*      */         
/*      */ 
/*      */ 
...
/*      */           
/* 1518 */           this.eventSink.consumeEvent(new ProfilerEvent((byte)5, "", this.currentCatalog, this.connection.getId(), getId(), 0, System.currentTimeMillis(), fetchEndTime - queryEndTime, mysql.getQueryTimingUnits(), null, LogUtils.findCallingClassAndMethod(new Throwable()), null));
/*      */         }
/*      */         
/*      */ 
/*      */ 
...
/*      */         }
/*      */         
/* 1547 */         Object queryAsString = rs;jsr 45;return (ResultSetInternalMethods)queryAsString;
/*      */       } catch (SQLException sqlEx) {
...
/*      */     throws SQLException
/*      */   {
/* 1628 */     synchronized (checkClosed().getConnectionMutex()) {
...
/* 1684 */           this.eventSink.consumeEvent(new ProfilerEvent((byte)2, "", this.currentCatalog, this.connectionId, this.statementId, -1, System.currentTimeMillis(), mysql.getCurrentTimeNanosOrMillis() - begin, mysql.getQueryTimingUnits(), null, LogUtils.findCallingClassAndMethod(new Throwable()), truncateQueryToLog(sql)));
/*      */         }
/*      */         
/*      */ 
/*      */ 
...
/* 1750 */     synchronized (checkClosed().getConnectionMutex()) {
...
/* 1769 */     synchronized (checkClosed().getConnectionMutex())
/*      */     {
...
/*      */     throws SQLException
/*      */   {
/* 1834 */     synchronized (checkClosed().getConnectionMutex())
/*      */     {
/* 1836 */       if (x == null) {
...
/*      */     throws SQLException
/*      */   {
/* 1862 */     synchronized (checkClosed().getConnectionMutex())
/*      */     {
/* 1864 */       if (x == null) {
...
/*      */     throws SQLException
/*      */   {
/* 1887 */     synchronized (checkClosed().getConnectionMutex())
/*      */     {
/* 1889 */       if (x == null) {
...
/*      */     throws SQLException
/*      */   {
/* 1912 */     setByte(parameterIndex, (byte)(x ? 1 : 0));
/*      */   }
/*      */   
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 1954 */     synchronized (checkClosed().getConnectionMutex())
/*      */     {
/* 1956 */       if (reader == null) {
...
/*      */     throws SQLException
/*      */   {
/* 1979 */     synchronized (checkClosed().getConnectionMutex())
/*      */     {
/* 1981 */       if (x == null) {
...
/*      */     throws SQLException
/*      */   {
/* 2048 */     synchronized (checkClosed().getConnectionMutex())
/*      */     {
/* 2050 */       if ((!this.connection.getAllowNanAndInf()) && ((x == Double.POSITIVE_INFINITY) || (x == Double.NEGATIVE_INFINITY) || (Double.isNaN(x))))
/*      */       {
/*      */ 
...
/*      */     throws SQLException
/*      */   {
/* 2211 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 2294 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 2315 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 2324 */     synchronized (checkClosed().getConnectionMutex()) {
/* 2325 */       if (x == null) {
...
/* 2353 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 2410 */     synchronized (checkClosed().getConnectionMutex()) {
/*      */       try {
...
/* 2456 */             packet.writeLenBytes((byte[])value);
...
/*      */     throws SQLException
/*      */   {
/* 2482 */     synchronized (checkClosed().getConnectionMutex()) {
...
/* 2514 */           intoBuf.writeByte((byte)0);
/* 2515 */           intoBuf.writeByte((byte)0);
...
/*      */     throws SQLException
/*      */   {
/* 2541 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */   {
/* 2552 */     synchronized (checkClosed().getConnectionMutex()) {
...
/* 2598 */           intoBuf.writeByte((byte)0);
/* 2599 */           intoBuf.writeByte((byte)0);
/* 2600 */           intoBuf.writeByte((byte)0);
/*      */         } else {
...
/*      */     throws SQLException
/*      */   {
/* 2646 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 2744 */     synchronized (checkClosed().getConnectionMutex()) {
/* 2745 */       byte[] buf = new byte[' '];
/*      */       
/* 2747 */       int numRead = 0;
/*      */       try
/*      */       {
...
/* 2842 */     synchronized (checkClosed().getConnectionMutex()) {
...
/* 2898 */     synchronized (checkClosed().getConnectionMutex()) {
...
/* 2908 */     synchronized (checkClosed().getConnectionMutex()) {
...
/*      */     throws SQLException
/*      */   {
/* 2922 */     synchronized (checkClosed().getConnectionMutex()) {
...
/* 3068 */     synchronized (checkClosed().getConnectionMutex()) {
/*      */       try {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\mysql\jdbc\ServerPreparedStatement.class
