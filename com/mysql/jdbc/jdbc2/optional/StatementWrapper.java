...
/*  51 */     if (Util.isJdbc4()) {
/*     */       try {
/*  53 */         JDBC_4_STATEMENT_WRAPPER_CTOR = Class.forName("com.mysql.jdbc.jdbc2.optional.JDBC4StatementWrapper").getConstructor(new Class[] { ConnectionWrapper.class, MysqlPooledConnection.class, java.sql.Statement.class });
/*     */ 
/*     */       }
...
/* 858 */         ((com.mysql.jdbc.Statement)this.wrappedStmt).enableStreamingResults();
/*     */       }
/*     */       else {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\com\mysql\jdbc\jdbc2\optional\StatementWrapper.class
