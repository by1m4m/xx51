...
/*  56 */   private final Map<ChannelOption<?>, Object> options = new LinkedHashMap();
/*  57 */   private final Map<AttributeKey<?>, Object> attrs = new LinkedHashMap();
/*     */   
...
/*     */     }
/* 106 */     return channelFactory(new ReflectiveChannelFactory(channelClass));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 134 */     return channelFactory(channelFactory);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */           
/* 309 */           AbstractBootstrap.doBind0(regFuture, channel, localAddress, promise);
/*     */         }
/*     */       }
/* 312 */     });
/* 313 */     return promise;
...
/*     */     try {
/* 320 */       channel = this.channelFactory.newChannel();
/* 321 */       init(channel);
/*     */     } catch (Throwable t) {
/* 323 */       if (channel != null)
/*     */       {
...
/*     */       }
/* 407 */       copied = new LinkedHashMap(map); }
/*     */     Map<K, V> copied;
...
/* 444 */       setChannelOption(channel, (ChannelOption)e.getKey(), e.getValue(), logger);
/*     */     }
/*     */   }
/*     */   
...
/* 451 */       setChannelOption(channel, (ChannelOption)e.getKey(), e.getValue(), logger);
/*     */     }
/*     */   }
/*     */   
