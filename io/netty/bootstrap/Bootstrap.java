...
/*     */   
/*  57 */   private volatile AddressResolverGroup<SocketAddress> resolver = DEFAULT_RESOLVER;
/*     */   
...
/*     */   {
/*  80 */     this.resolver = (resolver == null ? DEFAULT_RESOLVER : resolver);
/*  81 */     return this;
/*     */   }
/*     */   
/*     */ 
...
/* 188 */           Bootstrap.this.doResolveAndConnect0(channel, remoteAddress, localAddress, promise);
/*     */         }
/*     */       }
/* 191 */     });
/* 192 */     return promise;
...
/* 200 */       AddressResolver<SocketAddress> resolver = this.resolver.getResolver(eventLoop);
/*     */       
...
/*     */       
/*     */ 
/* 225 */       resolveFuture.addListener(new FutureListener()
/*     */       {
...
/*     */     {
/*     */       public void run() {
/* 251 */         if (this.val$localAddress == null) {
/* 252 */           channel.connect(remoteAddress, connectPromise);
/*     */         } else {
/* 254 */           channel.connect(remoteAddress, this.val$localAddress, connectPromise);
/*     */         }
...
/* 275 */         channel.attr((AttributeKey)e.getKey()).set(e.getValue());
/*     */       }
/*     */     }
/*     */   }
/*     */   
