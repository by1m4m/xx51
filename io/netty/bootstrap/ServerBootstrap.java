...
/*     */   
/*  47 */   private final Map<ChannelOption<?>, Object> childOptions = new LinkedHashMap();
/*  48 */   private final Map<AttributeKey<?>, Object> childAttrs = new LinkedHashMap();
...
/*     */       {
/* 151 */         AttributeKey<Object> key = (AttributeKey)e.getKey();
...
/* 163 */       currentChildOptions = (Map.Entry[])this.childOptions.entrySet().toArray(newOptionArray(0)); }
/*     */     final Map.Entry<ChannelOption<?>, Object>[] currentChildOptions;
/* 165 */     Object currentChildAttrs; synchronized (this.childAttrs) {
/* 166 */       currentChildAttrs = (Map.Entry[])this.childAttrs.entrySet().toArray(newAttrArray(0));
/*     */     }
/*     */     final Map.Entry<AttributeKey<?>, Object>[] currentChildAttrs;
/* 169 */     p.addLast(new ChannelHandler[] { new ChannelInitializer()
/*     */     {
...
/*     */         {
/*     */           public void run() {
/* 181 */             pipeline.addLast(new ChannelHandler[] { new ServerBootstrap.ServerBootstrapAcceptor(ch, ServerBootstrap.1.this.val$currentChildGroup, ServerBootstrap.1.this.val$currentChildHandler, ServerBootstrap.1.this.val$currentChildOptions, ServerBootstrap.1.this.val$currentChildAttrs) });
/*     */           }
/*     */         });
/*     */       }
/*     */     } });
...
/* 251 */         child.attr((AttributeKey)e.getKey()).set(e.getValue());
/*     */       }
/*     */       try
/*     */       {
/* 255 */         this.childGroup.register(child).addListener(new ChannelFutureListener()
/*     */         {
