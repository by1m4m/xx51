...
/*     */     case ADVANCED: 
/*     */     case PARANOID: 
/*  48 */       ResourceLeakTracker<ByteBuf> leak = AbstractByteBuf.leakDetector.track(buf);
/*  49 */       if (leak != null) {
...
/*     */     case SIMPLE: 
/*  63 */       ResourceLeakTracker<ByteBuf> leak = AbstractByteBuf.leakDetector.track(buf);
/*  64 */       if (leak != null) {
...
/*     */     case ADVANCED: 
/*     */     case PARANOID: 
/*  70 */       ResourceLeakTracker<ByteBuf> leak = AbstractByteBuf.leakDetector.track(buf);
/*  71 */       if (leak != null) {
...
/*     */   {
/* 152 */     return heapBuffer(256, Integer.MAX_VALUE);
/*     */   }
/*     */   
/*     */   public ByteBuf heapBuffer(int initialCapacity)
/*     */   {
/* 157 */     return heapBuffer(initialCapacity, Integer.MAX_VALUE);
/*     */   }
/*     */   
...
/*     */   {
/* 171 */     return directBuffer(256, Integer.MAX_VALUE);
/*     */   }
/*     */   
/*     */   public ByteBuf directBuffer(int initialCapacity)
/*     */   {
/* 176 */     return directBuffer(initialCapacity, Integer.MAX_VALUE);
/*     */   }
/*     */   
...
/* 268 */       int newCapacity = minNewCapacity / 4194304 * 4194304;
/* 269 */       if (newCapacity > maxCapacity - 4194304) {
/* 270 */         newCapacity = maxCapacity;
/*     */       } else {
/* 272 */         newCapacity += 4194304;
/*     */       }
