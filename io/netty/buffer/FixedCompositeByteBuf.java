...
/* 349 */       return (_getInt(index) & 0xFFFFFFFF) << 32 | _getInt(index + 4) & 0xFFFFFFFF;
/*     */     }
/* 351 */     return _getInt(index) & 0xFFFFFFFF | (_getInt(index + 4) & 0xFFFFFFFF) << 32;
/*     */   }
/*     */   
/*     */ 
...
/* 361 */       return _getIntLE(index) & 0xFFFFFFFF | (_getIntLE(index + 4) & 0xFFFFFFFF) << 32;
/*     */     }
/* 363 */     return (_getIntLE(index) & 0xFFFFFFFF) << 32 | _getIntLE(index + 4) & 0xFFFFFFFF;
/*     */   }
/*     */   
/*     */ 
...
/* 574 */       ByteBuf s = c.buf;
/*     */       int localLength;
/* 576 */       for (;;) { localLength = Math.min(length, s.readableBytes() - (index - adjustment));
...
/*     */       }
/*     */       
/* 596 */       return (ByteBuffer[])array.toArray(new ByteBuffer[0]);
/*     */     } finally {
/* 598 */       array.recycle();
/*     */     }
/*     */   }
