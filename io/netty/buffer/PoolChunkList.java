...
/*     */ {
/*  29 */   private static final Iterator<PoolChunkMetric> EMPTY_METRICS = Collections.emptyList().iterator();
/*     */   
...
/*     */     }
/*     */     
/*  84 */     PoolChunk<T> cur = this.head;
/*  85 */     for (;;) { long handle = cur.allocate(normCapacity);
/*  86 */       if (handle < 0L) {
/*  87 */         cur = cur.next;
/*  88 */         if (cur == null) {
/*  89 */           return false;
...
/*     */       }
/* 199 */       List<PoolChunkMetric> metrics = new ArrayList();
/* 200 */       PoolChunk<T> cur = this.head;
/* 201 */       for (;;) { metrics.add(cur);
/* 202 */         cur = cur.next;
/* 203 */         if (cur == null) {
/*     */           break;
/*     */         }
...
/*     */       }
/*     */       
/* 219 */       PoolChunk<T> cur = this.head;
/* 220 */       for (;;) { buf.append(cur);
/* 221 */         cur = cur.next;
/* 222 */         if (cur == null) {
/*     */           break;
/*     */         }
