...
/*     */   static
/*     */   {
/*  35 */     logger = InternalLoggerFactory.getInstance(PooledByteBufAllocator.class);
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*  84 */     int defaultMinNumArena = io.netty.util.NettyRuntime.availableProcessors() * 2;
...
/*     */   }
/*     */   
/* 142 */   public static final PooledByteBufAllocator DEFAULT = new PooledByteBufAllocator(
/* 143 */     PlatformDependent.directBufferPreferred());
...
/* 234 */       List<PoolArenaMetric> metrics = new ArrayList(this.heapArenas.length);
...
/* 250 */       List<PoolArenaMetric> metrics = new ArrayList(this.directArenas.length);
...
/* 272 */       throw new IllegalArgumentException("pageSize: " + pageSize + " (expected: " + 4096 + ")");
/*     */     }
/*     */     
...
/*     */     {
/* 435 */       PoolArena<byte[]> heapArena = leastUsedArena(PooledByteBufAllocator.this.heapArenas);
...
/* 439 */       if ((this.useCacheForAllThreads) || ((current instanceof FastThreadLocalThread))) {
/* 440 */         return new PoolThreadCache(heapArena, directArena, 
/* 441 */           PooledByteBufAllocator.this.tinyCacheSize, PooledByteBufAllocator.this.smallCacheSize, PooledByteBufAllocator.this.normalCacheSize, 
/* 442 */           PooledByteBufAllocator.DEFAULT_MAX_CACHED_BUFFER_CAPACITY, PooledByteBufAllocator.DEFAULT_CACHE_TRIM_INTERVAL);
/*     */       }
/*     */       
...
/*     */   {
/* 522 */     PoolArena<?>[] arenas = this.heapArenas != null ? this.heapArenas : this.directArenas;
/* 523 */     if (arenas == null) {
/* 524 */       return 0;
/*     */     }
/*     */     
...
/* 576 */     return usedMemory(this.heapArenas);
/*     */   }
/*     */   
/*     */   final long usedDirectMemory() {
/* 580 */     return usedMemory(this.directArenas);
/*     */   }
/*     */   
...
/* 613 */     PoolArena<byte[]> localPoolArena1; PoolArena<byte[]> a; if (heapArenasLen > 0) {
/* 614 */       PoolArena[] arrayOfPoolArena1 = this.heapArenas;int i = arrayOfPoolArena1.length; for (localPoolArena1 = 0; localPoolArena1 < i; localPoolArena1++) { a = arrayOfPoolArena1[localPoolArena1];
/* 615 */         buf.append(a);
/*     */       }
/*     */     }
/*     */     
...
/* 625 */       PoolArena[] arrayOfPoolArena2 = this.directArenas;localPoolArena1 = arrayOfPoolArena2.length; for (a = 0; a < localPoolArena1; a++) { PoolArena<ByteBuffer> a = arrayOfPoolArena2[a];
/* 626 */         buf.append(a);
/*     */       }
/*     */     }
/*     */     
