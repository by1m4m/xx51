...
/*     */ {
/*  32 */   private static final Recycler<PooledDirectByteBuf> RECYCLER = new Recycler()
/*     */   {
/*     */     protected PooledDirectByteBuf newObject(Recycler.Handle<PooledDirectByteBuf> handle) {
/*  35 */       return new PooledDirectByteBuf(handle, 0, null);
/*     */     }
/*     */   };
/*     */   
...
/*     */   {
/*  76 */     index = idx(index);
/*  77 */     return (((ByteBuffer)this.memory).get(index) & 0xFF) << 16 | 
/*  78 */       (((ByteBuffer)this.memory).get(index + 1) & 0xFF) << 8 | ((ByteBuffer)this.memory)
/*  79 */       .get(index + 2) & 0xFF;
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     index = idx(index);
/*  85 */     return ((ByteBuffer)this.memory).get(index) & 0xFF | 
/*  86 */       (((ByteBuffer)this.memory).get(index + 1) & 0xFF) << 8 | 
/*  87 */       (((ByteBuffer)this.memory).get(index + 2) & 0xFF) << 16;
/*     */   }
/*     */   
/*     */   protected int _getInt(int index)
/*     */   {
/*  92 */     return ((ByteBuffer)this.memory).getInt(idx(index));
/*     */   }
/*     */   
...
/*     */   {
/* 102 */     return ((ByteBuffer)this.memory).getLong(idx(index));
/*     */   }
/*     */   
...
/*     */     ByteBuffer tmpBuf;
/* 136 */     ByteBuffer tmpBuf; if (internal) {
/* 137 */       tmpBuf = internalNioBuffer();
/*     */     } else {
/* 139 */       tmpBuf = ((ByteBuffer)this.memory).duplicate();
/*     */     }
/* 141 */     index = idx(index);
...
/*     */     ByteBuffer tmpBuf;
/* 163 */     ByteBuffer tmpBuf; if (internal) {
/* 164 */       tmpBuf = internalNioBuffer();
/*     */     } else {
/* 166 */       tmpBuf = ((ByteBuffer)this.memory).duplicate();
/*     */     }
/* 168 */     index = idx(index);
...
/* 191 */       return;
/*     */     }
/* 193 */     ByteBufUtil.readBytes(alloc(), internal ? internalNioBuffer() : ((ByteBuffer)this.memory).duplicate(), idx(index), length, out);
/*     */   }
/*     */   
...
/*     */     } else {
/* 219 */       tmpBuf = ((ByteBuffer)this.memory).duplicate();
/*     */     }
/* 221 */     index = idx(index);
...
/*     */     }
/*     */     
/* 237 */     ByteBuffer tmpBuf = internal ? internalNioBuffer() : ((ByteBuffer)this.memory).duplicate();
/* 238 */     index = idx(index);
...
/*     */   {
/* 261 */     ((ByteBuffer)this.memory).put(idx(index), (byte)value);
/*     */   }
/*     */   
/*     */   protected void _setShort(int index, int value)
/*     */   {
/* 266 */     ((ByteBuffer)this.memory).putShort(idx(index), (short)value);
/*     */   }
/*     */   
...
/*     */   {
/* 276 */     index = idx(index);
/* 277 */     ((ByteBuffer)this.memory).put(index, (byte)(value >>> 16));
/* 278 */     ((ByteBuffer)this.memory).put(index + 1, (byte)(value >>> 8));
/* 279 */     ((ByteBuffer)this.memory).put(index + 2, (byte)value);
/*     */   }
/*     */   
/*     */   protected void _setMediumLE(int index, int value)
/*     */   {
/* 284 */     index = idx(index);
/* 285 */     ((ByteBuffer)this.memory).put(index, (byte)value);
/* 286 */     ((ByteBuffer)this.memory).put(index + 1, (byte)(value >>> 8));
/* 287 */     ((ByteBuffer)this.memory).put(index + 2, (byte)(value >>> 16));
/*     */   }
/*     */   
/*     */   protected void _setInt(int index, int value)
/*     */   {
/* 292 */     ((ByteBuffer)this.memory).putInt(idx(index), value);
/*     */   }
/*     */   
...
/*     */   {
/* 302 */     ((ByteBuffer)this.memory).putLong(idx(index), value);
/*     */   }
/*     */   
...
/* 407 */     index = idx(index);
/* 408 */     return ((ByteBuffer)((ByteBuffer)this.memory).duplicate().position(index).limit(index + length)).slice();
/*     */   }
/*     */   
