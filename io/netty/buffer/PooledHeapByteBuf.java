...
/*     */ {
/*  31 */   private static final Recycler<PooledHeapByteBuf> RECYCLER = new Recycler()
/*     */   {
...
/*     */   {
/*  55 */     return HeapByteBufUtil.getByte((byte[])this.memory, idx(index));
/*     */   }
/*     */   
/*     */   protected short _getShort(int index)
/*     */   {
/*  60 */     return HeapByteBufUtil.getShort((byte[])this.memory, idx(index));
/*     */   }
/*     */   
/*     */   protected short _getShortLE(int index)
/*     */   {
/*  65 */     return HeapByteBufUtil.getShortLE((byte[])this.memory, idx(index));
/*     */   }
/*     */   
/*     */   protected int _getUnsignedMedium(int index)
/*     */   {
/*  70 */     return HeapByteBufUtil.getUnsignedMedium((byte[])this.memory, idx(index));
/*     */   }
/*     */   
/*     */   protected int _getUnsignedMediumLE(int index)
/*     */   {
/*  75 */     return HeapByteBufUtil.getUnsignedMediumLE((byte[])this.memory, idx(index));
/*     */   }
/*     */   
/*     */   protected int _getInt(int index)
/*     */   {
/*  80 */     return HeapByteBufUtil.getInt((byte[])this.memory, idx(index));
/*     */   }
/*     */   
/*     */   protected int _getIntLE(int index)
/*     */   {
/*  85 */     return HeapByteBufUtil.getIntLE((byte[])this.memory, idx(index));
/*     */   }
/*     */   
/*     */   protected long _getLong(int index)
/*     */   {
/*  90 */     return HeapByteBufUtil.getLong((byte[])this.memory, idx(index));
/*     */   }
/*     */   
/*     */   protected long _getLongLE(int index)
/*     */   {
/*  95 */     return HeapByteBufUtil.getLongLE((byte[])this.memory, idx(index));
/*     */   }
/*     */   
...
/* 102 */       PlatformDependent.copyMemory((byte[])this.memory, idx(index), dst.memoryAddress() + dstIndex, length);
/* 103 */     } else if (dst.hasArray()) {
/* 104 */       getBytes(index, dst.array(), dst.arrayOffset() + dstIndex, length);
/*     */     } else {
/* 106 */       dst.setBytes(dstIndex, (byte[])this.memory, idx(index), length);
/*     */     }
/* 108 */     return this;
/*     */   }
/*     */   
...
/* 121 */     dst.put((byte[])this.memory, idx(index), dst.remaining());
/* 122 */     return this;
/*     */   }
/*     */   
...
/* 128 */     out.write((byte[])this.memory, idx(index), length);
/* 129 */     return this;
/*     */   }
/*     */   
...
/* 139 */     index = idx(index);
/*     */     ByteBuffer tmpBuf;
/* 141 */     ByteBuffer tmpBuf; if (internal) {
/* 142 */       tmpBuf = internalNioBuffer();
/*     */     } else {
/* 144 */       tmpBuf = ByteBuffer.wrap((byte[])this.memory);
/*     */     }
...
/* 156 */     index = idx(index);
/* 157 */     ByteBuffer tmpBuf = internal ? internalNioBuffer() : ByteBuffer.wrap((byte[])this.memory);
...
/*     */   {
/* 179 */     HeapByteBufUtil.setByte((byte[])this.memory, idx(index), value);
/*     */   }
/*     */   
/*     */   protected void _setShort(int index, int value)
/*     */   {
/* 184 */     HeapByteBufUtil.setShort((byte[])this.memory, idx(index), value);
/*     */   }
/*     */   
/*     */   protected void _setShortLE(int index, int value)
/*     */   {
/* 189 */     HeapByteBufUtil.setShortLE((byte[])this.memory, idx(index), value);
/*     */   }
/*     */   
/*     */   protected void _setMedium(int index, int value)
/*     */   {
/* 194 */     HeapByteBufUtil.setMedium((byte[])this.memory, idx(index), value);
/*     */   }
/*     */   
/*     */   protected void _setMediumLE(int index, int value)
/*     */   {
/* 199 */     HeapByteBufUtil.setMediumLE((byte[])this.memory, idx(index), value);
/*     */   }
/*     */   
/*     */   protected void _setInt(int index, int value)
/*     */   {
/* 204 */     HeapByteBufUtil.setInt((byte[])this.memory, idx(index), value);
/*     */   }
/*     */   
/*     */   protected void _setIntLE(int index, int value)
/*     */   {
/* 209 */     HeapByteBufUtil.setIntLE((byte[])this.memory, idx(index), value);
/*     */   }
/*     */   
/*     */   protected void _setLong(int index, long value)
/*     */   {
/* 214 */     HeapByteBufUtil.setLong((byte[])this.memory, idx(index), value);
/*     */   }
/*     */   
/*     */   protected void _setLongLE(int index, long value)
/*     */   {
/* 219 */     HeapByteBufUtil.setLongLE((byte[])this.memory, idx(index), value);
/*     */   }
/*     */   
...
/* 226 */       PlatformDependent.copyMemory(src.memoryAddress() + srcIndex, (byte[])this.memory, idx(index), length);
/* 227 */     } else if (src.hasArray()) {
/* 228 */       setBytes(index, src.array(), src.arrayOffset() + srcIndex, length);
/*     */     } else {
/* 230 */       src.getBytes(srcIndex, (byte[])this.memory, idx(index), length);
/*     */     }
/* 232 */     return this;
/*     */   }
/*     */   
...
/* 246 */     src.get((byte[])this.memory, idx(index), length);
/* 247 */     return this;
/*     */   }
/*     */   
...
/* 253 */     return in.read((byte[])this.memory, idx(index), length);
/*     */   }
/*     */   
...
/* 282 */     copy.writeBytes((byte[])this.memory, idx(index), length);
/* 283 */     return copy;
/*     */   }
/*     */   
...
/* 299 */     index = idx(index);
/* 300 */     ByteBuffer buf = ByteBuffer.wrap((byte[])this.memory, index, length);
