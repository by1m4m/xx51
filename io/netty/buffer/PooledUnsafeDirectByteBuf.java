...
/*     */ {
/*  32 */   private static final Recycler<PooledUnsafeDirectByteBuf> RECYCLER = new Recycler()
/*     */   {
/*     */ 
/*  35 */     protected PooledUnsafeDirectByteBuf newObject(Recycler.Handle<PooledUnsafeDirectByteBuf> handle) { return new PooledUnsafeDirectByteBuf(handle, 0, null); }
/*     */   };
...
/*  65 */     this.memoryAddress = (PlatformDependent.directBufferAddress((ByteBuffer)this.memory) + this.offset);
/*     */   }
/*     */   
...
/*     */     } else {
/* 171 */       tmpBuf = ((ByteBuffer)this.memory).duplicate();
/*     */     }
/* 173 */     index = idx(index);
...
/*     */     }
/*     */     
/* 189 */     ByteBuffer tmpBuf = internal ? internalNioBuffer() : ((ByteBuffer)this.memory).duplicate();
/* 190 */     index = idx(index);
...
/* 325 */     index = idx(index);
/* 326 */     return ((ByteBuffer)((ByteBuffer)this.memory).duplicate().position(index).limit(index + length)).slice();
/*     */   }
/*     */   
