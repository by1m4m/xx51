...
/*     */ {
/*  29 */   private final UnpooledByteBufAllocatorMetric metric = new UnpooledByteBufAllocatorMetric(null);
/*     */   
/*     */ 
...
/*     */     
/*  77 */     this.noCleaner = ((tryNoCleaner) && (PlatformDependent.hasUnsafe()) && (PlatformDependent.hasDirectBufferNoCleanerConstructor()));
/*     */   }
/*     */   
...
/* 139 */       super(initialCapacity, maxCapacity);
/*     */     }
/*     */     
...
/* 159 */       super(initialCapacity, maxCapacity);
/*     */     }
/*     */     
/*     */     protected byte[] allocateArray(int initialCapacity)
/*     */     {
...
/*     */     {
/* 181 */       super(initialCapacity, maxCapacity);
/*     */     }
/*     */     
...
/* 210 */       super(initialCapacity, maxCapacity);
/*     */     }
/*     */     
/*     */     protected ByteBuffer allocateDirect(int initialCapacity)
/*     */     {
...
/* 231 */       super(initialCapacity, maxCapacity);
/*     */     }
/*     */     
/*     */     protected ByteBuffer allocateDirect(int initialCapacity)
/*     */     {
...
/*     */     {
/* 265 */       return 
/* 266 */         StringUtil.simpleClassName(this) + "(usedHeapMemory: " + usedHeapMemory() + "; usedDirectMemory: " + usedDirectMemory() + ')';
/*     */     }
/*     */   }
/*     */ }
