...
/*  60 */       return 
/*     */       
/*  62 */         (PlatformDependent.getByte(address) & 0xFF) << 16 | (PlatformDependent.BIG_ENDIAN_NATIVE_ORDER ? PlatformDependent.getShort(address + 1L) : Short.reverseBytes(PlatformDependent.getShort(address + 1L))) & 0xFFFF;
/*     */     }
/*  64 */     return 
/*     */     
/*  66 */       (PlatformDependent.getByte(address) & 0xFF) << 16 | (PlatformDependent.getByte(address + 1L) & 0xFF) << 8 | PlatformDependent.getByte(address + 2L) & 0xFF;
/*     */   }
/*     */   
...
/*  71 */       return 
/*     */       
/*  73 */         PlatformDependent.getByte(address) & 0xFF | ((PlatformDependent.BIG_ENDIAN_NATIVE_ORDER ? Short.reverseBytes(PlatformDependent.getShort(address + 1L)) : PlatformDependent.getShort(address + 1L)) & 0xFFFF) << 8;
/*     */     }
/*  75 */     return 
/*     */     
/*  77 */       PlatformDependent.getByte(address) & 0xFF | (PlatformDependent.getByte(address + 1L) & 0xFF) << 8 | (PlatformDependent.getByte(address + 2L) & 0xFF) << 16;
/*     */   }
/*     */   
...
/*     */     
/*     */ 
/*  88 */       PlatformDependent.getByte(address) << 24 | (PlatformDependent.getByte(address + 1L) & 0xFF) << 16 | (PlatformDependent.getByte(address + 2L) & 0xFF) << 8 | PlatformDependent.getByte(address + 3L) & 0xFF;
/*     */   }
/*     */   
...
/*     */     
/*     */ 
/*  99 */       PlatformDependent.getByte(address) & 0xFF | (PlatformDependent.getByte(address + 1L) & 0xFF) << 8 | (PlatformDependent.getByte(address + 2L) & 0xFF) << 16 | PlatformDependent.getByte(address + 3L) << 24;
/*     */   }
/*     */   
...
/*     */ 
/*     */ 
/* 114 */       PlatformDependent.getByte(address) << 56 | (PlatformDependent.getByte(address + 1L) & 0xFF) << 48 | (PlatformDependent.getByte(address + 2L) & 0xFF) << 40 | (PlatformDependent.getByte(address + 3L) & 0xFF) << 32 | (PlatformDependent.getByte(address + 4L) & 0xFF) << 24 | (PlatformDependent.getByte(address + 5L) & 0xFF) << 16 | (PlatformDependent.getByte(address + 6L) & 0xFF) << 8 | PlatformDependent.getByte(address + 7L) & 0xFF;
/*     */   }
/*     */   
...
/*     */     } else {
/* 204 */       PlatformDependent.putByte(address, (byte)(int)(value >>> 56));
/* 205 */       PlatformDependent.putByte(address + 1L, (byte)(int)(value >>> 48));
/* 206 */       PlatformDependent.putByte(address + 2L, (byte)(int)(value >>> 40));
/* 207 */       PlatformDependent.putByte(address + 3L, (byte)(int)(value >>> 32));
/* 208 */       PlatformDependent.putByte(address + 4L, (byte)(int)(value >>> 24));
/* 209 */       PlatformDependent.putByte(address + 5L, (byte)(int)(value >>> 16));
/* 210 */       PlatformDependent.putByte(address + 6L, (byte)(int)(value >>> 8));
...
/* 220 */       PlatformDependent.putByte(address + 1L, (byte)(int)(value >>> 8));
/* 221 */       PlatformDependent.putByte(address + 2L, (byte)(int)(value >>> 16));
/* 222 */       PlatformDependent.putByte(address + 3L, (byte)(int)(value >>> 24));
/* 223 */       PlatformDependent.putByte(address + 4L, (byte)(int)(value >>> 32));
/* 224 */       PlatformDependent.putByte(address + 5L, (byte)(int)(value >>> 40));
/* 225 */       PlatformDependent.putByte(address + 6L, (byte)(int)(value >>> 48));
/* 226 */       PlatformDependent.putByte(address + 7L, (byte)(int)(value >>> 56));
/*     */     }
/*     */   }
/*     */   
...
/* 254 */       return 
/*     */       
/* 256 */         (PlatformDependent.getByte(array, index) & 0xFF) << 16 | (PlatformDependent.BIG_ENDIAN_NATIVE_ORDER ? PlatformDependent.getShort(array, index + 1) : Short.reverseBytes(PlatformDependent.getShort(array, index + 1))) & 0xFFFF;
/*     */     }
/*     */     
/* 259 */     return 
/*     */     
/* 261 */       (PlatformDependent.getByte(array, index) & 0xFF) << 16 | (PlatformDependent.getByte(array, index + 1) & 0xFF) << 8 | PlatformDependent.getByte(array, index + 2) & 0xFF;
/*     */   }
/*     */   
...
/* 266 */       return 
/*     */       
/* 268 */         PlatformDependent.getByte(array, index) & 0xFF | ((PlatformDependent.BIG_ENDIAN_NATIVE_ORDER ? Short.reverseBytes(PlatformDependent.getShort(array, index + 1)) : PlatformDependent.getShort(array, index + 1)) & 0xFFFF) << 8;
/*     */     }
/* 270 */     return 
/*     */     
/* 272 */       PlatformDependent.getByte(array, index) & 0xFF | (PlatformDependent.getByte(array, index + 1) & 0xFF) << 8 | (PlatformDependent.getByte(array, index + 2) & 0xFF) << 16;
/*     */   }
/*     */   
...
/*     */     
/*     */ 
/* 283 */       PlatformDependent.getByte(array, index) << 24 | (PlatformDependent.getByte(array, index + 1) & 0xFF) << 16 | (PlatformDependent.getByte(array, index + 2) & 0xFF) << 8 | PlatformDependent.getByte(array, index + 3) & 0xFF;
/*     */   }
/*     */   
...
/*     */     
/*     */ 
/* 294 */       PlatformDependent.getByte(array, index) & 0xFF | (PlatformDependent.getByte(array, index + 1) & 0xFF) << 8 | (PlatformDependent.getByte(array, index + 2) & 0xFF) << 16 | PlatformDependent.getByte(array, index + 3) << 24;
/*     */   }
/*     */   
...
/*     */ 
/*     */ 
/* 309 */       PlatformDependent.getByte(array, index) << 56 | (PlatformDependent.getByte(array, index + 1) & 0xFF) << 48 | (PlatformDependent.getByte(array, index + 2) & 0xFF) << 40 | (PlatformDependent.getByte(array, index + 3) & 0xFF) << 32 | (PlatformDependent.getByte(array, index + 4) & 0xFF) << 24 | (PlatformDependent.getByte(array, index + 5) & 0xFF) << 16 | (PlatformDependent.getByte(array, index + 6) & 0xFF) << 8 | PlatformDependent.getByte(array, index + 7) & 0xFF;
/*     */   }
/*     */   
...
/*     */     } else {
/* 401 */       PlatformDependent.putByte(array, index, (byte)(int)(value >>> 56));
/* 402 */       PlatformDependent.putByte(array, index + 1, (byte)(int)(value >>> 48));
/* 403 */       PlatformDependent.putByte(array, index + 2, (byte)(int)(value >>> 40));
/* 404 */       PlatformDependent.putByte(array, index + 3, (byte)(int)(value >>> 32));
/* 405 */       PlatformDependent.putByte(array, index + 4, (byte)(int)(value >>> 24));
/* 406 */       PlatformDependent.putByte(array, index + 5, (byte)(int)(value >>> 16));
/* 407 */       PlatformDependent.putByte(array, index + 6, (byte)(int)(value >>> 8));
...
/* 417 */       PlatformDependent.putByte(array, index + 1, (byte)(int)(value >>> 8));
/* 418 */       PlatformDependent.putByte(array, index + 2, (byte)(int)(value >>> 16));
/* 419 */       PlatformDependent.putByte(array, index + 3, (byte)(int)(value >>> 24));
/* 420 */       PlatformDependent.putByte(array, index + 4, (byte)(int)(value >>> 32));
/* 421 */       PlatformDependent.putByte(array, index + 5, (byte)(int)(value >>> 40));
/* 422 */       PlatformDependent.putByte(array, index + 6, (byte)(int)(value >>> 48));
/* 423 */       PlatformDependent.putByte(array, index + 7, (byte)(int)(value >>> 56));
/*     */     }
/*     */   }
/*     */   
