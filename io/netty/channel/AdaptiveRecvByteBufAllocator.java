...
/*     */   
/*  68 */   private static int getSizeTableIndex(int size) { int low = 0;int high = SIZE_TABLE.length - 1;
/*  69 */     for (;;) { if (high < low) {
/*  70 */         return low;
/*     */       }
/*  72 */       if (high == low) {
...
/*     */     
/*  98 */     public HandleImpl(int minIndex, int maxIndex, int initial) { super();
