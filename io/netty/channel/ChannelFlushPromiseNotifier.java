...
/* 130 */     notifyPromises();
/*     */     for (;;) {
/* 132 */       FlushCheckpoint cp = (FlushCheckpoint)this.flushCheckpoints.poll();
/* 133 */       if (cp == null) {
/*     */         break;
/*     */       }
...
/*     */     for (;;) {
/* 172 */       FlushCheckpoint cp = (FlushCheckpoint)this.flushCheckpoints.poll();
/* 173 */       if (cp == null) {
/*     */         break;
/*     */       }
...
/*     */     for (;;) {
/* 201 */       FlushCheckpoint cp = (FlushCheckpoint)this.flushCheckpoints.peek();
/* 202 */       if (cp == null)
/*     */       {
...
/* 209 */         if ((writeCounter <= 0L) || (this.flushCheckpoints.size() != 1)) break;
/* 210 */         this.writeCounter = 0L;
/* 211 */         cp.flushCheckpoint(cp.flushCheckpoint() - writeCounter); break;
/*     */       }
/*     */       
/*     */ 
/*     */ 
