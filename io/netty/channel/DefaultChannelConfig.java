...
/* 108 */       if (!setOption((ChannelOption)e.getKey(), e.getValue())) {
...
/*     */     try
/*     */     {
/* 230 */       MaxMessagesRecvByteBufAllocator allocator = (MaxMessagesRecvByteBufAllocator)getRecvByteBufAllocator();
...
/*     */     try
/*     */     {
/* 248 */       MaxMessagesRecvByteBufAllocator allocator = (MaxMessagesRecvByteBufAllocator)getRecvByteBufAllocator();
...
/*     */   {
/* 296 */     return this.rcvBufAllocator;
/*     */   }
/*     */   
...
/*     */     for (;;)
/*     */     {
/* 365 */       WriteBufferWaterMark waterMark = this.writeBufferWaterMark;
/* 366 */       if (writeBufferHighWaterMark < waterMark.low())
/*     */       {
/*     */ 
/* 369 */         throw new IllegalArgumentException("writeBufferHighWaterMark cannot be less than writeBufferLowWaterMark (" + waterMark.low() + "): " + writeBufferHighWaterMark);
/*     */       }
/*     */       
/* 372 */       if (WATERMARK_UPDATER.compareAndSet(this, waterMark, new WriteBufferWaterMark(waterMark
...
/*     */     for (;;)
/*     */     {
/* 391 */       WriteBufferWaterMark waterMark = this.writeBufferWaterMark;
/* 392 */       if (writeBufferLowWaterMark > waterMark.high())
/*     */       {
/*     */ 
/* 395 */         throw new IllegalArgumentException("writeBufferLowWaterMark cannot be greater than writeBufferHighWaterMark (" + waterMark.high() + "): " + writeBufferLowWaterMark);
/*     */       }
/*     */       
/* 398 */       if (WATERMARK_UPDATER.compareAndSet(this, waterMark, new WriteBufferWaterMark(writeBufferLowWaterMark, waterMark
/* 399 */         .high(), false))) {
/* 400 */         return this;
/*     */       }
/*     */     }
