...
/*     */   static
/*     */   {
/*  41 */     logger = InternalLoggerFactory.getInstance(DefaultChannelId.class);
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*  49 */     nextSequence = new AtomicInteger();
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/* 195 */     this.data[(i++)] = ((byte)(int)(value >>> 56));
/* 196 */     this.data[(i++)] = ((byte)(int)(value >>> 48));
/* 197 */     this.data[(i++)] = ((byte)(int)(value >>> 40));
/* 198 */     this.data[(i++)] = ((byte)(int)(value >>> 32));
/* 199 */     this.data[(i++)] = ((byte)(int)(value >>> 24));
/* 200 */     this.data[(i++)] = ((byte)(int)(value >>> 16));
/* 201 */     this.data[(i++)] = ((byte)(int)(value >>> 8));
