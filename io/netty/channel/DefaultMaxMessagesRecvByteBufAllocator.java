...
/*     */     {
/* 142 */       return (this.config.isAutoRead()) && ((!this.respectMaybeMoreData) || 
/* 143 */         (maybeMoreDataSupplier.get())) && (this.totalMessages < this.maxMessagePerRead) && (this.totalBytesRead > 0);
/*     */     }
/*     */     
/*     */ 
/*     */ 
