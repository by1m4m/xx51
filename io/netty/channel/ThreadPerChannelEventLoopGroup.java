...
/*  53 */   final Queue<EventLoop> idleChildren = new ConcurrentLinkedQueue();
/*     */   
/*     */   private final ChannelException tooManyChannels;
/*     */   private volatile boolean shuttingDown;
/*  57 */   private final Promise<?> terminationFuture = new DefaultPromise(GlobalEventExecutor.INSTANCE);
/*  58 */   private final FutureListener<Object> childTerminationListener = new FutureListener()
/*     */   {
...
/*     */   {
/* 148 */     return new ReadOnlyIterator(this.activeChildren.iterator());
/*     */   }
/*     */   
...
/*     */   {
/* 177 */     return this.terminationFuture;
/*     */   }
/*     */   
/*     */   @Deprecated
...
/* 247 */     for (EventLoop l : this.activeChildren) {
/*     */       for (;;) {
...
/*     */       }
/*     */     }
/* 258 */     for (EventLoop l : this.idleChildren) {
/*     */       for (;;) {
...
/*     */     }
/*     */     
/* 314 */     EventLoop loop = (EventLoop)this.idleChildren.poll();
/* 315 */     if (loop == null) {
...
/* 320 */       loop.terminationFuture().addListener(this.childTerminationListener);
/*     */     }
