...
/*  55 */   private static enum State { OPEN,  ACTIVE,  CLOSED;
/*     */     private State() {} }
...
/* 166 */     this.config = new DefaultChannelConfig(this);
...
/* 195 */     p.addLast(new ChannelHandler[] { new ChannelInitializer()
/*     */     {
...
/*     */     } });
/* 207 */     if (register) {
/* 208 */       ChannelFuture future = this.loop.register(this);
...
/*     */     throws Exception
/*     */   {
/* 217 */     ChannelFuture future = this.loop.register(this);
...
/*     */   {
/* 291 */     T message = poll(this.inboundMessages);
/* 292 */     if (message != null) {
...
/*     */   {
/* 303 */     T message = poll(this.outboundMessages);
/* 304 */     if (message != null) {
...
/*     */         }
/*     */         else {
/* 404 */           future.addListener(this.recordExceptionListener);
/*     */         }
/*     */       }
/*     */       
/* 408 */       checkException();
...
/*     */   {
/* 713 */     return new EmbeddedUnsafe(null);
/*     */   }
/*     */   
...
/*     */ 
/*     */ 
/* 748 */   protected void handleInboundMessage(Object msg) { inboundMessages().add(msg); }
/*     */   
/*     */   private final class EmbeddedUnsafe extends AbstractChannel.AbstractUnsafe {
/* 751 */     private EmbeddedUnsafe() { super(); }
/*     */     
/*     */ 
/*     */ 
/* 755 */     final Channel.Unsafe wrapped = new Channel.Unsafe()
/*     */     {
