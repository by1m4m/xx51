...
/*     */   {
/*  56 */     return new EpollDomainSocketChannel(this, new Socket(fd));
/*     */   }
/*     */   
...
/*     */   {
/*     */     try {
/*  75 */       super.doClose(); } finally { DomainSocketAddress local;
/*     */       File socketFile;
/*  77 */       boolean success; DomainSocketAddress local = this.local;
/*  78 */       if (local != null)
/*     */       {
