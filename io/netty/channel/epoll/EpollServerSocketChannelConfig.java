...
/*  52 */       return Boolean.valueOf(isReusePort());
/*     */     }
/*  54 */     if (option == EpollChannelOption.IP_FREEBIND) {
/*  55 */       return Boolean.valueOf(isFreeBind());
/*     */     }
/*  57 */     if (option == EpollChannelOption.IP_TRANSPARENT) {
/*  58 */       return Boolean.valueOf(isIpTransparent());
/*     */     }
/*  60 */     if (option == EpollChannelOption.TCP_DEFER_ACCEPT) {
/*  61 */       return Integer.valueOf(getTcpDeferAccept());
/*     */     }
...
/*     */     {
/*  78 */       Map<InetAddress, byte[]> m = (Map)value;
/*  79 */       setTcpMd5Sig(m);
