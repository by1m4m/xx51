...
/*     */   public static final int EPOLLERR; public static final boolean IS_SUPPORTING_SENDMMSG; public static final boolean IS_SUPPORTING_TCP_FASTOPEN;
/*  58 */   static { try { offsetofEpollData();
/*     */     }
...
/*     */ 
/*     */ 
/*  67 */     EPOLLIN = NativeStaticallyReferencedJniMethods.epollin();
/*  68 */     EPOLLOUT = NativeStaticallyReferencedJniMethods.epollout();
/*  69 */     EPOLLRDHUP = NativeStaticallyReferencedJniMethods.epollrdhup();
/*  70 */     EPOLLET = NativeStaticallyReferencedJniMethods.epollet();
/*  71 */     EPOLLERR = NativeStaticallyReferencedJniMethods.epollerr();
/*     */     
/*  73 */     IS_SUPPORTING_SENDMMSG = NativeStaticallyReferencedJniMethods.isSupportingSendmmsg();
/*  74 */     IS_SUPPORTING_TCP_FASTOPEN = NativeStaticallyReferencedJniMethods.isSupportingTcpFastopen();
/*  75 */     TCP_MD5SIG_MAXKEYLEN = NativeStaticallyReferencedJniMethods.tcpMd5SigMaxKeyLen();
/*  76 */     KERNEL_VERSION = NativeStaticallyReferencedJniMethods.kernelVersion();
/*     */     
/*     */ 
/*     */ 
/*  80 */     SENDMMSG_CLOSED_CHANNEL_EXCEPTION = (ClosedChannelException)ThrowableUtil.unknownStackTrace(new ClosedChannelException(), Native.class, "sendmmsg(...)");
/*     */     
/*  82 */     SPLICE_CLOSED_CHANNEL_EXCEPTION = (ClosedChannelException)ThrowableUtil.unknownStackTrace(new ClosedChannelException(), Native.class, "splice(...)"); }
/*     */   
/*     */   public static final int TCP_MD5SIG_MAXKEYLEN;
/*     */   public static final String KERNEL_VERSION;
/*  86 */   private static final Errors.NativeIoException SENDMMSG_CONNECTION_RESET_EXCEPTION = Errors.newConnectionResetException("syscall:sendmmsg(...)", Errors.ERRNO_EPIPE_NEGATIVE);
/*     */   
/*  88 */   private static final Errors.NativeIoException SPLICE_CONNECTION_RESET_EXCEPTION = Errors.newConnectionResetException("syscall:splice(...)", Errors.ERRNO_EPIPE_NEGATIVE);
...
/*     */   
/*     */ 
/*     */   public static int epollWait(FileDescriptor epollFd, EpollEventArray events, FileDescriptor timerFd, int timeoutSec, int timeoutNs)
/*     */     throws IOException
/*     */   {
