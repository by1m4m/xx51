...
/*  61 */       super.getOptions(), new ChannelOption[] { ChannelOption.SO_BROADCAST, ChannelOption.SO_RCVBUF, ChannelOption.SO_SNDBUF, ChannelOption.SO_REUSEADDR, ChannelOption.IP_MULTICAST_LOOP_DISABLED, ChannelOption.IP_MULTICAST_ADDR, ChannelOption.IP_MULTICAST_IF, ChannelOption.IP_MULTICAST_TTL, ChannelOption.IP_TOS, ChannelOption.DATAGRAM_CHANNEL_ACTIVE_ON_REGISTRATION, UnixChannelOption.SO_REUSEPORT });
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*  71 */       return Boolean.valueOf(isBroadcast());
/*     */     }
...
/*  83 */       return Boolean.valueOf(isLoopbackModeDisabled());
/*     */     }
/*  85 */     if (option == ChannelOption.IP_MULTICAST_ADDR) {
/*  86 */       return getInterface();
/*     */     }
/*  88 */     if (option == ChannelOption.IP_MULTICAST_IF) {
/*  89 */       return getNetworkInterface();
/*     */     }
/*  91 */     if (option == ChannelOption.IP_MULTICAST_TTL) {
/*  92 */       return Integer.valueOf(getTimeToLive());
/*     */     }
/*  94 */     if (option == ChannelOption.IP_TOS) {
/*  95 */       return Integer.valueOf(getTrafficClass());
/*     */     }
/*  97 */     if (option == ChannelOption.DATAGRAM_CHANNEL_ACTIVE_ON_REGISTRATION) {
/*  98 */       return Boolean.valueOf(this.activeOnOpen);
/*     */     }
/* 100 */     if (option == UnixChannelOption.SO_REUSEPORT) {
/* 101 */       return Boolean.valueOf(isReusePort());
/*     */     }
/* 103 */     return (T)super.getOption(option);
/*     */   }
/*     */   
/*     */ 
