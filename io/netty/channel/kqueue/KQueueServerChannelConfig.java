...
/*  54 */       return Integer.valueOf(getReceiveBufferSize());
/*     */     }
/*  56 */     if (option == ChannelOption.SO_REUSEADDR) {
/*  57 */       return Boolean.valueOf(isReuseAddress());
/*     */     }
/*  59 */     if (option == ChannelOption.SO_BACKLOG) {
/*  60 */       return Integer.valueOf(getBacklog());
/*     */     }
/*  62 */     return (T)super.getOption(option);
/*     */   }
/*     */   
