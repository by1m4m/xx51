...
/*     */   {
/*  95 */     super(null);
/*  96 */     config().setAllocator(new PreferHeapByteBufAllocator(this.config.getAllocator()));
/*     */   }
/*     */   
/*     */   protected LocalChannel(LocalServerChannel parent, LocalChannel peer) {
/* 100 */     super(parent);
/* 101 */     config().setAllocator(new PreferHeapByteBufAllocator(this.config.getAllocator()));
/* 102 */     this.peer = peer;
...
/*     */   {
/* 144 */     return new LocalUnsafe(null);
/*     */   }
/*     */   
...
/*     */     throws Exception
/*     */   {
/* 201 */     this.localAddress = LocalChannelRegistry.register(this, this.localAddress, localAddress);
/*     */     
...
/*     */   }
/*     */   
/* 450 */   private class LocalUnsafe extends AbstractChannel.AbstractUnsafe { private LocalUnsafe() { super(); }
/*     */     
/*     */ 
