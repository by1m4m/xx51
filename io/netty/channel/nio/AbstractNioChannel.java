...
/*     */       } else {
/* 174 */         eventLoop.execute(this.clearReadPendingRunnable);
/*     */       }
/*     */       
/*     */     }
/*     */     else
...
/*     */   {
/* 218 */     protected AbstractNioUnsafe() { super(); }
/*     */     
...
/* 263 */             AbstractNioChannel.this.connectTimeoutFuture = AbstractNioChannel.this.eventLoop().schedule(new Runnable()
/*     */             {
/*     */               public void run() {
...
/* 270 */                   AbstractNioChannel.AbstractNioUnsafe.this.close(AbstractNioChannel.AbstractNioUnsafe.this.voidPromise()); } }, connectTimeoutMillis, TimeUnit.MILLISECONDS);
/*     */           }
/*     */           
/*     */ 
/*     */ 
