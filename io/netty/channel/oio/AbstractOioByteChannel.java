...
/* 124 */           if (byteBuf.isReadable()) break;
/* 125 */           byteBuf.release();
/* 126 */           byteBuf = null;
/* 127 */           close = allocHandle.lastBytesRead() < 0;
/* 128 */           if (!close)
/*     */             break;
/* 130 */           this.readPending = false; break;
/*     */         }
/*     */         
/*     */ 
/*     */ 
...
/* 145 */           int capacity = byteBuf.capacity();
...
/*     */     
/*     */ 
/* 232 */     throw new UnsupportedOperationException("unsupported message type: " + StringUtil.simpleClassName(msg) + EXPECTED_TYPES);
/*     */   }
/*     */   
