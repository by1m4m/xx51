...
/* 109 */     this.bootstrap.handler(new ChannelInitializer()
/*     */     {
...
/*     */     } else {
/* 228 */       f.addListener(new FutureListener()
/*     */       {
...
/*     */     } else {
/* 323 */       f.addListener(new FutureListener()
/*     */       {
/*     */         public void operationComplete(Future<Boolean> future) throws Exception {
...
/*     */   {
/* 376 */     return this.lastRecentUsed ? (Channel)this.deque.pollLast() : (Channel)this.deque.pollFirst();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */       }
/*     */       
/* 398 */       channel.close().awaitUninterruptibly();
/*     */     }
/*     */   }
/*     */ }
