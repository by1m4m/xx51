...
/*  64 */       super.getOptions(), new ChannelOption[] { ChannelOption.SO_RCVBUF, ChannelOption.SO_SNDBUF, SctpChannelOption.SCTP_NODELAY, SctpChannelOption.SCTP_INIT_MAXSTREAMS });
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*  78 */       return Boolean.valueOf(isSctpNoDelay());
/*     */     }
/*  80 */     if (option == SctpChannelOption.SCTP_INIT_MAXSTREAMS) {
/*  81 */       return getInitMaxStreams();
/*     */     }
...
/*     */   {
/*     */     try {
/* 108 */       return ((Boolean)this.javaChannel.getOption(SctpStandardSocketOptions.SCTP_NODELAY)).booleanValue();
/*     */     } catch (IOException e) {
...
/*     */   {
/*     */     try {
/* 127 */       return ((Integer)this.javaChannel.getOption(SctpStandardSocketOptions.SO_SNDBUF)).intValue();
/*     */     } catch (IOException e) {
...
/*     */   {
/*     */     try {
/* 146 */       return ((Integer)this.javaChannel.getOption(SctpStandardSocketOptions.SO_RCVBUF)).intValue();
/*     */     } catch (IOException e) {
...
/*     */   {
/*     */     try {
/* 165 */       return (SctpStandardSocketOptions.InitMaxStreams)this.javaChannel.getOption(SctpStandardSocketOptions.SCTP_INIT_MAXSTREAMS);
/*     */     } catch (IOException e) {
