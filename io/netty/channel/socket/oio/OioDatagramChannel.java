...
/*  64 */     StringUtil.simpleClassName(io.netty.channel.socket.DatagramPacket.class) + ", " + 
...
/*     */   {
/* 139 */     return (isOpen()) && (
/* 140 */       ((((Boolean)this.config.getOption(ChannelOption.DATAGRAM_CHANNEL_ACTIVE_ON_REGISTRATION)).booleanValue()) && (isRegistered())) || 
/* 141 */       (this.socket.isBound()));
/*     */   }
/*     */   
...
/* 222 */       buf.add(new io.netty.channel.socket.DatagramPacket(data.writerIndex(allocHandle.lastBytesRead()), localAddress(), remoteAddr));
/* 223 */       free = false;
/* 224 */       return 1;
/*     */     }
...
/*     */       {
/* 255 */         AddressedEnvelope<ByteBuf, SocketAddress> envelope = (AddressedEnvelope)o;
/* 256 */         SocketAddress remoteAddress = envelope.recipient();
...
/*     */   {
/* 296 */     if (((msg instanceof io.netty.channel.socket.DatagramPacket)) || ((msg instanceof ByteBuf))) {
/* 297 */       return msg;
/*     */     }
/*     */     
/* 300 */     if ((msg instanceof AddressedEnvelope))
/*     */     {
/* 302 */       AddressedEnvelope<Object, SocketAddress> e = (AddressedEnvelope)msg;
...
/*     */     
/*     */ 
/* 309 */     throw new UnsupportedOperationException("unsupported message type: " + StringUtil.simpleClassName(msg) + EXPECTED_TYPES);
/*     */   }
/*     */   
...
/* 363 */     if (!isActive())
/*     */     {
/* 365 */       throw new IllegalStateException(DatagramChannel.class.getName() + " must be bound to join a group.");
/*     */     }
/*     */   }
/*     */   
/*     */ 
