...
/* 102 */       return Integer.valueOf(getProtocolReceiveBufferSize());
/*     */     }
/* 104 */     if (option == UdtChannelOption.PROTOCOL_SEND_BUFFER_SIZE) {
/* 105 */       return Integer.valueOf(getProtocolSendBufferSize());
/*     */     }
/* 107 */     if (option == UdtChannelOption.SYSTEM_RECEIVE_BUFFER_SIZE) {
/* 108 */       return Integer.valueOf(getSystemReceiveBufferSize());
/*     */     }
/* 110 */     if (option == UdtChannelOption.SYSTEM_SEND_BUFFER_SIZE) {
/* 111 */       return Integer.valueOf(getSystemSendBufferSize());
/*     */     }
/* 113 */     if (option == ChannelOption.SO_RCVBUF) {
/* 114 */       return Integer.valueOf(getReceiveBufferSize());
/*     */     }
/* 116 */     if (option == ChannelOption.SO_SNDBUF) {
/* 117 */       return Integer.valueOf(getSendBufferSize());
/*     */     }
/* 119 */     if (option == ChannelOption.SO_REUSEADDR) {
/* 120 */       return Boolean.valueOf(isReuseAddress());
/*     */     }
/* 122 */     if (option == ChannelOption.SO_LINGER) {
/* 123 */       return Integer.valueOf(getSoLinger());
/*     */     }
