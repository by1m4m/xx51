...
/*     */   {
/*  55 */     super(null, channelUDT, 16);
/*     */     try {
/*  57 */       channelUDT.configureBlocking(false);
/*  58 */       this.config = new DefaultUdtServerChannelConfig(this, channelUDT, true);
/*     */     } catch (Exception e) {
/*     */       try {
/*  61 */         channelUDT.close();
/*     */       } catch (Exception e2) {
...
/*     */   {
/* 153 */     SocketChannelUDT channelUDT = (SocketChannelUDT)SocketUtils.accept(javaChannel());
