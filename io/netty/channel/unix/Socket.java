...
/* 137 */       byte[] address = addr.getAddress();
...
/* 161 */       byte[] address = addr.getAddress();
...
/*     */   }
/*     */   
/*     */   public final int sendToAddresses(long memoryAddress, int length, InetAddress addr, int port)
/*     */     throws IOException
/*     */   {
/*     */     int scopeId;
/*     */     int scopeId;
...
/* 185 */       byte[] address = addr.getAddress();
...
/* 245 */       res = connect(this.fd, address.address, address.scopeId, inetSocketAddress.getPort()); } else { int res;
/* 246 */       if ((socketAddress instanceof DomainSocketAddress)) {
...
/*     */     throws IOException;
/*     */   
/*     */   private static native int getTrafficClass(int paramInt)
/*     */     throws IOException;
/*     */   
...
/*     */     throws IOException;
/*     */   
/*     */   private static native void setTrafficClass(int paramInt1, int paramInt2)
/*     */     throws IOException;
/*     */   
