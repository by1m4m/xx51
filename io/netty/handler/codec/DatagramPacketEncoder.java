...
/*     */   {
/*  57 */     this.encoder = ((MessageToMessageEncoder)ObjectUtil.checkNotNull(encoder, "encoder"));
/*     */   }
/*     */   
...
/*  65 */       return (this.encoder.acceptOutboundMessage(envelope.content())) && 
/*  66 */         ((envelope.sender() instanceof InetSocketAddress)) && 
...
/*     */     
/*  77 */     this.encoder.encode(ctx, msg.content(), out);
/*  78 */     if (out.size() != 1)
/*     */     {
/*  80 */       throw new EncoderException(StringUtil.simpleClassName(this.encoder) + " must produce only one message.");
/*     */     }
...
/*     */     }
/*     */     else {
/*  88 */       throw new EncoderException(StringUtil.simpleClassName(this.encoder) + " must produce only ByteBuf.");
/*     */     }
/*     */   }
/*     */   
