...
/*     */   
/*  50 */   static { DELIMITERS.set(9);
/*  51 */     for (char c = ' '; c <= '/'; c = (char)(c + '\001')) {
/*  52 */       DELIMITERS.set(c);
/*     */     }
/*  54 */     for (char c = ';'; c <= '@'; c = (char)(c + '\001')) {
/*  55 */       DELIMITERS.set(c);
/*     */     }
/*  57 */     for (char c = '['; c <= '`'; c = (char)(c + '\001')) {
/*  58 */       DELIMITERS.set(c);
/*     */     }
/*  60 */     for (char c = '{'; c <= '~'; c = (char)(c + '\001')) {
/*  61 */       DELIMITERS.set(c);
/*     */     }
/*     */   }
/*     */   
/*  65 */   private static final String[] DAY_OF_WEEK_TO_SHORT_NAME = { "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" };
/*     */   
/*     */ 
/*  68 */   private static final String[] CALENDAR_MONTH_TO_SHORT_NAME = { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" };
/*     */   
/*     */ 
/*  71 */   private static final FastThreadLocal<DateFormatter> INSTANCES = new FastThreadLocal()
/*     */   {
/*     */     protected DateFormatter initialValue()
/*     */     {
/*  75 */       return new DateFormatter(null);
/*     */     }
/*     */   };
/*     */   
/*     */ 
...
/*     */ 
/*     */ 
/* 326 */         this.year = (getNumericalValue(c0) * 1000 + getNumericalValue(c1) * 100 + getNumericalValue(c2) * 10 + getNumericalValue(c3));
/* 327 */         return true;
/*     */       }
/*     */     }
/*     */     
