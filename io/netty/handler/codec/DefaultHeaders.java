...
/*      */   }
/*      */   
/*   77 */   public DefaultHeaders(ValueConverter<V> valueConverter) { this(HashingStrategy.JAVA_HASHER, valueConverter); }
/*      */   
/*      */ 
...
/*      */   {
/*  106 */     this.valueConverter = ((ValueConverter)ObjectUtil.checkNotNull(valueConverter, "valueConverter"));
/*  107 */     this.nameValidator = ((NameValidator)ObjectUtil.checkNotNull(nameValidator, "nameValidator"));
/*  108 */     this.hashingStrategy = ((HashingStrategy)ObjectUtil.checkNotNull(nameHashingStrategy, "nameHashingStrategy"));
/*      */     
/*      */ 
/*  111 */     this.entries = new HeaderEntry[MathUtil.findNextPositivePowerOfTwo(Math.max(2, Math.min(arraySizeHint, 128)))];
/*  112 */     this.hashMask = ((byte)(this.entries.length - 1));
/*  113 */     this.head = new HeaderEntry();
/*      */   }
/*      */   
/*      */   public V get(K name)
/*      */   {
...
/*  147 */     return (V)remove0(h, index(h), ObjectUtil.checkNotNull(name, "name"));
/*      */   }
/*      */   
...
/*      */     
/*  163 */     LinkedList<V> values = new LinkedList();
/*      */     
...
/*      */     {
/*  403 */       defaultHeaders = (DefaultHeaders)headers;
/*      */       
...
/*  480 */     V convertedValue = ObjectUtil.checkNotNull(this.valueConverter.convertObject(value), "convertedValue");
...
/*      */   public T clear()
/*      */   {
/*  592 */     Arrays.fill(this.entries, null);
...
/*      */   {
/*  600 */     return new HeaderIterator(null);
/*      */   }
/*      */   
...
/*      */     }
/*      */     
/*  898 */     return equals((Headers)o, HashingStrategy.JAVA_HASHER);
/*      */   }
/*      */   
/*      */ 
/*      */   public int hashCode()
...
/*  961 */     return new HeaderEntry(h, name, value, next, this.head);
/*      */   }
/*      */   
...
/*      */     
/* 1035 */     public boolean hasNext() { return this.current.after != DefaultHeaders.this.head; }
/*      */     
/*      */ 
...
/*      */     
/*      */     ValueIterator() {
/* 1061 */       this.name = ObjectUtil.checkNotNull(name, "name");
...
/* 1128 */       this.hash = -1;
/* 1129 */       this.key = null;
/* 1130 */       this.after = this;this.before = this;
/*      */     }
/*      */     
...
/*      */     {
/* 1153 */       return (K)this.key;
/*      */     }
/*      */     
/*      */     public final V getValue()
/*      */     {
/* 1158 */       return (V)this.value;
/*      */     }
/*      */     
