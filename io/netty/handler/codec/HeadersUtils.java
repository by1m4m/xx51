...
/*     */   {
/*  42 */     List<V> allNames = headers.getAll(name);
/*  43 */     new AbstractList()
/*     */     {
/*     */       public String get(int index) {
/*  46 */         V value = this.val$allNames.get(index);
/*  47 */         return value != null ? value.toString() : null;
/*     */       }
/*     */       
/*     */       public int size()
/*     */       {
/*  52 */         return this.val$allNames.size();
/*     */       }
/*     */     };
/*     */   }
/*     */   
...
/*  93 */       Map.Entry<?, ?> header = (Map.Entry)headersIt.next();
...
/*     */     {
/* 124 */       return new HeadersUtils.StringEntry((Map.Entry)this.iter.next());
/*     */     }
/*     */     
/*     */     public void remove()
/*     */     {
...
/*     */     {
/* 207 */       return this.allNames.addAll(c);
/*     */     }
/*     */   }
/*     */   
...
/* 215 */       this.allNames = ((Set)ObjectUtil.checkNotNull(allNames, "allNames"));
/*     */     }
/*     */     
/*     */     public int size()
/*     */     {
