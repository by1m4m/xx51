...
/*     */         }
/*     */       } else {
/* 101 */         ctx.write(msg, promise); } } catch (EncoderException e) { int sizeMinusOne;
/*     */       ChannelPromise voidPromise;
/*     */       boolean isVoidPromise;
/* 104 */       int i; ChannelPromise p; ChannelPromise p; throw e;
/*     */     } catch (Throwable t) {
...
/* 117 */           for (int i = 0; i < sizeMinusOne; i++) { ChannelPromise p;
/*     */             ChannelPromise p;
