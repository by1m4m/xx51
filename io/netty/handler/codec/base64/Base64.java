...
/*     */   {
/* 167 */     if (src.order() == ByteOrder.BIG_ENDIAN) { int inBuff;
/*     */       int inBuff;
/* 169 */       int inBuff; switch (numSigBytes) {
/*     */       case 1: 
...
/*     */       }
/*     */       
/* 180 */       encode3to4BigEndian(inBuff, numSigBytes, dest, destOffset, alphabet); } else { int inBuff;
/*     */       int inBuff;
/*     */       int inBuff;
...
/*     */   {
/* 201 */     long len43 = (len << 2) / 3L;
/*     */     
/*     */ 
/* 204 */     long ret = len43 + 3L & 0xFFFFFFFFFFFFFFFC;
/*     */     
/* 206 */     if (breakLines) {
/* 207 */       ret += len43 / 76L;
/*     */     }
...
/*     */     
/*     */ 
/* 323 */     return new Decoder(null).decode(src, off, len, allocator, dialect);
/*     */   }
/*     */   
...
/*     */       throws Exception
/*     */     {
/* 356 */       this.sbiCrop = ((byte)(value & 0x7F));
