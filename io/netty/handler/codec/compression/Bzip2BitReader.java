...
/*     */     
/*  65 */     if (bitCount < count) { int offset;
/*     */       int offset;
/*     */       int offset;
/*  68 */       long readData; int offset; switch (this.in.readableBytes()) {
/*     */       case 1: 
/*  70 */         long readData = this.in.readUnsignedByte();
/*  71 */         offset = 8;
/*  72 */         break;
/*     */       
/*     */       case 2: 
/*  75 */         long readData = this.in.readUnsignedShort();
/*  76 */         offset = 16;
/*  77 */         break;
/*     */       
/*     */       case 3: 
/*  80 */         long readData = this.in.readUnsignedMedium();
/*  81 */         offset = 24;
/*  82 */         break;
/*     */       
/*     */       default: 
