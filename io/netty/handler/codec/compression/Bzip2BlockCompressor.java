...
/*     */ 
/*     */ 
/*  72 */   private final boolean[] blockValuesPresent = new boolean['Ā'];
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */     int j;
/* 112 */     int k; for (int i = 0; i < condensedInUse.length; i++) {
/* 113 */       j = 0; for (k = i << 4; j < 16; k++) {
/* 114 */         if (blockValuesPresent[k] != 0) {
...
/* 125 */       if (condensedInUse[i] != 0) {
/* 126 */         int j = 0; for (int k = i << 4; j < 16; k++) {
/* 127 */           writer.writeBoolean(out, blockValuesPresent[k]);j++;
/*     */         }
/*     */       }
/*     */     }
/*     */   }
