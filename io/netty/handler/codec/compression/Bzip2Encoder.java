...
/* 126 */           int length = Math.min(in.readableBytes(), blockCompressor.availableSize());
/* 127 */           int bytesWritten = blockCompressor.write(in, in.readerIndex(), length);
...
/*     */         case CLOSE_BLOCK: 
/* 139 */           closeBlock(out);
/* 140 */           this.currentState = State.INIT_BLOCK;
/*     */         }
/*     */       }
...
/*     */     {
/*     */       public void run() {
/* 190 */         ChannelFuture f = Bzip2Encoder.this.finishEncode(Bzip2Encoder.access$000(Bzip2Encoder.this), promise);
/* 191 */         f.addListener(new ChannelPromiseNotifier(new ChannelPromise[] { promise }));
/*     */       }
/* 193 */     });
/* 194 */     return promise;
/*     */   }
...
/*     */       {
/*     */ 
/* 213 */         public void run() { ctx.close(promise); } }, 10L, TimeUnit.SECONDS);
/*     */     }
/*     */   }
/*     */   
/*     */ 
