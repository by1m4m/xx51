...
/*     */ 
/*     */ 
/* 137 */     for (int hslot = 0; hslot < 8192; hslot++)
/*     */     {
/* 139 */       htab[hslot] = ip;
/*     */     }
/*     */     
...
/*     */       {
/*     */ 
/* 182 */         int hval = hashFunction(input, inOffset + ip);
/*     */         
/* 184 */         hslot = hval;
/*     */         
/* 186 */         ref = htab[hval];
...
/*     */         
/*     */ 
/* 196 */         if ((distance != 0L) && (level == 1 ? distance < 8191L : distance < 73725L)) { if ((input[(inOffset + ref++)] == input[(inOffset + ip++)]) && (input[(inOffset + ref++)] == input[(inOffset + ip++)]) && (input[(inOffset + ref++)] == input[(inOffset + ip++)])) {}
/*     */ 
/*     */ 
/*     */         }
/*     */         else
...
/* 205 */           ip = anchor;
/* 206 */           copy++;
/* 207 */           if (copy != 32) continue;
/* 208 */           copy = 0;
/* 209 */           output[(outOffset + op++)] = 31; continue;
/*     */         }
/*     */         
/*     */ 
/*     */ 
...
/* 223 */               ip = anchor;
/* 224 */               copy++;
/* 225 */               if (copy != 32) continue;
/* 226 */               copy = 0;
/* 227 */               output[(outOffset + op++)] = 31; continue;
/*     */             }
/*     */             
/*     */ 
/* 231 */             len += 2;
...
/* 311 */           if (len < 7) {
/* 312 */             output[(outOffset + op++)] = ((byte)(int)((len << 5) + (distance >>> 8)));
/* 313 */             output[(outOffset + op++)] = ((byte)(int)(distance & 0xFF));
/*     */           } else {
/* 315 */             output[(outOffset + op++)] = ((byte)(int)(224L + (distance >>> 8)));
/* 316 */             for (len -= 7; len >= 255; len -= 255) {
/* 317 */               output[(outOffset + op++)] = -1;
/*     */             }
/* 319 */             output[(outOffset + op++)] = ((byte)len);
/* 320 */             output[(outOffset + op++)] = ((byte)(int)(distance & 0xFF));
/*     */           }
/*     */           
/*     */         }
/* 324 */         else if (len < 7) {
...
/* 328 */           output[(outOffset + op++)] = ((byte)(int)(distance >>> 8));
/* 329 */           output[(outOffset + op++)] = ((byte)(int)(distance & 0xFF));
/*     */         } else {
/* 331 */           distance -= 8191L;
...
/* 338 */           output[(outOffset + op++)] = ((byte)(int)(distance >>> 8));
/* 339 */           output[(outOffset + op++)] = ((byte)(int)(distance & 0xFF));
/*     */         }
/*     */       }
/*     */       else {
/* 343 */         if (len > 262) {
/* 344 */           while (len > 262) {
/* 345 */             output[(outOffset + op++)] = ((byte)(int)(224L + (distance >>> 8)));
/* 346 */             output[(outOffset + op++)] = -3;
/* 347 */             output[(outOffset + op++)] = ((byte)(int)(distance & 0xFF));
/* 348 */             len -= 262;
/*     */           }
/*     */         }
/*     */         
/* 352 */         if (len < 7) {
/* 353 */           output[(outOffset + op++)] = ((byte)(int)((len << 5) + (distance >>> 8)));
/* 354 */           output[(outOffset + op++)] = ((byte)(int)(distance & 0xFF));
/*     */         } else {
/* 356 */           output[(outOffset + op++)] = ((byte)(int)(224L + (distance >>> 8)));
/* 357 */           output[(outOffset + op++)] = ((byte)(len - 7));
/* 358 */           output[(outOffset + op++)] = ((byte)(int)(distance & 0xFF));
/*     */         }
/*     */       }
/*     */       
/*     */ 
...
/* 409 */     if (level == 2)
/*     */     {
/* 411 */       int tmp1581_1579 = outOffset; byte[] tmp1581_1578 = output;tmp1581_1578[tmp1581_1579] = ((byte)(tmp1581_1578[tmp1581_1579] | 0x20));
/*     */     }
/*     */     
/* 414 */     return op;
/*     */   }
...
/*     */           } else {
/*     */             int code;
/* 463 */             do { code = input[(inOffset + ip++)] & 0xFF;
/* 464 */               len += code;
/* 465 */             } while (code == 255);
/*     */           }
/*     */         }
...
/*     */         
/* 542 */         for (ctrl -= 1L; ctrl != 0L; ctrl -= 1L)
/*     */         {
