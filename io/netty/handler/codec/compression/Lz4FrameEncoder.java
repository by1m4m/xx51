...
/*     */ {
/*  72 */   private static final EncoderException ENCODE_FINSHED_EXCEPTION = (EncoderException)ThrowableUtil.unknownStackTrace(new EncoderException(new IllegalStateException("encode finished and not enough space to write remaining data")), Lz4FrameEncoder.class, "encode");
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/* 149 */     this(factory, highCompressor, blockSize, checksum, Integer.MAX_VALUE);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 268 */     int flushableBytes = this.buffer.readableBytes();
...
/*     */     {
/*     */       public void run() {
/* 370 */         ChannelFuture f = Lz4FrameEncoder.this.finishEncode(Lz4FrameEncoder.access$000(Lz4FrameEncoder.this), promise);
/* 371 */         f.addListener(new ChannelPromiseNotifier(new ChannelPromise[] { promise }));
/*     */       }
/* 373 */     });
/* 374 */     return promise;
/*     */   }
...
/*     */       {
/*     */ 
/* 393 */         public void run() { ctx.close(promise); } }, 10L, TimeUnit.SECONDS);
/*     */     }
/*     */   }
/*     */   
/*     */ 
