...
/* 186 */       this.encoder.code(bbIn, bbOut, -1L, -1L, null);
/*     */     } finally {
/* 188 */       if (bbIn != null) {
/* 189 */         bbIn.close();
/*     */       }
...
/* 210 */       factor = 1.5D; } else { double factor;
/* 211 */       if (inputLength < 500) {
/* 212 */         factor = 1.2D; } else { double factor;
/* 213 */         if (inputLength < 1000) {
/* 214 */           factor = 1.1D; } else { double factor;
/* 215 */           if (inputLength < 10000) {
/* 216 */             factor = 1.05D;
/*     */           } else
/* 218 */             factor = 1.02D;
/*     */         } } }
