...
/*     */     private State() {} }
/*     */   
/*  54 */   public void reset() { this.state = State.READY;
/*  55 */     this.tag = 0;
/*  56 */     this.written = 0;
/*     */   }
/*     */   
...
/* 307 */         int literalWritten = decodeLiteral(this.tag, in, out);
...
/*     */         case 1: 
/* 320 */           int decodeWritten = decodeCopyWith1ByteOffset(this.tag, in, out, this.written);
...
/*     */           break;
/*     */         case 2: 
/* 330 */           int decodeWritten = decodeCopyWith2ByteOffset(this.tag, in, out, this.written);
...
/*     */           break;
/*     */         case 3: 
/* 340 */           int decodeWritten = decodeCopyWith4ByteOffset(this.tag, in, out, this.written);
...
/*     */     int length;
/* 395 */     int length; int length; int length; int length; switch (tag >> 2 & 0x3F) {
/*     */     case 60: 
...
/* 460 */       for (int copies = length / offset; 
/* 461 */           copies > 0; copies--) {
...
/* 504 */       for (int copies = length / offset; 
/* 505 */           copies > 0; copies--) {
...
/* 548 */       for (int copies = length / offset; 
/* 549 */           copies > 0; copies--) {
...
/*     */     {
/*     */ 
/* 643 */       throw new DecompressionException("mismatching checksum: " + Integer.toHexString(actualChecksum) + " (expected: " + Integer.toHexString(expectedChecksum) + ')');
/*     */     }
/*     */   }
/*     */   
/*     */ 
