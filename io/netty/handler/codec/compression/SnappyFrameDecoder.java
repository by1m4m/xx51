...
/* 138 */         throw new DecompressionException("Found reserved unskippable chunk type: 0x" + Integer.toHexString(chunkTypeVal));
...
/* 154 */           Snappy.validateChecksum(checksum, in, in.readerIndex(), chunkLength - 4);
/*     */         } else {
/* 156 */           in.skipBytes(4);
/*     */         }
