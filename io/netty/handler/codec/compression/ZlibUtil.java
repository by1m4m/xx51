...
/*    */   
/*    */ 
/* 40 */   static CompressionException deflaterException(Deflater z, String message, int resultCode) { return new CompressionException(message + " (" + resultCode + ')' + (z.msg != null ? ": " + z.msg : "")); }
/*    */   
...
/*    */     JZlib.WrapperType convertedWrapperType;
/* 45 */     JZlib.WrapperType convertedWrapperType; switch (wrapper) {
/*    */     case NONE: 
