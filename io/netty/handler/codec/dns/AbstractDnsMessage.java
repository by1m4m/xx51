...
/*     */     
/*     */ 
/* 131 */     List<DnsRecord> recordList = (List)records;
...
/*     */     
/*     */ 
/* 160 */     List<DnsRecord> recordList = (List)records;
...
/*     */ 
/*     */ 
/* 188 */     List<DnsRecord> recordList = (List)records;
...
/*     */ 
/*     */ 
/* 226 */     List<DnsRecord> recordList = (List)records;
...
/* 246 */       List<DnsRecord> recordList = newRecordList();
...
/*     */     
/*     */ 
/* 254 */     List<DnsRecord> recordList = (List)records;
...
/*     */     {
/* 279 */       if (index == 0) {
/* 280 */         List<DnsRecord> recordList = newRecordList();
/* 281 */         recordList.add(record);
/* 282 */         recordList.add(castRecord(records));
/* 283 */       } else if (index == 1) {
/* 284 */         List<DnsRecord> recordList = newRecordList();
...
/*     */     
/*     */ 
/* 295 */     List<DnsRecord> recordList = (List)records;
...
/*     */     
/*     */ 
/* 321 */     List<DnsRecord> recordList = (List)records;
...
/*     */     {
/* 346 */       List<DnsRecord> list = (List)recordOrList;
/* 347 */       if (!list.isEmpty()) {
...
/*     */     {
/* 461 */       throw new IllegalArgumentException("record: " + record + " (expected: " + StringUtil.simpleClassName(DnsQuestion.class) + ')');
/*     */     }
/* 463 */     return record;
/*     */   }
/*     */   
...
/*     */   {
/* 468 */     return (DnsRecord)record;
/*     */   }
/*     */   
/*     */   private static ArrayList<DnsRecord> newRecordList() {
/* 472 */     return new ArrayList(2);
/*     */   }
/*     */ }
