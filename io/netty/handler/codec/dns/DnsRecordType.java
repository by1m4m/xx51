...
/*     */   
/* 306 */   private static final Map<String, DnsRecordType> BY_NAME = new HashMap();
/* 307 */   private static final IntObjectHashMap<DnsRecordType> BY_TYPE = new IntObjectHashMap();
/*     */   private static final String EXPECTED;
/*     */   private final int intValue;
/*     */   
/* 311 */   static { DnsRecordType[] all = { A, NS, CNAME, SOA, PTR, MX, TXT, RP, AFSDB, SIG, KEY, AAAA, LOC, SRV, NAPTR, KX, CERT, DNAME, OPT, APL, DS, SSHFP, IPSECKEY, RRSIG, NSEC, DNSKEY, DHCID, NSEC3, NSEC3PARAM, TLSA, HIP, SPF, TKEY, TSIG, IXFR, AXFR, ANY, CAA, TA, DLV };
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/* 344 */     DnsRecordType result = (DnsRecordType)BY_NAME.get(name);
/* 345 */     if (result == null) {
