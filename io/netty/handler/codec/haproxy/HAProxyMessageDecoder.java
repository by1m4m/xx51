...
/*  61 */   private static final byte[] BINARY_PREFIX = { 13, 10, 13, 10, 0, 13, 10, 81, 85, 73, 84, 10 };
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*  76 */   private static final byte[] TEXT_PREFIX = { 80, 82, 79, 88, 89 };
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 272 */       if (eoh >= 0) {
/* 273 */         int length = eoh - buffer.readerIndex();
/* 274 */         if (length > this.v2MaxHeaderSize) {
...
/* 315 */       if (eol >= 0) {
/* 316 */         int length = eol - buffer.readerIndex();
/* 317 */         if (length > 108) {
...
/* 362 */     HAProxyProtocolException ppex; if ((errMsg != null) && (e != null)) {
/* 363 */       ppex = new HAProxyProtocolException(errMsg, e); } else { HAProxyProtocolException ppex;
/* 364 */       if (errMsg != null) {
/* 365 */         ppex = new HAProxyProtocolException(errMsg); } else { HAProxyProtocolException ppex;
/* 366 */         if (e != null) {
