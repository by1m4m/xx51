...
/*  71 */         this.charSequenceEscaper = new CsvValueEscaper()
/*     */         {
...
/*     */     {
/*  84 */       super(valueConverter, nameValidator);
/*     */     }
/*     */     
...
/*  91 */         return itr;
/*     */       }
/*  93 */       Iterator<CharSequence> unescapedItr = StringUtil.unescapeCsvFields((CharSequence)itr.next()).iterator();
/*  94 */       if (itr.hasNext()) {
...
/*     */       }
/* 109 */       return StringUtil.unescapeCsvFields((CharSequence)values.get(0));
/*     */     }
/*     */     
/*     */ 
...
/* 125 */             addEscapedValue((CharSequence)header.getKey(), (CharSequence)header.getValue());
/*     */           }
/*     */         }
/*     */       } else {
/* 129 */         for (Map.Entry<? extends CharSequence, ? extends CharSequence> header : headers) {
/* 130 */           add((CharSequence)header.getKey(), (CharSequence)header.getValue());
/*     */         }
/*     */       }
/* 133 */       return this;
/*     */     }
...
/*     */     {
/* 200 */       super.set(name, commaSeparate(objectEscaper(), new Object[] { value }));
/* 201 */       return this;
/*     */     }
/*     */     
...
/* 217 */       CharSequence currentValue = (CharSequence)super.get(name);
...
/*     */       
/*     */ 
/* 258 */         new StringBuilder(currentValue.length() + 1 + value.length()).append(currentValue).append(',').append(value);
/*     */     }
/*     */     
