...
/*     */     }
/*     */   };
/*  54 */   static final DefaultHeaders.NameValidator<CharSequence> HttpNameValidator = new DefaultHeaders.NameValidator()
/*     */   {
...
/*  86 */     this(new DefaultHeadersImpl(AsciiString.CASE_INSENSITIVE_HASHER, 
...
/*     */   {
/* 212 */     return HeadersUtils.getAsString(this.headers, name);
/*     */   }
/*     */   
...
/*     */   {
/* 252 */     return HeadersUtils.getAllAsString(this.headers, name);
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/* 261 */     List<Map.Entry<String, String>> entriesConverted = new ArrayList(this.headers.size());
/* 262 */     for (Map.Entry<String, String> entry : this) {
...
/*     */   {
/* 271 */     return HeadersUtils.iteratorAsString(this.headers);
/*     */   }
/*     */   
...
/*     */   {
/* 337 */     return HeadersUtils.namesAsString(this.headers);
/*     */   }
/*     */   
/*     */   public boolean equals(Object o)
/*     */   {
/* 342 */     return ((o instanceof DefaultHttpHeaders)) && 
/* 343 */       (this.headers.equals(((DefaultHttpHeaders)o).headers, AsciiString.CASE_SENSITIVE_HASHER));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/*     */   }
/*     */   
/* 433 */   private static final class HeaderValueConverterAndValidator extends DefaultHttpHeaders.HeaderValueConverter { private HeaderValueConverterAndValidator() { super(); }
