...
/* 109 */     for (Map.Entry<String, String> e : trailingHeaders()) {
/* 110 */       buf.append((String)e.getKey());
/* 111 */       buf.append(": ");
/* 112 */       buf.append((String)e.getValue());
/* 113 */       buf.append(StringUtil.NEWLINE);
/*     */     }
/*     */   }
/*     */   
/*     */   private static final class TrailingHttpHeaders extends DefaultHttpHeaders {
/* 118 */     private static final DefaultHeaders.NameValidator<CharSequence> TrailerNameValidator = new DefaultHeaders.NameValidator()
/*     */     {
...
/*     */     {
/* 132 */       super(validate ? TrailerNameValidator : DefaultHeaders.NameValidator.NOT_NULL);
/*     */     }
/*     */   }
/*     */ }
