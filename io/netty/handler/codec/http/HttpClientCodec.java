...
/*     */ {
/*  49 */   private final Queue<HttpMethod> queue = new ArrayDeque();
/*     */   
...
/*     */   {
/*  97 */     init(new Decoder(maxInitialLineLength, maxHeaderSize, maxChunkSize, validateHeaders), new Encoder(null));
...
/*     */   {
/* 118 */     init(new Decoder(maxInitialLineLength, maxHeaderSize, maxChunkSize, validateHeaders, initialBufferSize), new Encoder(null));
/*     */     
...
/* 181 */       super(maxHeaderSize, maxChunkSize, validateHeaders);
/*     */     }
/*     */     
/*     */     Decoder(int maxInitialLineLength, int maxHeaderSize, int maxChunkSize, boolean validateHeaders, int initialBufferSize)
/*     */     {
/* 186 */       super(maxHeaderSize, maxChunkSize, validateHeaders, initialBufferSize);
/*     */     }
/*     */     
...
/*     */ 
/*     */ 
/* 234 */       HttpMethod method = (HttpMethod)HttpClientCodec.this.queue.poll();
/*     */       
...
/* 287 */           ctx.fireExceptionCaught(new PrematureChannelClosureException("channel gone inactive with " + missingResponses + " missing response(s)"));
/*     */         }
/*     */       }
/*     */     }
/*     */   }
