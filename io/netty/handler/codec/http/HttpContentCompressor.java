...
/* 137 */       ((headers instanceof HttpContent)) && 
/* 138 */       (((HttpContent)headers).content().readableBytes() < this.contentSizeThreshold)) {
/* 139 */       return null;
/*     */     }
/*     */     
/*     */ 
...
/* 170 */       .channel().config(), new ChannelHandler[] { ZlibCodecFactory.newZlibEncoder(wrapper, this.compressionLevel, this.windowBits, this.memLevel) }));
/*     */   }
/*     */   
/*     */ 
