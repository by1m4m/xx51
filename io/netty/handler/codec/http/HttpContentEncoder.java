...
/*     */   
/*  63 */   private final Queue<CharSequence> acceptEncodingQueue = new ArrayDeque();
...
/*     */       
/*  99 */       HttpResponse res = (HttpResponse)msg;
/* 100 */       int code = res.status().code();
/*     */       CharSequence acceptEncoding;
/* 102 */       CharSequence acceptEncoding; if (code == CONTINUE_CODE)
/*     */       {
/*     */ 
/* 105 */         acceptEncoding = null;
/*     */       }
/*     */       else {
/* 108 */         acceptEncoding = (CharSequence)this.acceptEncodingQueue.poll();
...
/*     */         
/*     */ 
/* 147 */         Result result = beginEncode(res, acceptEncoding.toString());
/*     */         
/*     */ 
/* 150 */         if (result == null) {
/* 151 */           if (isFull) {
...
/*     */     {
/*     */ 
/* 240 */       throw new IllegalStateException("unexpected message type: " + msg.getClass().getName() + " (expected: " + HttpResponse.class.getSimpleName() + ')');
/*     */     }
/*     */   }
/*     */   
...
/*     */     {
/*     */ 
/* 248 */       throw new IllegalStateException("unexpected message type: " + msg.getClass().getName() + " (expected: " + HttpContent.class.getSimpleName() + ')');
/*     */     }
/*     */   }
/*     */   
