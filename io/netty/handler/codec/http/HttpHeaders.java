...
/*      */ {
/*      */   @Deprecated
/*   53 */   public static final HttpHeaders EMPTY_HEADERS = ;
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/* 1419 */       add((String)e.getKey(), e.getValue());
/*      */     }
/* 1421 */     return this;
/*      */   }
/*      */   
...
/*      */     }
/*      */     
/* 1504 */     for (Map.Entry<String, String> entry : headers) {
/* 1505 */       add((String)entry.getKey(), entry.getValue());
/*      */     }
/* 1507 */     return this;
/*      */   }
/*      */   
...
/*      */     }
/*      */     
/* 1523 */     for (Map.Entry<String, String> entry : headers) {
/* 1524 */       set((String)entry.getKey(), entry.getValue());
/*      */     }
/* 1526 */     return this;
/*      */   }
/*      */   
...
/* 1572 */     if (ignoreCase) {
/* 1573 */       do { if (!valueIterator.hasNext()) break;
/* 1574 */       } while (!((String)valueIterator.next()).equalsIgnoreCase(value));
/* 1575 */       return true;
/*      */     }
/*      */     
/*      */ 
...
/* 1601 */       if (containsCommaSeparatedTrimmed((CharSequence)itr.next(), value, ignoreCase)) {
/* 1602 */         return true;
/*      */       }
/*      */     }
/* 1605 */     return false;
