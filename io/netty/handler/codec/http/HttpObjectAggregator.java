...
/*     */   static
/*     */   {
/*  89 */     logger = InternalLoggerFactory.getInstance(HttpObjectAggregator.class);
/*  90 */     CONTINUE = new DefaultFullHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.CONTINUE, Unpooled.EMPTY_BUFFER);
/*     */     
/*  92 */     EXPECTATION_FAILED = new DefaultFullHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.EXPECTATION_FAILED, Unpooled.EMPTY_BUFFER);
/*     */     
/*  94 */     TOO_LARGE_CLOSE = new DefaultFullHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.REQUEST_ENTITY_TOO_LARGE, Unpooled.EMPTY_BUFFER);
/*     */     
/*  96 */     TOO_LARGE = new DefaultFullHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.REQUEST_ENTITY_TOO_LARGE, Unpooled.EMPTY_BUFFER);
/*     */     
/*     */ 
/*     */ 
/* 100 */     EXPECTATION_FAILED.headers().set(HttpHeaderNames.CONTENT_LENGTH, Integer.valueOf(0));
/* 101 */     TOO_LARGE.headers().set(HttpHeaderNames.CONTENT_LENGTH, Integer.valueOf(0));
/*     */     
/* 103 */     TOO_LARGE_CLOSE.headers().set(HttpHeaderNames.CONTENT_LENGTH, Integer.valueOf(0));
/* 104 */     TOO_LARGE_CLOSE.headers().set(HttpHeaderNames.CONNECTION, HttpHeaderValues.CLOSE);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 185 */       start.headers().remove(HttpHeaderNames.EXPECT);
/*     */     }
/* 187 */     return response;
/*     */   }
/*     */   
...
/* 212 */       ret = new AggregatedFullHttpRequest((HttpRequest)start, content, null); } else { AggregatedFullHttpMessage ret;
/* 213 */       if ((start instanceof HttpResponse)) {
...
/* 238 */       aggregated.headers().set(HttpHeaderNames.CONTENT_LENGTH, 
/*     */       
...
/*     */     {
/* 407 */       super(content, trailingHeaders);
/*     */     }
/*     */     
...
/*     */     {
/* 505 */       super(content, trailingHeaders);
/*     */     }
/*     */     
