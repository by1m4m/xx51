...
/* 216 */       out.add(msg); return;
/*     */     }
/*     */     
/*     */     FullHttpRequest fullRequest;
/*     */     
/* 221 */     if ((msg instanceof FullHttpRequest)) {
/* 222 */       FullHttpRequest fullRequest = (FullHttpRequest)msg;
...
/*     */   {
/* 267 */     List<CharSequence> requestedProtocols = splitHeader(request.headers().get(HttpHeaderNames.UPGRADE));
...
/* 272 */       CharSequence p = (CharSequence)requestedProtocols.get(i);
...
/* 295 */     if ((!AsciiString.containsContentEqualsIgnoreCase(values, HttpHeaderNames.UPGRADE)) || 
...
/*     */ 
/*     */ 
/* 337 */       writeComplete.addListener(ChannelFutureListener.CLOSE_ON_FAILURE);
/*     */     }
/*     */     finally {
/* 340 */       event.release();
/*     */     }
...
/* 362 */     List<CharSequence> protocols = new ArrayList(4);
