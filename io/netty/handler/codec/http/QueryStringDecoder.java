...
/* 213 */       from++;
/*     */     }
/* 215 */     Map<String, List<String>> params = new LinkedHashMap();
/* 216 */     int nameStart = from;
/* 217 */     int valueStart = -1;
/*     */     
/*     */ 
/* 220 */     for (int i = from; i < len; i++) {
...
/* 259 */     List<String> values = (List)params.get(name);
/* 260 */     if (values == null) {
/* 261 */       values = new ArrayList(1);
...
/*     */           }
/* 351 */           byteBuf.put(StringUtil.decodeHexByte(s, i + 1));
/* 352 */           i += 3;
