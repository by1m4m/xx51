...
/*     */           {
/*  93 */             int nameEnd = i;
/*  94 */             int valueEnd; int valueBegin = valueEnd = -1;
/*  95 */             break;
/*     */           }
/*  97 */           if (curChar == '=')
/*     */           {
...
/* 101 */             if (i == headerLen) {
/*     */               int valueEnd;
/* 103 */               int valueBegin = valueEnd = 0;
/* 104 */               break;
/*     */             }
/*     */             
/* 107 */             int valueBegin = i;
/*     */             
/* 109 */             int semiPos = header.indexOf(';', i);
/* 110 */             int valueEnd = i = semiPos > 0 ? semiPos : headerLen;
/* 111 */             break;
/*     */           }
/* 113 */           i++;
/*     */           
...
/* 116 */           if (i == headerLen)
/*     */           {
/* 118 */             int nameEnd = headerLen;
/* 119 */             int valueEnd; int valueBegin = valueEnd = -1;
/* 120 */             break; } }
/*     */         int valueEnd;
/*     */         int valueBegin;
/*     */         int nameEnd;
...
/* 171 */           return maxAgeMillis / 1000L + (maxAgeMillis % 1000L != 0L ? 1 : 0);
/*     */         }
/*     */       }
