...
/*     */ 
/*     */ 
/*  94 */   private static final Comparator<Cookie> COOKIE_COMPARATOR = new Comparator()
/*     */   {
...
/* 129 */     Cookie[] cookiesSorted; if (this.strict) {
/* 130 */       if (cookies.length == 1) {
/* 131 */         encode(buf, cookies[0]);
/*     */       } else {
/* 133 */         cookiesSorted = (Cookie[])Arrays.copyOf(cookies, cookies.length);
...
/* 160 */     Cookie[] cookiesSorted; if (this.strict) {
/* 161 */       if (cookies.size() == 1) {
/* 162 */         encode(buf, (Cookie)cookies.iterator().next());
/*     */       } else {
/* 164 */         cookiesSorted = (Cookie[])cookies.toArray(new Cookie[0]);
...
/*     */   {
/* 185 */     Iterator<? extends Cookie> cookiesIt = ((Iterable)ObjectUtil.checkNotNull(cookies, "cookies")).iterator();
...
/* 191 */     if (this.strict) {
/* 192 */       Cookie firstCookie = (Cookie)cookiesIt.next();
...
/*     */         }
/* 201 */         Cookie[] cookiesSorted = (Cookie[])cookiesList.toArray(new Cookie[0]);
...
/* 209 */         encode(buf, (Cookie)cookiesIt.next());
/*     */       }
/*     */     }
