...
/*     */   {
/*  50 */     this.origins = new LinkedHashSet(builder.origins);
...
/*     */   {
/*  87 */     return this.origins.isEmpty() ? "*" : (String)this.origins.iterator().next();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     }
/* 204 */     HttpHeaders preflightHeaders = new DefaultHttpHeaders();
/* 205 */     for (Map.Entry<CharSequence, Callable<?>> entry : this.preflightHeaders.entrySet()) {
/* 206 */       Object value = getValue((Callable)entry.getValue());
/* 207 */       if ((value instanceof Iterable)) {
/* 208 */         preflightHeaders.add((CharSequence)entry.getKey(), (Iterable)value);
/*     */       } else {
/* 210 */         preflightHeaders.add((CharSequence)entry.getKey(), value);
/*     */       }
/*     */     }
