...
/*  71 */   final Set<String> exposeHeaders = new HashSet();
/*     */   long maxAge;
/*  73 */   final Set<HttpMethod> requestMethods = new HashSet();
/*  74 */   final Set<String> requestHeaders = new HashSet();
/*  75 */   final Map<CharSequence, Callable<?>> preflightHeaders = new HashMap();
/*     */   
/*     */ 
...
/*     */   {
/*  85 */     this.origins = new LinkedHashSet(Arrays.asList(origins));
...
/* 285 */       this.preflightHeaders.put(name, new ConstantValueGenerator(values[0], null));
/*     */     } else {
...
/*     */   {
/* 304 */     this.preflightHeaders.put(name, new ConstantValueGenerator(value, null));
/* 305 */     return this;
/*     */   }
/*     */   
/*     */ 
...
/* 361 */       this.preflightHeaders.put(HttpHeaderNames.CONTENT_LENGTH, new ConstantValueGenerator("0", null));
/*     */     }
