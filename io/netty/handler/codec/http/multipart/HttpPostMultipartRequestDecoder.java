...
/*      */     }
/*  282 */     return (List)this.bodyMapHttpData.get(name);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     }
/*  304 */     List<InterfaceHttpData> list = (List)this.bodyMapHttpData.get(name);
/*  305 */     if (list != null) {
/*  306 */       return (InterfaceHttpData)list.get(0);
/*      */     }
/*  308 */     return null;
/*      */   }
/*      */   
...
/*      */     
/*  382 */     if (hasNext()) {
/*  383 */       return (InterfaceHttpData)this.bodyListHttpData.get(this.bodyListHttpDataRank++);
/*      */     }
/*  385 */     return null;
/*      */   }
/*      */   
...
/*  419 */       return;
/*      */     }
/*  421 */     List<InterfaceHttpData> datas = (List)this.bodyMapHttpData.get(data.getName());
/*  422 */     if (datas == null) {
/*  423 */       datas = new ArrayList(1);
...
/*  495 */       Attribute charsetAttribute = (Attribute)this.currentFieldAttributes.get(HttpHeaderValues.CHARSET);
...
/*      */         }
/*      */       }
/*  505 */       Attribute nameAttribute = (Attribute)this.currentFieldAttributes.get(HttpHeaderValues.NAME);
/*  506 */       if (this.currentAttribute == null)
/*      */       {
/*  508 */         Attribute lengthAttribute = (Attribute)this.currentFieldAttributes.get(HttpHeaderNames.CONTENT_LENGTH);
/*      */         long size;
/*      */         try {
...
/*  540 */         return null;
/*      */       }
/*  542 */       Attribute finalAttribute = this.currentAttribute;
...
/*  668 */       this.currentFieldAttributes = new TreeMap(CaseIgnoringComparator.INSTANCE);
/*      */     }
/*      */     
...
/*  681 */       if (HttpHeaderNames.CONTENT_DISPOSITION.contentEqualsIgnoreCase(contents[0])) { boolean checkSecondArg;
...
/*      */         }
/*      */         Attribute attribute;
/*  715 */         this.currentFieldAttributes.put(HttpHeaderNames.CONTENT_TRANSFER_ENCODING, attribute);
...
/*      */         }
/*      */         Attribute attribute;
/*  727 */         this.currentFieldAttributes.put(HttpHeaderNames.CONTENT_LENGTH, attribute);
...
/*      */             } catch (NullPointerException e) { Attribute attribute;
/*  759 */               throw new HttpPostRequestDecoder.ErrorDataDecoderException(e);
/*      */             } catch (IllegalArgumentException e) {
/*  761 */               throw new HttpPostRequestDecoder.ErrorDataDecoderException(e); }
/*      */             Attribute attribute;
...
/*      */     }
/*      */     
/*  772 */     Attribute filenameAttribute = (Attribute)this.currentFieldAttributes.get(HttpHeaderValues.FILENAME);
...
/*      */   {
/*  841 */     Attribute encoding = (Attribute)this.currentFieldAttributes.get(HttpHeaderNames.CONTENT_TRANSFER_ENCODING);
...
/*      */       }
/*      */     }
/*  864 */     Attribute charsetAttribute = (Attribute)this.currentFieldAttributes.get(HttpHeaderValues.CHARSET);
...
/*  875 */       Attribute filenameAttribute = (Attribute)this.currentFieldAttributes.get(HttpHeaderValues.FILENAME);
/*  876 */       Attribute nameAttribute = (Attribute)this.currentFieldAttributes.get(HttpHeaderValues.NAME);
/*  877 */       Attribute contentTypeAttribute = (Attribute)this.currentFieldAttributes.get(HttpHeaderNames.CONTENT_TYPE);
/*  878 */       Attribute lengthAttribute = (Attribute)this.currentFieldAttributes.get(HttpHeaderNames.CONTENT_LENGTH);
/*      */       long size;
/*      */       try {
...
/*      */   {
/* 1448 */     ArrayList<String> headers = new ArrayList(1);
/*      */     
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/* 1454 */     int nameStart = HttpPostBodyUtil.findNonWhitespace(sb, 0);
/* 1455 */     for (int nameEnd = nameStart; nameEnd < sb.length(); nameEnd++) {
/* 1456 */       char ch = sb.charAt(nameEnd);
/* 1457 */       if ((ch == ':') || (Character.isWhitespace(ch))) {
/*      */         break;
/*      */       }
/*      */     }
/* 1461 */     for (int colonEnd = nameEnd; colonEnd < sb.length(); colonEnd++) {
...
/*      */     String[] values;
/* 1472 */     String[] values; if (svalue.indexOf(';') >= 0) {
...
/* 1482 */       array[i] = ((String)headers.get(i));
/*      */     }
/* 1484 */     return array;
/*      */   }
/*      */   
...
/* 1518 */     return (String[])values.toArray(new String[0]);
/*      */   }
/*      */ }
