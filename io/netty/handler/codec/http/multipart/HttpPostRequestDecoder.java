...
/* 163 */       int crank; if (headerContentType[1].regionMatches(true, 0, boundaryHeader, 0, boundaryHeader.length())) {
/* 164 */         int mrank = 1;
/* 165 */         crank = 2; } else { int crank;
/* 166 */         if (headerContentType[2].regionMatches(true, 0, boundaryHeader, 0, boundaryHeader.length())) {
/* 167 */           int mrank = 2;
/* 168 */           crank = 1;
/*     */         } else {
/* 170 */           return null; } }
/*     */       int crank;
/* 172 */       int mrank; String boundary = StringUtil.substringAfter(headerContentType[mrank], '=');
