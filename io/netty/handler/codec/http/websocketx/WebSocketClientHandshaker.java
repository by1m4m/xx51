...
/* 189 */             return;
/*     */           }
/* 191 */           p.addAfter(ctx.name(), "ws-encoder", WebSocketClientHandshaker.this.newWebSocketEncoder());
/*     */           
...
/* 343 */         if (ctx == null) {
/* 344 */           return promise.setFailure(new IllegalStateException("ChannelPipeline does not contain a HttpResponseDecoder or HttpClientCodec"));
/*     */         }
/*     */       }
/*     */       
/*     */ 
...
/* 354 */       p.addAfter(aggregatorName, "handshaker", new SimpleChannelInboundHandler()
/*     */       {
...
/* 458 */         (WebSocketScheme.WS.name().contentEquals(wsURL.getScheme())) ? host : 
...
/* 463 */         (WebSocketScheme.WSS.name().contentEquals(wsURL.getScheme())) ? host : 
...
/*     */     int defaultPort;
/* 477 */     String schemePrefix; int defaultPort; if ((WebSocketScheme.WSS.name().contentEquals(scheme)) || 
/* 478 */       (HttpScheme.HTTPS.name().contentEquals(scheme)) || ((scheme == null) && 
/* 479 */       (port == WebSocketScheme.WSS.port())))
/*     */     {
/* 481 */       String schemePrefix = HTTPS_SCHEME_PREFIX;
