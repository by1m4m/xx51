...
/*    */   {
/* 39 */     if (((msg instanceof TextWebSocketFrame)) || ((msg instanceof BinaryWebSocketFrame)) || ((msg instanceof ContinuationWebSocketFrame))) {} return 
/*    */     
/*    */ 
/* 42 */       (((WebSocketFrame)msg).rsv() & 0x4) > 0;
/*    */   }
/*    */   
