...
/*    */   {
/* 41 */     if (((msg instanceof TextWebSocketFrame)) || ((msg instanceof BinaryWebSocketFrame)) || ((msg instanceof ContinuationWebSocketFrame))) {} return 
/*    */     
/*    */ 
/* 44 */       (((WebSocketFrame)msg).content().readableBytes() > 0) && 
/* 45 */       ((((WebSocketFrame)msg).rsv() & 0x4) == 0);
/*    */   }
/*    */   
