...
/*    */     
/* 48 */       ((((WebSocketFrame)msg).rsv() & 0x4) == 0) || (((msg instanceof ContinuationWebSocketFrame)) && (this.compressing)));
/*    */   }
/*    */   
/*    */ 
/*    */   protected int rsv(WebSocketFrame msg)
/*    */   {
/* 54 */     return ((msg instanceof TextWebSocketFrame)) || ((msg instanceof BinaryWebSocketFrame)) ? msg
/* 55 */       .rsv() | 0x4 : msg.rsv();
/*    */   }
/*    */   
