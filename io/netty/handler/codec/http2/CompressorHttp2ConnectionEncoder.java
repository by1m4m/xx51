...
/*  76 */         EmbeddedChannel compressor = (EmbeddedChannel)stream.getProperty(CompressorHttp2ConnectionEncoder.this.propertyKey);
...
/*  88 */     EmbeddedChannel channel = stream == null ? null : (EmbeddedChannel)stream.getProperty(this.propertyKey);
/*  89 */     if (channel == null)
/*     */     {
...
/*  98 */       if (buf == null) { Object localObject1;
/*  99 */         if (endOfStream) {
...
/* 224 */       .channel().config(), new ChannelHandler[] { ZlibCodecFactory.newZlibEncoder(wrapper, this.compressionLevel, this.windowBits, this.memLevel) });
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 246 */       encoding = HttpHeaderValues.IDENTITY;
/*     */     }
/* 248 */     EmbeddedChannel compressor = newContentCompressor(ctx, encoding);
