...
/*  46 */   private final ArrayDeque<Http2Settings> outstandingLocalSettingsQueue = new ArrayDeque(4);
/*     */   
...
/*     */   {
/*  73 */     return (Http2RemoteFlowController)connection().remote().flowController();
/*     */   }
/*     */   
...
/*     */   {
/* 146 */     return writeHeaders(ctx, streamId, headers, 0, (short)16, false, padding, endStream, promise);
/*     */   }
/*     */   
...
/*     */         
/*     */         default: 
/* 185 */           throw new IllegalStateException("Stream " + stream.id() + " in unexpected state " + stream.state());
/*     */         }
/*     */         
/*     */       }
/*     */       
...
/*     */   {
/* 324 */     return promise.setFailure(new UnsupportedOperationException("Use the Http2[Inbound|Outbound]FlowController objects to control window sizes"));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 341 */     return (Http2Settings)this.outstandingLocalSettingsQueue.poll();
/*     */   }
/*     */   
...
/* 351 */     if (stream == null) { String message;
/*     */       String message;
...
/* 406 */           ctx.write(this.queue.remove(0, writePromise), writePromise);
/* 407 */           return;
/*     */         }
/*     */         
...
/* 434 */         (Integer.MAX_VALUE - (nextData = (FlowControlledData)next).size() < size()))
/* 435 */         return false;
/*     */       FlowControlledData nextData;
/* 437 */       nextData.queue.copyTo(this.queue);
...
/*     */       }
/* 497 */       this.promise.addListener(this);
/*     */       
...
/* 540 */         DefaultHttp2ConnectionEncoder.this.lifecycleManager.closeStreamLocal(this.stream, this.promise);
/*     */       }
/*     */     }
/*     */     
/*     */     public void operationComplete(ChannelFuture future) throws Exception
