...
/* 436 */       final boolean exclusive = (word1 & 0x80000000) != 0L;
/* 437 */       final int streamDependency = (int)(word1 & 0x7FFFFFFF);
...
/* 442 */       ByteBuf fragment = payload.readSlice(lengthWithoutTrailingPadding(payload.readableBytes(), padding));
/*     */       
/*     */ 
/* 445 */       this.headersContinuation = new HeadersContinuation(headersStreamId, ctx)
/*     */       {
...
/*     */         
/* 463 */       };
/* 464 */       this.headersContinuation.processFragment(this.flags.endOfHeaders(), fragment, listener);
...
/*     */ 
/*     */ 
/* 471 */     this.headersContinuation = new HeadersContinuation(headersStreamId, ctx)
/*     */     {
/*     */       public int getStreamId() {
...
/* 504 */     boolean exclusive = (word1 & 0x80000000) != 0L;
/* 505 */     int streamDependency = (int)(word1 & 0x7FFFFFFF);
...
/*     */     
/*     */ 
/* 554 */     this.headersContinuation = new HeadersContinuation(pushPromiseStreamId, ctx)
/*     */     {
/*     */       public int getStreamId() {
...
/*     */   {
/* 653 */     private final DefaultHttp2FrameReader.HeadersBlockBuilder builder = new DefaultHttp2FrameReader.HeadersBlockBuilder(DefaultHttp2FrameReader.this);
/*     */     
/*     */ 
/*     */ 
...
/*     */       }
/*     */       
/* 723 */       if (DefaultHttp2FrameReader.this.headersDecoder.configuration().maxHeaderListSizeGoAway() - fragment.readableBytes() < this.headerBlock.readableBytes()) {
