...
/* 189 */             ByteBuf lastFrame = ctx.alloc().buffer(9);
...
/* 231 */             ctx.write(ZERO_BUFFER.slice(0, paddingBytes(framePaddingBytes)), promiseAggregator
/* 232 */               .newPromise());
/*     */           }
...
/* 280 */       buf.writeInt(exclusive ? (int)(0x80000000 | streamDependency) : streamDependency);
/*     */       
...
/* 313 */       for (CharObjectMap.PrimitiveEntry<Long> entry : settings.entries()) {
...
/*     */       
/* 517 */       if (hasPriority) {
/* 518 */         buf.writeInt(exclusive ? (int)(0x80000000 | streamDependency) : streamDependency);
/*     */         
/*     */ 
...
/* 559 */       return promiseAggregator.setFailure(new IllegalArgumentException("Padding [" + padding + "] is too large for max frame size [" + this.maxFrameSize + "]"));
/*     */     }
/*     */     
/*     */ 
