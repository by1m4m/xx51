...
/*     */       {
/* 100 */         stream.setProperty(DefaultHttp2LocalFlowController.this.stateKey, new DefaultHttp2LocalFlowController.DefaultState(DefaultHttp2LocalFlowController.this, stream, DefaultHttp2LocalFlowController.this.initialWindowSize));
/*     */       }
/*     */       
/*     */ 
...
/* 283 */     return (FlowState)this.connection.connectionStream().getProperty(this.stateKey);
/*     */   }
/*     */   
/*     */   private FlowState state(Http2Stream stream) {
/* 287 */     return (FlowState)stream.getProperty(this.stateKey);
/*     */   }
/*     */   
