...
/*  59 */   private final HeaderEntry head = new HeaderEntry(-1, AsciiString.EMPTY_STRING, AsciiString.EMPTY_STRING, Integer.MAX_VALUE, null);
/*     */   
...
/* 116 */       CharSequence name = (CharSequence)header.getKey();
/* 117 */       CharSequence value = (CharSequence)header.getValue();
/*     */       
/*     */ 
...
/* 131 */       CharSequence name = (CharSequence)header.getKey();
/* 132 */       CharSequence value = (CharSequence)header.getValue();
...
/* 241 */       for (long length = i - nbits; 
/* 242 */           (length & 0xFFFFFFFFFFFFFF80) != 0L; length >>>= 7) {
...
/*     */   private void clear()
/*     */   {
/* 450 */     Arrays.fill(this.headerFields, null);
