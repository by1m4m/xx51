...
/*     */       do
/*     */       {
/* 184 */         this.node = HpackHuffmanDecoder.Node.access$100(this.node)[(this.current >>> this.currentBits - 8 & 0xFF)];
/* 185 */         this.currentBits -= HpackHuffmanDecoder.Node.access$300(this.node);
/* 186 */         if (HpackHuffmanDecoder.Node.access$000(this.node)) {
/* 187 */           if (HpackHuffmanDecoder.Node.access$400(this.node) == 256) {
/* 188 */             throw HpackHuffmanDecoder.EOS_DECODED;
/*     */           }
/* 190 */           append(HpackHuffmanDecoder.Node.access$400(this.node));
/* 191 */           this.node = HpackHuffmanDecoder.ROOT;
/*     */           
/*     */ 
/* 194 */           this.symbolBits = this.currentBits;
/*     */         }
/* 196 */       } while (this.currentBits >= 8);
/* 197 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/* 206 */         this.node = HpackHuffmanDecoder.Node.access$100(this.node)[(this.current << 8 - this.currentBits & 0xFF)];
/* 207 */         if ((!HpackHuffmanDecoder.Node.access$000(this.node)) || (HpackHuffmanDecoder.Node.access$300(this.node) > this.currentBits)) break;
/* 208 */         if (HpackHuffmanDecoder.Node.access$400(this.node) == 256) {
/* 209 */           throw HpackHuffmanDecoder.EOS_DECODED;
/*     */         }
/* 211 */         this.currentBits -= HpackHuffmanDecoder.Node.access$300(this.node);
/* 212 */         append(HpackHuffmanDecoder.Node.access$400(this.node));
