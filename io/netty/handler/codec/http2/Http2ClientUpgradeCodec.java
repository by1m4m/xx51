...
/* 124 */       for (Object localObject1 = settings.entries().iterator(); ((Iterator)localObject1).hasNext();) { CharObjectMap.PrimitiveEntry<Long> entry = (CharObjectMap.PrimitiveEntry)((Iterator)localObject1).next();
