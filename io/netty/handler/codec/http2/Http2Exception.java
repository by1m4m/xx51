...
/*     */     {
/* 240 */       super(message, Http2Exception.ShutdownHint.NO_SHUTDOWN);
/* 241 */       this.streamId = streamId;
/*     */     }
/*     */     
/*     */     StreamException(int streamId, Http2Error error, String message, Throwable cause) {
/* 245 */       super(message, cause, Http2Exception.ShutdownHint.NO_SHUTDOWN);
...
/*     */     {
/* 277 */       super(Http2Exception.ShutdownHint.NO_SHUTDOWN);
/* 278 */       this.exceptions = new ArrayList(initialCapacity);
/*     */     }
/*     */     
