...
/*     */     
/* 160 */     decoder.frameListener(new FrameListener(null));
/* 161 */     connection().addListener(new ConnectionListener(null));
/* 162 */     ((Http2RemoteFlowController)connection().remote().flowController()).listener(new Http2RemoteFlowControllerListener(null));
...
/*     */         try {
/* 187 */           return streamVisitor.visit((Http2FrameStream)stream.getProperty(Http2FrameCodec.this.streamKey));
...
/* 214 */       Http2LocalFlowController localFlowController = (Http2LocalFlowController)connection.local().flowController();
...
/*     */         }
/* 249 */         upgrade.upgradeRequest().headers().setInt(HttpConversionUtil.ExtensionHeaderNames.STREAM_ID
/* 250 */           .text(), 1);
/* 251 */         stream.setProperty(this.upgradeKey, Boolean.valueOf(true));
/* 252 */         InboundHttpToHttp2Adapter.handle(ctx, 
/* 253 */           connection(), decoder().frameListener(), upgrade.upgradeRequest().retain());
/*     */       } finally {
/* 255 */         upgrade.release();
/*     */       }
/* 257 */       return;
...
/* 321 */       Boolean upgraded = (Boolean)stream.getProperty(this.upgradeKey);
...
/*     */       } else {
/* 374 */         this.numBufferedStreams += 1;
/*     */         
/* 376 */         writePromise.addListener(new ChannelFutureListener()
/*     */         {
/*     */           public void operationComplete(ChannelFuture future) throws Exception {
/* 379 */             Http2FrameCodec.access$510(Http2FrameCodec.this);
/*     */             
...
/*     */     {
/* 423 */       Http2FrameCodec.DefaultHttp2FrameStream stream2 = (Http2FrameCodec.DefaultHttp2FrameStream)stream.getProperty(Http2FrameCodec.this.streamKey);
/* 424 */       if (stream2 != null) {
...
/*     */     {
/* 431 */       Http2FrameCodec.DefaultHttp2FrameStream stream2 = (Http2FrameCodec.DefaultHttp2FrameStream)stream.getProperty(Http2FrameCodec.this.streamKey);
/* 432 */       if (stream2 != null) {
...
/*     */     }
/*     */     
/* 467 */     Http2FrameStream stream = (Http2FrameStream)connectionStream.getProperty(this.streamKey);
/* 468 */     if (stream == null) {
...
/*     */     {
/* 576 */       Http2FrameStream stream = (Http2FrameStream)Http2FrameCodec.this.connection().stream(streamId).getProperty(Http2FrameCodec.this.streamKey);
/* 577 */       if (stream == null) {
...
/*     */     
/* 613 */     public void writabilityChanged(Http2Stream stream) { Http2FrameStream frameStream = (Http2FrameStream)stream.getProperty(Http2FrameCodec.this.streamKey);
/* 614 */       if (frameStream == null) {
/* 615 */         return;
/*     */       }
/* 617 */       Http2FrameCodec.this.onHttp2StreamWritabilityChanged(
/* 618 */         Http2FrameCodec.this.ctx, frameStream, ((Http2RemoteFlowController)Http2FrameCodec.this.connection().remote().flowController()).isWritable(stream));
/*     */     }
/*     */   }
/*     */   
/*     */ 
