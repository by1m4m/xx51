...
/*     */   {
/*  63 */     return (Http2FrameCodecBuilder)super.initialSettings(settings);
/*     */   }
/*     */   
...
/*     */   {
/*  73 */     return (Http2FrameCodecBuilder)super.gracefulShutdownTimeoutMillis(gracefulShutdownTimeoutMillis);
/*     */   }
/*     */   
...
/*     */   {
/*  88 */     return (Http2FrameCodecBuilder)super.maxReservedStreams(maxReservedStreams);
/*     */   }
/*     */   
...
/*     */   {
/*  98 */     return (Http2FrameCodecBuilder)super.validateHeaders(validateHeaders);
/*     */   }
/*     */   
...
/*     */   {
/* 108 */     return (Http2FrameCodecBuilder)super.frameLogger(frameLogger);
/*     */   }
/*     */   
...
/*     */   {
/* 118 */     return (Http2FrameCodecBuilder)super.encoderEnforceMaxConcurrentStreams(encoderEnforceMaxConcurrentStreams);
/*     */   }
/*     */   
...
/*     */   {
/* 129 */     return (Http2FrameCodecBuilder)super.headerSensitivityDetector(headerSensitivityDetector);
/*     */   }
/*     */   
/*     */   public Http2FrameCodecBuilder encoderIgnoreMaxHeaderListSize(boolean ignoreMaxHeaderListSize)
/*     */   {
/* 134 */     return (Http2FrameCodecBuilder)super.encoderIgnoreMaxHeaderListSize(ignoreMaxHeaderListSize);
/*     */   }
/*     */   
/*     */   public Http2FrameCodecBuilder initialHuffmanDecodeCapacity(int initialHuffmanDecodeCapacity)
/*     */   {
/* 139 */     return (Http2FrameCodecBuilder)super.initialHuffmanDecodeCapacity(initialHuffmanDecodeCapacity);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     }
/* 169 */     return (Http2FrameCodec)super.build();
/*     */   }
/*     */   
/*     */ 
