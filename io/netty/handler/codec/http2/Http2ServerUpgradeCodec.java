...
/*     */       }
/*     */       
/* 137 */       this.settings = decodeSettingsHeader(ctx, (CharSequence)upgradeHeaders.get(0));
/*     */       
/* 139 */       return true;
...
/*     */     try
/*     */     {
/* 150 */       ctx.pipeline().addAfter(ctx.name(), this.handlerName, this.connectionHandler);
...
/* 160 */       String name = ctx.pipeline().context(this.connectionHandler).name();
