...
/*     */   
/*  43 */   private final Map<ChannelOption<?>, Object> options = new LinkedHashMap();
/*  44 */   private final Map<AttributeKey<?>, Object> attrs = new LinkedHashMap();
...
/* 177 */         channel.attr((AttributeKey)e.getKey()).set(e.getValue());
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* 185 */       setChannelOption(channel, (ChannelOption)e.getKey(), e.getValue(), logger);
/*     */     }
/*     */   }
/*     */   
