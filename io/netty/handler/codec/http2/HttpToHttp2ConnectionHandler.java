...
/* 100 */           http2Trailers = HttpConversionUtil.toHttp2Headers(trailers, this.validateHeaders);
/*     */         }
/*     */         
/*     */ 
...
/*     */         {
/* 111 */           writeHeaders(ctx, encoder, this.currentStreamId, trailers, http2Trailers, true, promiseAggregator);
/*     */         }
/*     */       }
/*     */     } catch (Throwable t) {
...
/*     */   {
/* 128 */     int dependencyId = headers.getInt(HttpConversionUtil.ExtensionHeaderNames.STREAM_DEPENDENCY_ID
/* 129 */       .text(), 0);
/* 130 */     short weight = headers.getShort(HttpConversionUtil.ExtensionHeaderNames.STREAM_WEIGHT
/* 131 */       .text(), (short)16);
