...
/*     */   {
/*  94 */     FullHttpMessage msg = (FullHttpMessage)stream.removeProperty(this.messageKey);
...
/*     */   {
/* 106 */     return (FullHttpMessage)stream.getProperty(this.messageKey);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 115 */     FullHttpMessage previous = (FullHttpMessage)stream.setProperty(this.messageKey, message);
...
/*     */   {
/* 157 */     return this.connection.isServer() ? HttpConversionUtil.toFullHttpRequest(stream.id(), headers, alloc, validateHttpHeaders) : 
/* 158 */       HttpConversionUtil.toFullHttpResponse(stream.id(), headers, alloc, validateHttpHeaders);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 275 */         msg.headers().setInt(HttpConversionUtil.ExtensionHeaderNames.STREAM_DEPENDENCY_ID.text(), streamDependency);
/*     */       }
/*     */       
...
/*     */ 
/*     */ 
/* 306 */       headers.status(HttpResponseStatus.OK.codeAsText());
/*     */     }
...
/* 315 */     msg.headers().setShort(HttpConversionUtil.ExtensionHeaderNames.STREAM_WEIGHT.text(), (short)16);
/*     */     
/*     */ 
