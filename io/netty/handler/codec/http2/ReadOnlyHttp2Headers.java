...
/* 148 */         throw new IllegalArgumentException("otherHeaders name at index " + i + " is a pseudo header that appears after non-pseudo headers.");
/*     */       }
/*     */       
...
/* 170 */       AsciiString roName = this.otherHeaders[i];
/* 171 */       if ((roName.hashCode() == nameHash) && (roName.contentEqualsIgnoreCase(name))) {
/* 172 */         return this.otherHeaders[(i + 1)];
/*     */       }
/*     */     }
/* 175 */     return null;
/*     */   }
...
/* 202 */     List<CharSequence> values = new ArrayList();
/*     */     
...
/* 214 */       AsciiString roName = this.otherHeaders[i];
/* 215 */       if ((roName.hashCode() == nameHash) && (roName.contentEqualsIgnoreCase(name))) {
/* 216 */         values.add(this.otherHeaders[(i + 1)]);
/*     */       }
/*     */     }
/*     */     
/* 220 */     return values;
...
/* 231 */     return value != null ? Boolean.valueOf(CharSequenceValueConverter.INSTANCE.convertToBoolean(value)) : null;
/*     */   }
/*     */   
...
/* 243 */     return value != null ? Byte.valueOf(CharSequenceValueConverter.INSTANCE.convertToByte(value)) : null;
/*     */   }
/*     */   
...
/* 255 */     return value != null ? Character.valueOf(CharSequenceValueConverter.INSTANCE.convertToChar(value)) : null;
/*     */   }
/*     */   
...
/* 267 */     return value != null ? Short.valueOf(CharSequenceValueConverter.INSTANCE.convertToShort(value)) : null;
/*     */   }
/*     */   
...
/* 279 */     return value != null ? Integer.valueOf(CharSequenceValueConverter.INSTANCE.convertToInt(value)) : null;
/*     */   }
/*     */   
...
/* 291 */     return value != null ? Long.valueOf(CharSequenceValueConverter.INSTANCE.convertToLong(value)) : null;
/*     */   }
/*     */   
...
/* 303 */     return value != null ? Float.valueOf(CharSequenceValueConverter.INSTANCE.convertToFloat(value)) : null;
/*     */   }
/*     */   
...
/* 315 */     return value != null ? Double.valueOf(CharSequenceValueConverter.INSTANCE.convertToDouble(value)) : null;
/*     */   }
/*     */   
...
/* 327 */     return value != null ? Long.valueOf(CharSequenceValueConverter.INSTANCE.convertToTimeMillis(value)) : null;
/*     */   }
/*     */   
...
/*     */     }
/* 504 */     Set<CharSequence> names = new LinkedHashSet(size());
...
/* 512 */       names.add(this.otherHeaders[i]);
/*     */     }
/* 514 */     return names;
/*     */   }
/*     */   
...
/*     */   {
/* 694 */     return new ReadOnlyIterator(null);
/*     */   }
/*     */   
...
/*     */   {
/* 729 */     return get(Http2Headers.PseudoHeaderName.METHOD.value());
/*     */   }
/*     */   
/*     */   public CharSequence scheme()
/*     */   {
/* 734 */     return get(Http2Headers.PseudoHeaderName.SCHEME.value());
/*     */   }
/*     */   
/*     */   public CharSequence authority()
/*     */   {
/* 739 */     return get(Http2Headers.PseudoHeaderName.AUTHORITY.value());
/*     */   }
/*     */   
/*     */   public CharSequence path()
/*     */   {
/* 744 */     return get(Http2Headers.PseudoHeaderName.PATH.value());
/*     */   }
/*     */   
/*     */   public CharSequence status()
/*     */   {
/* 749 */     return get(Http2Headers.PseudoHeaderName.STATUS.value());
/*     */   }
/*     */   
...
/* 783 */       builder.append((CharSequence)entry.getKey()).append(": ").append((CharSequence)entry.getValue());
/* 784 */       separator = ", ";
/*     */     }
/* 786 */     return ']';
/*     */   }
...
/*     */       }
/* 812 */       CharSequence current = this.next;
/* 813 */       calculateNext();
/* 814 */       return current;
/*     */     }
/*     */     
...
/*     */     
/* 850 */     public boolean hasNext() { return this.i != this.current.length; }
/*     */     
/*     */ 
