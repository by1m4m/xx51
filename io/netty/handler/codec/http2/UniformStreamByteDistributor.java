...
/*  39 */   private final Deque<State> queue = new ArrayDeque(4);
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  58 */         stream.setProperty(UniformStreamByteDistributor.this.stateKey, new UniformStreamByteDistributor.State(UniformStreamByteDistributor.this, stream));
/*     */       }
/*     */       
...
/*     */     
/* 102 */     State state = (State)this.queue.pollFirst();
/*     */     do {
...
/* 123 */       } } while ((state = (State)this.queue.pollFirst()) != null);
/*     */     
/* 125 */     return this.totalStreamableBytes > 0L;
/*     */   }
/*     */   
/*     */   private State state(Http2Stream stream) {
/* 129 */     return (State)((Http2Stream)ObjectUtil.checkNotNull(stream, "stream")).getProperty(this.stateKey);
/*     */   }
/*     */   
/*     */ 
