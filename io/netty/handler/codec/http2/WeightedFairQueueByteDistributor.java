...
/* 103 */       this.stateOnlyRemovalQueue = EmptyPriorityQueue.instance();
/*     */     } else {
/* 105 */       this.stateOnlyMap = new IntObjectHashMap(maxStateOnlySize);
/*     */       
/*     */ 
/* 108 */       this.stateOnlyRemovalQueue = new DefaultPriorityQueue(StateOnlyComparator.INSTANCE, maxStateOnlySize + 2);
/*     */     }
...
/* 122 */         if (state == null) {
/* 123 */           state = new WeightedFairQueueByteDistributor.State(WeightedFairQueueByteDistributor.this, stream);
/*     */           
/* 125 */           List<WeightedFairQueueByteDistributor.ParentChangedEvent> events = new ArrayList(1);
...
/*     */         }
/* 132 */         switch (WeightedFairQueueByteDistributor.2.$SwitchMap$io$netty$handler$codec$http2$Http2Stream$State[stream.state().ordinal()]) {
/*     */         case 1: 
/*     */         case 2: 
...
/*     */   {
/* 193 */     state(state.stream()).updateStreamableBytes(Http2CodecUtil.streamableBytes(state), 
...
/* 239 */         List<ParentChangedEvent> events = new ArrayList(2 + (exclusive ? newParent.children.size() : 0));
...
/* 347 */     return (State)stream.getProperty(this.stateKey);
/*     */   }
/*     */   
...
/* 379 */       ParentChangedEvent event = (ParentChangedEvent)events.get(i);
...
/* 490 */       this.pseudoTimeQueue = new DefaultPriorityQueue(WeightedFairQueueByteDistributor.StatePseudoTimeComparator.INSTANCE, initialSize);
/*     */     }
/*     */     
...
/* 550 */         List<WeightedFairQueueByteDistributor.ParentChangedEvent> events = new ArrayList(1 + child.children.size());
...
/* 599 */       this.children = new IntObjectHashMap(WeightedFairQueueByteDistributor.INITIAL_CHILDREN_MAP_SIZE);
/*     */     }
/*     */     
...
/* 615 */         if ((!$assertionsDisabled) && (this.activeCountForTree == increment) && (this.pseudoTimeQueueIndex != -1))
/*     */         {
/* 617 */           if (!this.parent.pseudoTimeQueue.containsTyped(this)) {
/* 615 */             throw new AssertionError("State[" + this.streamId + "].activeCountForTree changed from 0 to " + increment + " is in a pseudoTimeQueue, but not in parent[ " + this.parent.streamId + "]'s pseudoTimeQueue");
/*     */           }
/*     */         }
/*     */         
/*     */ 
...
/*     */     {
/* 750 */       StringBuilder sb = new StringBuilder('Ā' * (this.activeCountForTree > 0 ? this.activeCountForTree : 1));
/* 751 */       toString(sb);
