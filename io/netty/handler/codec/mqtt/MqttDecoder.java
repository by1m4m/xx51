...
/*     */       try {
/*  85 */         Result<?> decodedVariableHeader = decodeVariableHeader(buffer, this.mqttFixedHeader);
/*  86 */         this.variableHeader = decodedVariableHeader.value;
/*  87 */         if (this.bytesRemainingInVariablePart > this.maxBytesInMessage) {
/*  88 */           throw new DecoderException("too large message: " + this.bytesRemainingInVariablePart + " bytes");
/*     */         }
...
/*     */         {
/*     */ 
/* 109 */           throw new DecoderException("non-zero remaining payload bytes: " + this.bytesRemainingInVariablePart + " (" + this.mqttFixedHeader.messageType() + ')');
/*     */         }
/* 111 */         checkpoint(DecoderState.READ_FIXED_HEADER);
/* 112 */         MqttMessage message = MqttMessageFactory.newMessage(this.mqttFixedHeader, this.variableHeader, 
/* 113 */           decodedPayload.value);
...
/* 136 */     return MqttMessageFactory.newInvalidMessage(this.mqttFixedHeader, this.variableHeader, cause);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 156 */     int loops = 0;
/*     */     short digit;
/* 158 */     do { digit = buffer.readUnsignedByte();
...
/* 250 */     return new Result(mqttConnectVariableHeader, numberOfBytesConsumed);
/*     */   }
/*     */   
...
/* 259 */     return new Result(mqttConnAckVariableHeader, 2);
/*     */   }
/*     */   
...
/* 265 */       MqttMessageIdVariableHeader.from(((Integer)messageId.value).intValue()), 
...
/* 286 */     return new Result(mqttPublishVariableHeader, numberOfBytesConsumed);
/*     */   }
/*     */   
...
/* 371 */     return new Result(mqttConnectPayload, numberOfBytesConsumed);
/*     */   }
/*     */   
/*     */ 
/*     */   private static Result<MqttSubscribePayload> decodeSubscribePayload(ByteBuf buffer, int bytesRemainingInVariablePart)
/*     */   {
/* 377 */     List<MqttTopicSubscription> subscribeTopics = new ArrayList();
...
/*     */     }
/* 386 */     return new Result(new MqttSubscribePayload(subscribeTopics), numberOfBytesConsumed);
/*     */   }
/*     */   
/*     */ 
/*     */   private static Result<MqttSubAckPayload> decodeSubackPayload(ByteBuf buffer, int bytesRemainingInVariablePart)
/*     */   {
/* 392 */     List<Integer> grantedQos = new ArrayList();
...
/*     */     }
/* 402 */     return new Result(new MqttSubAckPayload(grantedQos), numberOfBytesConsumed);
/*     */   }
/*     */   
/*     */ 
/*     */   private static Result<MqttUnsubscribePayload> decodeUnsubscribePayload(ByteBuf buffer, int bytesRemainingInVariablePart)
/*     */   {
/* 408 */     List<String> unsubscribeTopics = new ArrayList();
...
/*     */     }
/* 415 */     return new Result(new MqttUnsubscribePayload(unsubscribeTopics), numberOfBytesConsumed);
/*     */   }
/*     */   
/*     */ 
...
/* 422 */     return new Result(b, bytesRemainingInVariablePart);
/*     */   }
/*     */   
/*     */   private static Result<String> decodeString(ByteBuf buffer) {
/* 426 */     return decodeString(buffer, 0, Integer.MAX_VALUE);
/*     */   }
/*     */   
...
/* 436 */       return new Result(null, numberOfBytesConsumed);
/*     */     }
...
/* 441 */     return new Result(s, numberOfBytesConsumed);
/*     */   }
/*     */   
...
/* 449 */     return new Result(bytes, decodedSize.numberOfBytesConsumed + size);
/*     */   }
/*     */   
...
/* 462 */       result = -1;
/*     */     }
/* 464 */     return new Result(Integer.valueOf(result), 2);
/*     */   }
/*     */   
