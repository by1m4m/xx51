...
/*     */ {
/*  34 */   private static final String[] DEFAULT_SIMPLE_STRINGS = { "OK", "PONG", "QUEUED" };
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/*  86 */     this.byteBufToSimpleStrings = new HashMap(DEFAULT_SIMPLE_STRINGS.length, 1.0F);
/*  87 */     this.stringToSimpleStrings = new HashMap(DEFAULT_SIMPLE_STRINGS.length, 1.0F);
...
/*     */     }
/*     */     
/*  96 */     this.byteBufToErrors = new HashMap(DEFAULT_ERRORS.length, 1.0F);
/*  97 */     this.stringToErrors = new HashMap(DEFAULT_ERRORS.length, 1.0F);
...
/*     */     }
/*     */     
/* 106 */     this.byteBufToIntegers = new HashMap(129, 1.0F);
/* 107 */     this.longToIntegers = new LongObjectHashMap(129, 1.0F);
/* 108 */     this.longToByteBufs = new LongObjectHashMap(129, 1.0F);
/* 109 */     for (long value = -1L; value < 128L; value += 1L) {
...
/*     */   {
/* 122 */     return (SimpleStringRedisMessage)this.stringToSimpleStrings.get(content);
/*     */   }
/*     */   
/*     */   public SimpleStringRedisMessage getSimpleString(ByteBuf content)
/*     */   {
/* 127 */     return (SimpleStringRedisMessage)this.byteBufToSimpleStrings.get(content);
/*     */   }
/*     */   
/*     */   public ErrorRedisMessage getError(String content)
/*     */   {
/* 132 */     return (ErrorRedisMessage)this.stringToErrors.get(content);
/*     */   }
/*     */   
/*     */   public ErrorRedisMessage getError(ByteBuf content)
/*     */   {
/* 137 */     return (ErrorRedisMessage)this.byteBufToErrors.get(content);
/*     */   }
/*     */   
...
/*     */   {
/* 147 */     return (IntegerRedisMessage)this.byteBufToIntegers.get(content);
/*     */   }
/*     */   
