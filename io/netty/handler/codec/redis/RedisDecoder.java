...
/*     */ {
/*  37 */   private final ToPositiveLongProcessor toPositiveLongProcessor = new ToPositiveLongProcessor(null);
/*     */   
...
/*     */       do {
/*     */         do {
/* 101 */           do { do { do { switch (this.state) {
/*     */                 }
/* 103 */               } while (decodeType(in));
/* 104 */               return;
/*     */ 
/*     */ 
/*     */             }
/* 108 */             while (decodeInline(in, out));
/* 109 */             return;
/*     */ 
/*     */ 
/*     */           }
/* 113 */           while (decodeLength(in, out));
/* 114 */           return;
/*     */ 
/*     */ 
/*     */         }
/* 118 */         while (decodeBulkStringEndOfLine(in, out));
/* 119 */         return;
/*     */ 
/*     */ 
/*     */       }
/* 123 */       while (decodeBulkStringContent(in, out));
/* 124 */       return;
/*     */       
/*     */ 
/*     */ 
...
/*     */     case SIMPLE_STRING: 
/* 260 */       SimpleStringRedisMessage cached = this.messagePool.getSimpleString(content);
/* 261 */       return cached != null ? cached : new SimpleStringRedisMessage(content.toString(CharsetUtil.UTF_8));
/*     */     
/*     */     case ERROR: 
/* 264 */       ErrorRedisMessage cached = this.messagePool.getError(content);
/* 265 */       return cached != null ? cached : new ErrorRedisMessage(content.toString(CharsetUtil.UTF_8));
/*     */     
/*     */     case INTEGER: 
/* 268 */       IntegerRedisMessage cached = this.messagePool.getInteger(content);
...
/*     */     {
/* 298 */       throw new RedisCodecException("too many characters to be a valid RESP Integer: " + byteBuf.toString(CharsetUtil.US_ASCII));
/*     */     }
/* 300 */     if (negative) {
