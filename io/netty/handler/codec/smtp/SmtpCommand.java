...
/*     */   
/*  44 */   private static final Map<String, SmtpCommand> COMMANDS = new HashMap();
/*     */   
/*  46 */   static { COMMANDS.put(EHLO.name().toString(), EHLO);
...
/*  64 */     SmtpCommand command = (SmtpCommand)COMMANDS.get(commandName.toString());
...
/*  82 */     ByteBufUtil.writeAscii(buffer, this.name);
/*     */   }
/*     */   
...
/* 100 */       return false;
/*     */     }
/* 102 */     return this.name.contentEqualsIgnoreCase(((SmtpCommand)obj).name());
/*     */   }
/*     */   
