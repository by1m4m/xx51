...
/*     */     }
/*  92 */     out.writeByte(32);
/*  93 */     if ((parameters instanceof RandomAccess)) {
/*  94 */       int sizeMinusOne = parameters.size() - 1;
/*  95 */       for (int i = 0; i < sizeMinusOne; i++) {
/*  96 */         ByteBufUtil.writeAscii(out, (CharSequence)parameters.get(i));
/*  97 */         out.writeByte(32);
/*     */       }
/*  99 */       ByteBufUtil.writeAscii(out, (CharSequence)parameters.get(sizeMinusOne));
/*     */     } else {
/* 101 */       Iterator<CharSequence> params = parameters.iterator();
/*     */       for (;;) {
/* 103 */         ByteBufUtil.writeAscii(out, (CharSequence)params.next());
/* 104 */         if (!params.hasNext()) break;
