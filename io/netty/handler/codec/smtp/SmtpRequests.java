...
/*  92 */       return new DefaultSmtpRequest(SmtpCommand.MAIL, new CharSequence[] { (CharSequence)(sender != null ? "FROM:<" + sender + '>' : FROM_NULL_SENDER) });
/*     */     }
/*     */     
/*  95 */     List<CharSequence> params = new ArrayList(mailParameters.length + 1);
...
/*     */     }
/* 112 */     List<CharSequence> params = new ArrayList(rcptParameters.length + 1);
