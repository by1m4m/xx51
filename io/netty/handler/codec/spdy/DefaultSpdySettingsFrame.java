...
/*     */   {
/*  44 */     Setting setting = (Setting)this.settingsMap.get(Integer.valueOf(id));
...
/*  59 */     Setting setting = (Setting)this.settingsMap.get(key);
/*  60 */     if (setting != null) {
...
/*     */   {
/*  78 */     Setting setting = (Setting)this.settingsMap.get(Integer.valueOf(id));
/*  79 */     return (setting != null) && (setting.isPersist());
/*     */   }
/*     */   
/*     */   public SpdySettingsFrame setPersistValue(int id, boolean persistValue)
/*     */   {
/*  84 */     Setting setting = (Setting)this.settingsMap.get(Integer.valueOf(id));
/*  85 */     if (setting != null) {
...
/*     */   {
/*  93 */     Setting setting = (Setting)this.settingsMap.get(Integer.valueOf(id));
/*  94 */     return (setting != null) && (setting.isPersisted());
/*     */   }
/*     */   
/*     */   public SpdySettingsFrame setPersisted(int id, boolean persisted)
/*     */   {
/*  99 */     Setting setting = (Setting)this.settingsMap.get(Integer.valueOf(id));
/* 100 */     if (setting != null) {
...
/* 123 */       Setting setting = (Setting)e.getValue();
/* 124 */       buf.append("--> ");
