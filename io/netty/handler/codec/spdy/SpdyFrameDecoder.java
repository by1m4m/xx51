...
/*     */           }
/*     */           
/* 178 */           boolean last = (this.length == 0) && (hasFlag(this.flags, (byte)1));
/*     */           
...
/* 192 */         boolean last = hasFlag(this.flags, (byte)1);
...
/* 212 */         boolean last = hasFlag(this.flags, (byte)1);
/*     */         
...
/* 232 */         int statusCode = SpdyCodecUtil.getSignedInt(buffer, buffer.readerIndex() + 4);
...
/* 306 */         int statusCode = SpdyCodecUtil.getSignedInt(buffer, buffer.readerIndex() + 4);
...
/* 319 */         boolean last = hasFlag(this.flags, (byte)1);
/*     */         
...
/* 374 */         if (this.length != 0) break label1466;
