...
/* 196 */             Map.Entry<CharSequence, CharSequence> entry = (Map.Entry)itr.next();
/*     */             
/* 198 */             CharSequence headerName = this.headersToLowerCase ? AsciiString.of((CharSequence)entry.getKey()).toLowerCase() : (CharSequence)entry.getKey();
...
/* 222 */     int streamId = httpHeaders.getInt(SpdyHttpHeaders.Names.STREAM_ID).intValue();
...
/* 261 */       Map.Entry<CharSequence, CharSequence> entry = (Map.Entry)itr.next();
/*     */       
/* 263 */       CharSequence headerName = this.headersToLowerCase ? AsciiString.of((CharSequence)entry.getKey()).toLowerCase() : (CharSequence)entry.getKey();
...
/* 280 */     int streamId = httpHeaders.getInt(SpdyHttpHeaders.Names.STREAM_ID).intValue();
...
/* 304 */       Map.Entry<CharSequence, CharSequence> entry = (Map.Entry)itr.next();
/*     */       
/* 306 */       CharSequence headerName = this.headersToLowerCase ? AsciiString.of((CharSequence)entry.getKey()).toLowerCase() : (CharSequence)entry.getKey();
