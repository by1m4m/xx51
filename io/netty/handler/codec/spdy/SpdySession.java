...
/*  71 */       StreamState state = (StreamState)this.activeStreams.put(Integer.valueOf(streamId), new StreamState(priority, remoteSideClosed, localSideClosed, sendWindowSize, receiveWindowSize));
/*     */       
/*  73 */       if (state == null) {
/*  74 */         if (remote) {
...
/*  84 */     StreamState state = (StreamState)this.activeStreams.remove(Integer.valueOf(streamId));
/*  85 */     if (state != null) {
/*  86 */       if (remote) {
...
/* 103 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
/* 104 */     return (state == null) || (state.isRemoteSideClosed());
/*     */   }
/*     */   
/*     */   void closeRemoteSide(int streamId, boolean remote) {
/* 108 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
/* 109 */     if (state != null) {
...
/* 118 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
/* 119 */     return (state == null) || (state.isLocalSideClosed());
/*     */   }
/*     */   
/*     */   void closeLocalSide(int streamId, boolean remote) {
/* 123 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
/* 124 */     if (state != null) {
...
/*     */   {
/* 137 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
/* 138 */     return (state != null) && (state.hasReceivedReply());
/*     */   }
/*     */   
/*     */   void receivedReply(int streamId) {
/* 142 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
/* 143 */     if (state != null) {
...
/*     */     }
/*     */     
/* 153 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
...
/*     */     }
/*     */     
/* 162 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
...
/*     */     }
/*     */     
/* 171 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
/* 172 */     if (state == null) {
/* 173 */       return -1;
/*     */     }
...
/*     */     }
/*     */     
/* 186 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
...
/* 206 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
...
/* 213 */         StreamState state = (StreamState)e.getValue();
...
/*     */     }
/*     */     
/* 224 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
/* 225 */     return state != null ? state.getPendingWrite() : null;
/*     */   }
/*     */   
/*     */   PendingWrite removePendingWrite(int streamId) {
/* 229 */     StreamState state = (StreamState)this.activeStreams.get(Integer.valueOf(streamId));
...
/* 307 */       return (SpdySession.PendingWrite)this.pendingWriteQueue.peek();
/*     */     }
/*     */     
/*     */     SpdySession.PendingWrite removePendingWrite() {
/* 311 */       return (SpdySession.PendingWrite)this.pendingWriteQueue.poll();
/*     */     }
/*     */     
/*     */     void clearPendingWrites(Throwable cause) {
/*     */       for (;;) {
/* 316 */         SpdySession.PendingWrite pendingWrite = (SpdySession.PendingWrite)this.pendingWriteQueue.poll();
