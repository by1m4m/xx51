...
/* 233 */         (this.spdySession.isActiveStream(streamId))) {
...
/* 268 */         (this.spdySession.isRemoteSideClosed(streamId))) {
...
/*     */       {
/* 490 */         this.spdySession.putPendingWrite(streamId, new SpdySession.PendingWrite(spdyDataFrame, promise));
/* 491 */         return; }
...
/* 742 */       future.addListener(this.closeSessionFutureListener);
/*     */     }
/*     */   }
/*     */   
...
/* 750 */       future.addListener(this.closeSessionFutureListener);
/*     */     }
/*     */   }
/*     */   
