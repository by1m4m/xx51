...
/* 225 */       (in.getByte(i + 2) == 45) && 
/* 226 */       (in.getByte(i + 3) == 45);
/*     */   }
/*     */   
/*     */   private static boolean isCDATABlockStart(ByteBuf in, int i) {
/* 230 */     return (i < in.writerIndex() - 8) && 
/* 231 */       (in.getByte(i + 2) == 91) && 
/* 232 */       (in.getByte(i + 3) == 67) && 
/* 233 */       (in.getByte(i + 4) == 68) && 
/* 234 */       (in.getByte(i + 5) == 65) && 
/* 235 */       (in.getByte(i + 6) == 84) && 
/* 236 */       (in.getByte(i + 7) == 65) && 
/* 237 */       (in.getByte(i + 8) == 91);
/*     */   }
/*     */ }
