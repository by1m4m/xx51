...
/*  57 */       return new Ip4SubnetFilterRule((Inet4Address)ipAddress, cidrPrefix, ruleType, null);
/*  58 */     if ((ipAddress instanceof Inet6Address)) {
/*  59 */       return new Ip6SubnetFilterRule((Inet6Address)ipAddress, cidrPrefix, ruleType, null);
/*     */     }
...
/*     */     {
/* 128 */       return (int)(-1L << 32 - cidrPrefix & 0xFFFFFFFFFFFFFFFF);
/*     */     }
/*     */   }
/*     */   
