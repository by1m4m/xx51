...
/*     */     
/* 100 */     this.authorization = new AsciiString("Basic " + authzBase64.toString(CharsetUtil.US_ASCII));
/*     */     
/* 102 */     authz.release();
...
/* 131 */     p.addBefore(name, null, this.codec);
/*     */   }
/*     */   
...
/*     */   {
/* 146 */     InetSocketAddress raddr = (InetSocketAddress)destinationAddress();
/*     */     
...
/*     */ 
/*     */ 
/* 155 */     FullHttpRequest req = new DefaultFullHttpRequest(HttpVersion.HTTP_1_1, HttpMethod.CONNECT, url, Unpooled.EMPTY_BUFFER, false);
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/* 163 */       req.headers().set(HttpHeaderNames.PROXY_AUTHORIZATION, this.authorization);
/*     */     }
/*     */     
/* 166 */     if (this.headers != null) {
/* 167 */       req.headers().add(this.headers);
/*     */     }
/*     */     
/* 170 */     return req;
/*     */   }
