...
/*  61 */   private final LazyChannelPromise connectPromise = new LazyChannelPromise(null);
...
/*     */   {
/* 102 */     return this.destinationAddress;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 201 */             ProxyHandler.this.setConnectFailure(new ProxyConnectException(ProxyHandler.this.exceptionMessage("timeout"))); } }, connectTimeoutMillis, TimeUnit.MILLISECONDS);
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */   {
/* 227 */     this.ctx.writeAndFlush(msg).addListener(this.writeListener);
/*     */   }
/*     */   
...
/*     */     
/* 453 */     protected EventExecutor executor() { if (ProxyHandler.this.ctx == null) {
