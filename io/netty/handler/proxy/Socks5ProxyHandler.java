...
/*  50 */   private static final Socks5InitialRequest INIT_REQUEST_NO_AUTH = new DefaultSocks5InitialRequest(
/*  51 */     Collections.singletonList(Socks5AuthMethod.NO_AUTH));
/*     */   
/*  53 */   private static final Socks5InitialRequest INIT_REQUEST_PASSWORD = new DefaultSocks5InitialRequest(
...
/*     */         }
/*     */         else
/* 199 */           throw new ProxyConnectException(exceptionMessage("unknown address type: " + StringUtil.simpleClassName(rhost)));
/*     */       }
/*     */     }
