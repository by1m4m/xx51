...
/*     */       
/*  85 */       this.alpnSelector = new AlpnSelector(applicationNegotiator.protocolSelectorFactory().newSelector(this, new LinkedHashSet(applicationNegotiator.protocols())));
/*  86 */       Java9SslUtils.setHandshakeApplicationProtocolSelector(engine, this.alpnSelector);
/*     */     }
/*     */     else {
/*  89 */       this.selectionListener = applicationNegotiator.protocolListenerFactory().newListener(this, applicationNegotiator.protocols());
