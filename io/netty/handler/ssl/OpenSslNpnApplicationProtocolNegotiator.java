...
/*    */   {
/* 33 */     this.protocols = ((List)ObjectUtil.checkNotNull(ApplicationProtocolUtil.toList(protocols), "protocols"));
/*    */   }
/*    */   
/*    */   public OpenSslNpnApplicationProtocolNegotiator(String... protocols) {
/* 37 */     this.protocols = ((List)ObjectUtil.checkNotNull(ApplicationProtocolUtil.toList(protocols), "protocols"));
/*    */   }
/*    */   
