...
/*  80 */   private static final FastThreadLocal<MessageDigest> tlmd = new FastThreadLocal()
/*     */   {
...
/* 115 */       if (!found)
/*     */       {
/* 117 */         throw new CertificateException(type + " certificate with unknown fingerprint: " + cert.getSubjectDN());
/*     */       }
/*     */     }
/*     */     
...
/*     */     }
/*     */     
/* 163 */     List<byte[]> list = new ArrayList(fingerprints.length);
...
/* 168 */       if (f.length != 20)
/*     */       {
/* 170 */         throw new IllegalArgumentException("malformed fingerprint: " + ByteBufUtil.hexDump(Unpooled.wrappedBuffer(f)) + " (expected: SHA1)");
/*     */       }
/* 172 */       list.add(f.clone());
/*     */     }
/*     */     
/* 175 */     this.fingerprints = ((byte[][])list.toArray(new byte[0][]));
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/* 183 */     List<byte[]> list = new ArrayList();
...
/*     */     }
/*     */     
/* 200 */     return (byte[][])list.toArray(new byte[0][]);
/*     */   }
/*     */   
