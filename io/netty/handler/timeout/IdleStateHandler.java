...
/* 106 */       IdleStateHandler.this.firstWriterIdleEvent = IdleStateHandler.access$202(IdleStateHandler.this, true);
/*     */     }
/*     */   };
/*     */   
...
/* 284 */       this.firstReaderIdleEvent = (this.firstAllIdleEvent = 1);
/*     */     }
...
/* 302 */       ctx.write(msg, promise.unvoid()).addListener(this.writeListener);
/*     */     } else {
