...
/*     */     throws Exception
/*     */   {
/* 133 */     TrafficCounter trafficCounter = new TrafficCounter(this, ctx.executor(), "ChannelTC" + ctx.channel().hashCode(), this.checkInterval);
...
/* 187 */         return;
/*     */       }
/* 189 */       ToSend newToSend = new ToSend(delay + now, msg, promise, null);
