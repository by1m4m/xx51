...
/*     */       
/*     */ 
/* 467 */       perChannel.channelTrafficCounter = new TrafficCounter(this, null, "ChannelTC" + ctx.channel().hashCode(), this.checkInterval);
...
/* 582 */     PerChannel perChannel = (PerChannel)this.channelQueues.get(key);
...
/* 594 */     PerChannel perChannel = (PerChannel)this.channelQueues.get(key);
...
/* 662 */       PerChannel perChannel = (PerChannel)this.channelQueues.get(key);
/* 663 */       long wait = 0L;
...
/* 702 */     PerChannel perChannel = (PerChannel)this.channelQueues.get(key);
...
/*     */       }
/* 723 */       ToSend newToSend = new ToSend(delay + now, msg, size, promise, null);
...
/*     */     {
/*     */ 
/* 740 */       public void run() { GlobalChannelTrafficShapingHandler.this.sendAllValid(ctx, forSchedule, futureNow); } }, delay, TimeUnit.MILLISECONDS);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 748 */       for (ToSend newToSend = (ToSend)perChannel.messagesQueue.pollFirst(); 
/* 749 */           newToSend != null; newToSend = (ToSend)perChannel.messagesQueue.pollFirst()) {
...
/* 772 */     return 
/*     */     
/* 774 */       340 + super.toString() + " Write Channel Limit: " + this.writeChannelLimit + " Read Channel Limit: " + this.readChannelLimit;
/*     */   }
/*     */   
