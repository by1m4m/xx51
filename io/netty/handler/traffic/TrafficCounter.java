...
/* 193 */       this.monitor = new TrafficMonitoringTask(null);
/*     */       
/* 195 */       this.scheduledFuture = this.executor.schedule(this.monitor, localCheckInterval, TimeUnit.MILLISECONDS);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 509 */     if (interval > 10L)
/*     */     {
/* 511 */       long time = sum * 1000L / limitTraffic - interval + pastDelay;
/* 512 */       if (time > 10L) {
...
/* 517 */           time = maxTime;
/*     */         }
/* 519 */         this.readingTime = Math.max(localReadingTime, now + time);
/* 520 */         return time;
/*     */       }
...
/* 584 */     if (interval > 10L)
/*     */     {
/* 586 */       long time = sum * 1000L / limitTraffic - interval + pastDelay;
/* 587 */       if (time > 10L) {
...
/* 592 */           time = maxTime;
/*     */         }
/* 594 */         this.writingTime = Math.max(localWritingTime, now + time);
/* 595 */         return time;
/*     */       }
