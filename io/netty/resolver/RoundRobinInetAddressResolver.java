...
/*     */     throws Exception
/*     */   {
/*  57 */     this.nameResolver.resolveAll(inetHost).addListener(new FutureListener()
/*     */     {
/*     */       public void operationComplete(Future<List<InetAddress>> future) throws Exception {
/*  60 */         if (future.isSuccess()) {
/*  61 */           List<InetAddress> inetAddresses = (List)future.getNow();
...
/*     */   {
/*  79 */     this.nameResolver.resolveAll(inetHost).addListener(new FutureListener()
/*     */     {
/*     */       public void operationComplete(Future<List<InetAddress>> future) throws Exception {
/*  82 */         if (future.isSuccess()) {
/*  83 */           List<InetAddress> inetAddresses = (List)future.getNow();
/*  84 */           if (!inetAddresses.isEmpty())
/*     */           {
/*  86 */             List<InetAddress> result = new ArrayList(inetAddresses);
/*     */             
