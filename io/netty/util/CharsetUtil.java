...
/*     */   
/*  65 */   private static final Charset[] CHARSETS = { UTF_16, UTF_16BE, UTF_16LE, UTF_8, ISO_8859_1, US_ASCII };
/*     */   
...
/* 115 */     CharsetEncoder e = (CharsetEncoder)map.get(charset);
/* 116 */     if (e != null) {
...
/* 171 */     CharsetDecoder d = (CharsetDecoder)map.get(charset);
/* 172 */     if (d != null) {
