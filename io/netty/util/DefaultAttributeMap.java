...
/*     */     {
/*  48 */       attributes = new AtomicReferenceArray(4);
/*     */       
...
/*     */     
/*  55 */     int i = index(key);
/*  56 */     DefaultAttribute<?> head = (DefaultAttribute)attributes.get(i);
/*  57 */     if (head == null)
/*     */     {
/*     */ 
/*  60 */       head = new DefaultAttribute();
/*  61 */       DefaultAttribute<T> attr = new DefaultAttribute(head, key);
/*  62 */       head.next = attr;
/*  63 */       attr.prev = head;
...
/*  66 */         return attr;
/*     */       }
/*  68 */       head = (DefaultAttribute)attributes.get(i);
/*     */     }
/*     */     
/*     */ 
...
/*  76 */       if (next == null) {
/*  77 */         DefaultAttribute<T> attr = new DefaultAttribute(head, key);
/*  78 */         curr.next = attr;
/*  79 */         attr.prev = curr;
/*  80 */         return attr;
/*     */       }
...
/*     */     
/* 102 */     int i = index(key);
/* 103 */     DefaultAttribute<?> head = (DefaultAttribute)attributes.get(i);
/* 104 */     if (head == null)
/*     */     {
/* 106 */       return false;
/*     */     }
