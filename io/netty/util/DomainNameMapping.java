...
/*     */   {
/*  65 */     this(new LinkedHashMap(initialCapacity), defaultValue);
/*     */   }
/*     */   
/*     */   DomainNameMapping(Map<String, V> map, V defaultValue) {
/*  69 */     this.defaultValue = ObjectUtil.checkNotNull(defaultValue, "defaultValue");
/*  70 */     this.map = map;
/*  71 */     this.unmodifiableMap = (map != null ? Collections.unmodifiableMap(map) : null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/*  89 */     this.map.put(normalizeHostname((String)ObjectUtil.checkNotNull(hostname, "hostname")), ObjectUtil.checkNotNull(output, "output"));
/*  90 */     return this;
/*     */   }
/*     */   
/*     */ 
...
/* 131 */         if (matches((String)entry.getKey(), hostname)) {
/* 132 */           return (V)entry.getValue();
/*     */         }
/*     */       }
/*     */     }
/* 136 */     return (V)this.defaultValue;
/*     */   }
/*     */   
/*     */ 
/*     */ 
