...
/*     */   
/*     */ 
/*  54 */   private static final Queue<Entry> pendingEntries = new ConcurrentLinkedQueue();
/*  55 */   private static final Watcher watcher = new Watcher(null);
...
/*     */ 
/*     */ 
/*  68 */     threadFactory = new DefaultThreadFactory(poolName, true, 1, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 111 */       Thread watcherThread = threadFactory.newThread(watcher);
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       {
/*     */         public Void run() {
/* 120 */           this.val$watcherThread.setContextClassLoader(null);
/* 121 */           return null;
/*     */         }
/*     */         
/* 124 */       });
/* 125 */       watcherThread.start();
/* 126 */       watcherThread = watcherThread;
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */     }
/*     */     
/* 144 */     Thread watcherThread = watcherThread;
...
/*     */     implements Runnable
/*     */   {
/* 157 */     private final List<ThreadDeathWatcher.Entry> watchees = new ArrayList();
/*     */     
/*     */     public void run()
/*     */     {
/*     */       for (;;) {
...
/*     */       for (;;)
/*     */       {
/* 208 */         ThreadDeathWatcher.Entry e = (ThreadDeathWatcher.Entry)ThreadDeathWatcher.pendingEntries.poll();
/* 209 */         if (e == null) {
/*     */           break;
/*     */         }
/*     */         
/* 213 */         if (e.isWatch) {
/* 214 */           this.watchees.add(e);
/*     */         } else {
...
/* 224 */         ThreadDeathWatcher.Entry e = (ThreadDeathWatcher.Entry)watchees.get(i);
