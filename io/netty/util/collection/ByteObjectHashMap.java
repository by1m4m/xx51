...
/*     */   
/*     */   private int mask;
/*  62 */   private final Set<Byte> keySet = new KeySet(null);
/*  63 */   private final Set<Map.Entry<Byte, V>> entrySet = new EntrySet(null);
/*  64 */   private final Iterable<ByteObjectMap.PrimitiveEntry<V>> entries = new Iterable()
/*     */   {
/*     */     public Iterator<ByteObjectMap.PrimitiveEntry<V>> iterator() {
/*  67 */       return new ByteObjectHashMap.PrimitiveIterator(ByteObjectHashMap.this, null);
/*     */     }
/*     */   };
/*     */   
...
/*     */     {
/*     */ 
/* 151 */       source = (ByteObjectHashMap)sourceMap;
...
/* 163 */       put((Byte)entry.getKey(), entry.getValue());
/*     */     }
/*     */   }
/*     */   
...
/* 224 */         new Iterator() {
/* 225 */           final ByteObjectHashMap<V>.PrimitiveIterator iter = new ByteObjectHashMap.PrimitiveIterator(ByteObjectHashMap.this, null);
/*     */           
...
/*     */     {
/* 522 */       return new ByteObjectHashMap.MapIterator(ByteObjectHashMap.this, null);
/*     */     }
/*     */     
/*     */     public int size()
/*     */     {
...
/* 554 */         ByteObjectMap.PrimitiveEntry<V> entry = (ByteObjectMap.PrimitiveEntry)iter.next();
...
/*     */     public V value()
/*     */     {
/* 650 */       return (V)ByteObjectHashMap.toExternal(ByteObjectHashMap.this.values[this.entryIndex]);
/*     */     }
/*     */     
/*     */     public void setValue(V value)
/*     */     {
/* 655 */       ByteObjectHashMap.this.values[this.entryIndex] = ByteObjectHashMap.toInternal(value);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */   {
/* 663 */     private final ByteObjectHashMap<V>.PrimitiveIterator iter = new ByteObjectHashMap.PrimitiveIterator(ByteObjectHashMap.this, null);
/*     */     
/*     */     private MapIterator() {}
/*     */     
...
/* 676 */       this.iter.next();
/*     */       
/* 678 */       return new ByteObjectHashMap.MapEntry(ByteObjectHashMap.this, ByteObjectHashMap.PrimitiveIterator.access$1100(this.iter));
/*     */     }
/*     */     
/*     */     public void remove()
/*     */     {
...
/*     */     {
/* 705 */       verifyExists();
/* 706 */       return (V)ByteObjectHashMap.toExternal(ByteObjectHashMap.this.values[this.entryIndex]);
/*     */     }
/*     */     
/*     */     public V setValue(V value)
/*     */     {
/* 711 */       verifyExists();
/* 712 */       V prevValue = ByteObjectHashMap.toExternal(ByteObjectHashMap.this.values[this.entryIndex]);
/* 713 */       ByteObjectHashMap.this.values[this.entryIndex] = ByteObjectHashMap.toInternal(value);
