...
/*     */   
/*     */   private int mask;
/*  62 */   private final Set<Character> keySet = new KeySet(null);
/*  63 */   private final Set<Map.Entry<Character, V>> entrySet = new EntrySet(null);
/*  64 */   private final Iterable<CharObjectMap.PrimitiveEntry<V>> entries = new Iterable()
/*     */   {
/*     */     public Iterator<CharObjectMap.PrimitiveEntry<V>> iterator() {
/*  67 */       return new CharObjectHashMap.PrimitiveIterator(CharObjectHashMap.this, null);
/*     */     }
/*     */   };
/*     */   
...
/*     */     {
/*     */ 
/* 151 */       source = (CharObjectHashMap)sourceMap;
...
/* 163 */       put((Character)entry.getKey(), entry.getValue());
/*     */     }
/*     */   }
/*     */   
...
/* 224 */         new Iterator() {
/* 225 */           final CharObjectHashMap<V>.PrimitiveIterator iter = new CharObjectHashMap.PrimitiveIterator(CharObjectHashMap.this, null);
/*     */           
...
/*     */     {
/* 522 */       return new CharObjectHashMap.MapIterator(CharObjectHashMap.this, null);
/*     */     }
/*     */     
/*     */     public int size()
/*     */     {
...
/* 554 */         CharObjectMap.PrimitiveEntry<V> entry = (CharObjectMap.PrimitiveEntry)iter.next();
...
/*     */     public V value()
/*     */     {
/* 650 */       return (V)CharObjectHashMap.toExternal(CharObjectHashMap.this.values[this.entryIndex]);
/*     */     }
/*     */     
/*     */     public void setValue(V value)
/*     */     {
/* 655 */       CharObjectHashMap.this.values[this.entryIndex] = CharObjectHashMap.toInternal(value);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */   {
/* 663 */     private final CharObjectHashMap<V>.PrimitiveIterator iter = new CharObjectHashMap.PrimitiveIterator(CharObjectHashMap.this, null);
/*     */     
/*     */     private MapIterator() {}
/*     */     
...
/* 676 */       this.iter.next();
/*     */       
/* 678 */       return new CharObjectHashMap.MapEntry(CharObjectHashMap.this, CharObjectHashMap.PrimitiveIterator.access$1100(this.iter));
/*     */     }
/*     */     
/*     */     public void remove()
/*     */     {
...
/*     */     {
/* 705 */       verifyExists();
/* 706 */       return (V)CharObjectHashMap.toExternal(CharObjectHashMap.this.values[this.entryIndex]);
/*     */     }
/*     */     
/*     */     public V setValue(V value)
/*     */     {
/* 711 */       verifyExists();
/* 712 */       V prevValue = CharObjectHashMap.toExternal(CharObjectHashMap.this.values[this.entryIndex]);
/* 713 */       CharObjectHashMap.this.values[this.entryIndex] = CharObjectHashMap.toInternal(value);
