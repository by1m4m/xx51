...
/*     */   
/*     */   private int mask;
/*  62 */   private final Set<Integer> keySet = new KeySet(null);
/*  63 */   private final Set<Map.Entry<Integer, V>> entrySet = new EntrySet(null);
/*  64 */   private final Iterable<IntObjectMap.PrimitiveEntry<V>> entries = new Iterable()
/*     */   {
/*     */     public Iterator<IntObjectMap.PrimitiveEntry<V>> iterator() {
/*  67 */       return new IntObjectHashMap.PrimitiveIterator(IntObjectHashMap.this, null);
/*     */     }
/*     */   };
/*     */   
...
/*     */     {
/*     */ 
/* 151 */       source = (IntObjectHashMap)sourceMap;
...
/* 163 */       put((Integer)entry.getKey(), entry.getValue());
/*     */     }
/*     */   }
/*     */   
...
/* 224 */         new Iterator() {
/* 225 */           final IntObjectHashMap<V>.PrimitiveIterator iter = new IntObjectHashMap.PrimitiveIterator(IntObjectHashMap.this, null);
/*     */           
...
/*     */     {
/* 522 */       return new IntObjectHashMap.MapIterator(IntObjectHashMap.this, null);
/*     */     }
/*     */     
/*     */     public int size()
/*     */     {
...
/* 554 */         IntObjectMap.PrimitiveEntry<V> entry = (IntObjectMap.PrimitiveEntry)iter.next();
...
/*     */     public V value()
/*     */     {
/* 650 */       return (V)IntObjectHashMap.toExternal(IntObjectHashMap.this.values[this.entryIndex]);
/*     */     }
/*     */     
/*     */     public void setValue(V value)
/*     */     {
/* 655 */       IntObjectHashMap.this.values[this.entryIndex] = IntObjectHashMap.toInternal(value);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */   {
/* 663 */     private final IntObjectHashMap<V>.PrimitiveIterator iter = new IntObjectHashMap.PrimitiveIterator(IntObjectHashMap.this, null);
/*     */     
/*     */     private MapIterator() {}
/*     */     
...
/* 676 */       this.iter.next();
/*     */       
/* 678 */       return new IntObjectHashMap.MapEntry(IntObjectHashMap.this, IntObjectHashMap.PrimitiveIterator.access$1100(this.iter));
/*     */     }
/*     */     
/*     */     public void remove()
/*     */     {
...
/*     */     {
/* 705 */       verifyExists();
/* 706 */       return (V)IntObjectHashMap.toExternal(IntObjectHashMap.this.values[this.entryIndex]);
/*     */     }
/*     */     
/*     */     public V setValue(V value)
/*     */     {
/* 711 */       verifyExists();
/* 712 */       V prevValue = IntObjectHashMap.toExternal(IntObjectHashMap.this.values[this.entryIndex]);
/* 713 */       IntObjectHashMap.this.values[this.entryIndex] = IntObjectHashMap.toInternal(value);
