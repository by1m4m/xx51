...
/*     */   
/*     */   private int mask;
/*  62 */   private final Set<Long> keySet = new KeySet(null);
/*  63 */   private final Set<Map.Entry<Long, V>> entrySet = new EntrySet(null);
/*  64 */   private final Iterable<LongObjectMap.PrimitiveEntry<V>> entries = new Iterable()
/*     */   {
/*     */     public Iterator<LongObjectMap.PrimitiveEntry<V>> iterator() {
/*  67 */       return new LongObjectHashMap.PrimitiveIterator(LongObjectHashMap.this, null);
/*     */     }
/*     */   };
/*     */   
...
/*     */     {
/*     */ 
/* 151 */       source = (LongObjectHashMap)sourceMap;
...
/* 163 */       put((Long)entry.getKey(), entry.getValue());
/*     */     }
/*     */   }
/*     */   
...
/* 224 */         new Iterator() {
/* 225 */           final LongObjectHashMap<V>.PrimitiveIterator iter = new LongObjectHashMap.PrimitiveIterator(LongObjectHashMap.this, null);
/*     */           
...
/*     */     {
/* 522 */       return new LongObjectHashMap.MapIterator(LongObjectHashMap.this, null);
/*     */     }
/*     */     
/*     */     public int size()
/*     */     {
...
/* 554 */         LongObjectMap.PrimitiveEntry<V> entry = (LongObjectMap.PrimitiveEntry)iter.next();
...
/*     */     public V value()
/*     */     {
/* 650 */       return (V)LongObjectHashMap.toExternal(LongObjectHashMap.this.values[this.entryIndex]);
/*     */     }
/*     */     
/*     */     public void setValue(V value)
/*     */     {
/* 655 */       LongObjectHashMap.this.values[this.entryIndex] = LongObjectHashMap.toInternal(value);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */   {
/* 663 */     private final LongObjectHashMap<V>.PrimitiveIterator iter = new LongObjectHashMap.PrimitiveIterator(LongObjectHashMap.this, null);
/*     */     
/*     */     private MapIterator() {}
/*     */     
...
/* 676 */       this.iter.next();
/*     */       
/* 678 */       return new LongObjectHashMap.MapEntry(LongObjectHashMap.this, LongObjectHashMap.PrimitiveIterator.access$1100(this.iter));
/*     */     }
/*     */     
/*     */     public void remove()
/*     */     {
...
/*     */     {
/* 705 */       verifyExists();
/* 706 */       return (V)LongObjectHashMap.toExternal(LongObjectHashMap.this.values[this.entryIndex]);
/*     */     }
/*     */     
/*     */     public V setValue(V value)
/*     */     {
/* 711 */       verifyExists();
/* 712 */       V prevValue = LongObjectHashMap.toExternal(LongObjectHashMap.this.values[this.entryIndex]);
/* 713 */       LongObjectHashMap.this.values[this.entryIndex] = LongObjectHashMap.toInternal(value);
