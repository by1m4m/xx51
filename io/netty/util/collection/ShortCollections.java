...
/*     */ {
/*  29 */   private static final ShortObjectMap<Object> EMPTY_MAP = new EmptyMap(null);
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 223 */         this.entries = new Iterable()
/*     */         {
/*     */           public Iterator<ShortObjectMap.PrimitiveEntry<V>> iterator() {
/* 226 */             return new ShortCollections.UnmodifiableMap.IteratorImpl(ShortCollections.UnmodifiableMap.this, ShortCollections.UnmodifiableMap.this.map.entries().iterator());
/*     */           }
/*     */         };
/*     */       }
/*     */       
...
/*     */         }
/* 278 */         return new ShortCollections.UnmodifiableMap.EntryImpl(ShortCollections.UnmodifiableMap.this, (ShortObjectMap.PrimitiveEntry)this.iter.next());
/*     */       }
/*     */       
/*     */       public void remove()
/*     */       {
