...
/*  38 */   private final GenericFutureListener<Future<?>> listener = new GenericFutureListener()
/*     */   {
/*     */     public void operationComplete(Future<?> future) throws Exception {
/*  41 */       PromiseCombiner.access$004(PromiseCombiner.this);
...
/* 119 */     this.aggregatePromise = ((Promise)ObjectUtil.checkNotNull(aggregatePromise, "aggregatePromise"));
