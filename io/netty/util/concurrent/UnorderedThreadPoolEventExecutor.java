...
/*     */   {
/* 102 */     return new DefaultPromise(this);
/*     */   }
/*     */   
/*     */   public <V> ProgressivePromise<V> newProgressivePromise()
/*     */   {
/* 107 */     return new DefaultProgressivePromise(this);
/*     */   }
/*     */   
/*     */   public <V> Future<V> newSucceededFuture(V result)
/*     */   {
/* 112 */     return new SucceededFuture(this, result);
/*     */   }
/*     */   
/*     */   public <V> Future<V> newFailedFuture(Throwable cause)
/*     */   {
/* 117 */     return new FailedFuture(this, cause);
/*     */   }
/*     */   
...
/*     */   {
/* 163 */     return (runnable instanceof NonNotifyRunnable) ? task : new RunnableScheduledFutureTask(this, runnable, task);
/*     */   }
/*     */   
/*     */ 
/*     */   protected <V> RunnableScheduledFuture<V> decorateTask(Callable<V> callable, RunnableScheduledFuture<V> task)
/*     */   {
/* 169 */     return new RunnableScheduledFutureTask(this, callable, task);
/*     */   }
/*     */   
...
/*     */   {
/* 179 */     return (ScheduledFuture)super.schedule(callable, delay, unit);
/*     */   }
/*     */   
...
/*     */   {
/* 199 */     return (Future)super.submit(task, result);
/*     */   }
/*     */   
/*     */   public <T> Future<T> submit(Callable<T> task)
/*     */   {
/* 204 */     return (Future)super.submit(task);
/*     */   }
/*     */   
