...
/*     */   public long rp2;
/*     */   
/*  61 */   public static InternalThreadLocalMap getIfSet() { Thread thread = Thread.currentThread();
/*  62 */     if ((thread instanceof FastThreadLocalThread)) {
/*  63 */       return ((FastThreadLocalThread)thread).threadLocalMap();
/*     */     }
/*  65 */     return (InternalThreadLocalMap)slowThreadLocalMap.get(); }
/*     */   
/*     */   public long rp3;
/*     */   public long rp4;
/*  69 */   public static InternalThreadLocalMap get() { Thread thread = Thread.currentThread();
...
/*  87 */     InternalThreadLocalMap ret = (InternalThreadLocalMap)slowThreadLocalMap.get();
/*  88 */     if (ret == null) {
...
/*     */   public long rp8;
/*     */   public long rp9;
/* 126 */   private InternalThreadLocalMap() { super(newIndexedVariableTable()); }
/*     */   
/*     */ 
...
/* 198 */     if (cache == null) {
/* 199 */       this.charsetEncoderCache = (cache = new IdentityHashMap());
/*     */     }
/* 201 */     return cache;
/*     */   }
/*     */   
...
/* 206 */     if (cache == null) {
/* 207 */       this.charsetDecoderCache = (cache = new IdentityHashMap());
/*     */     }
/* 209 */     return cache;
/*     */   }
/*     */   
...
/*     */   {
/* 218 */     ArrayList<E> list = this.arrayList;
/* 219 */     if (list == null) {
/* 220 */       this.arrayList = new ArrayList(minCapacity);
/* 221 */       return this.arrayList;
/*     */     }
/* 223 */     list.clear();
...
/* 246 */     if (cache == null) {
/* 247 */       this.typeParameterMatcherGetCache = (cache = new IdentityHashMap());
/*     */     }
/* 249 */     return cache;
/*     */   }
/*     */   
...
/* 254 */     if (cache == null) {
/* 255 */       this.typeParameterMatcherFindCache = (cache = new IdentityHashMap());
/*     */     }
/* 257 */     return cache;
/*     */   }
/*     */   
...
/* 270 */     if (cache == null)
/*     */     {
/* 272 */       this.handlerSharableCache = (cache = new WeakHashMap(4));
/*     */     }
/* 274 */     return cache;
/*     */   }
/*     */   
