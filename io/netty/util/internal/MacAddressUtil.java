...
/*     */   {
/*  49 */     byte[] bestMacAddr = EmptyArrays.EMPTY_BYTES;
/*  50 */     InetAddress bestInetAddr = NetUtil.LOCALHOST4;
/*     */     
/*     */ 
/*  53 */     Map<NetworkInterface, InetAddress> ifaces = new LinkedHashMap();
/*     */     try {
...
/*  58 */           NetworkInterface iface = (NetworkInterface)interfaces.nextElement();
/*     */           
...
/*  74 */       NetworkInterface iface = (NetworkInterface)entry.getKey();
/*  75 */       InetAddress inetAddr = (InetAddress)entry.getValue();
...
/* 125 */       break;
/*     */     default: 
/* 127 */       bestMacAddr = Arrays.copyOf(bestMacAddr, 8);
/*     */     }
/*     */     
...
/*     */     case 17: 
/* 159 */       char separator = value.charAt(2);
/* 160 */       validateMacSeparator(separator);
/* 161 */       machineId = new byte[6];
/* 162 */       break;
/*     */     case 23: 
/* 164 */       char separator = value.charAt(2);
...
/* 173 */     int j = 0;
/* 174 */     for (int i = 0; i < end; j += 3) {
/* 175 */       int sIndex = j + 2;
/* 176 */       machineId[i] = StringUtil.decodeHexByte(value, j);
/* 177 */       if (value.charAt(sIndex) != separator)
/*     */       {
/* 179 */         throw new IllegalArgumentException("expected separator '" + separator + " but got '" + value.charAt(sIndex) + "' at index: " + sIndex);
/*     */       }
/* 174 */       i++;
/*     */     }
/*     */     
