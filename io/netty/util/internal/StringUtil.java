...
/*     */   static
/*     */   {
/*  30 */     NEWLINE = SystemPropertyUtil.get("line.separator", "\n");
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*  39 */     BYTE2HEX_PAD = new String['Ā'];
/*  40 */     BYTE2HEX_NOPAD = new String['Ā'];
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 192 */     for (int i = offset; i < endMinusOne; i++) {
/* 193 */       if (src[i] != 0) {
/*     */         break;
/*     */       }
/*     */     }
...
/*     */   {
/* 284 */     String className = ((Class)ObjectUtil.checkNotNull(clazz, "clazz")).getName();
...
/*     */   {
/* 315 */     int length = ((CharSequence)ObjectUtil.checkNotNull(value, "value")).length();
/*     */     int last;
/*     */     int start;
/* 318 */     int last; if (trimWhiteSpace) {
/* 319 */       int start = indexOfFirstNonOwsChar(value, length);
...
/*     */   {
/* 401 */     int length = ((CharSequence)ObjectUtil.checkNotNull(value, "value")).length();
/* 402 */     if (length == 0) {
/* 403 */       return value;
/*     */     }
...
/*     */   {
/* 438 */     List<CharSequence> unescaped = new ArrayList(2);
