...
/*     */     
/*  40 */     TypeParameterMatcher matcher = (TypeParameterMatcher)getCache.get(parameterType);
/*  41 */     if (matcher == null) {
...
/*     */     
/*  60 */     Map<String, TypeParameterMatcher> map = (Map)findCache.get(thisClass);
/*  61 */     if (map == null) {
/*  62 */       map = new HashMap();
/*  63 */       findCache.put(thisClass, map);
/*     */     }
/*     */     
/*  66 */     TypeParameterMatcher matcher = (TypeParameterMatcher)map.get(typeParamName);
/*  67 */     if (matcher == null) {
