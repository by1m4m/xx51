...
/* 123 */       this.logger.log(FQCN, this.traceCapable ? Level.TRACE : Level.DEBUG, ft
...
/* 148 */       this.logger.log(FQCN, this.traceCapable ? Level.TRACE : Level.DEBUG, ft
...
/* 171 */       this.logger.log(FQCN, this.traceCapable ? Level.TRACE : Level.DEBUG, ft
