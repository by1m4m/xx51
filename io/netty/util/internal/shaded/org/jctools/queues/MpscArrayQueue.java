...
/* 252 */     UnsafeRefArrayAccess.soElement(this.buffer, offset, e);
/* 253 */     return true;
/*     */   }
/*     */   
/*     */ 
...
/* 306 */     UnsafeRefArrayAccess.soElement(this.buffer, offset, e);
/* 307 */     return true;
/*     */   }
/*     */   
/*     */ 
...
/* 349 */     UnsafeRefArrayAccess.soElement(this.buffer, offset, e);
/* 350 */     return 0;
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/*     */ 
/* 371 */     E e = UnsafeRefArrayAccess.lvElement(buffer, offset);
/* 372 */     if (null == e)
/*     */     {
/*     */ 
/*     */ 
...
/*     */         do
/*     */         {
/* 383 */           e = UnsafeRefArrayAccess.lvElement(buffer, offset);
/*     */         }
/* 385 */         while (e == null);
/*     */       }
/*     */       else
...
/*     */     }
/*     */     
/* 393 */     UnsafeRefArrayAccess.spElement(buffer, offset, null);
...
/* 415 */     E e = UnsafeRefArrayAccess.lvElement(buffer, offset);
/* 416 */     if (null == e)
/*     */     {
/*     */ 
/*     */ 
...
/*     */         do
/*     */         {
/* 427 */           e = UnsafeRefArrayAccess.lvElement(buffer, offset);
/*     */         }
/* 429 */         while (e == null);
/*     */       }
/*     */       else
...
/*     */     
/*     */ 
/* 453 */     E e = UnsafeRefArrayAccess.lvElement(buffer, offset);
/* 454 */     if (null == e)
/*     */     {
/* 456 */       return null;
/*     */     }
/*     */     
/* 459 */     UnsafeRefArrayAccess.spElement(buffer, offset, null);
...
/* 470 */     return (E)UnsafeRefArrayAccess.lvElement(buffer, calcElementOffset(cIndex, mask));
/*     */   }
/*     */   
/*     */ 
...
/* 508 */       E e = UnsafeRefArrayAccess.lvElement(buffer, offset);
/* 509 */       if (null == e)
/*     */       {
/* 511 */         return i;
/*     */       }
/* 513 */       UnsafeRefArrayAccess.spElement(buffer, offset, null);
...
/* 556 */       UnsafeRefArrayAccess.soElement(buffer, offset, s.get());
/*     */     }
...
/* 574 */         E e = UnsafeRefArrayAccess.lvElement(buffer, offset);
/* 575 */         if (null == e)
/*     */         {
...
/* 580 */           cIndex += 1L;
/* 581 */           counter = 0;
/* 582 */           UnsafeRefArrayAccess.spElement(buffer, offset, null);
