...
/* 119 */       return 0;
/*     */     }
/* 121 */     LinkedQueueAtomicNode<E> tail = newNode(s.get());
/* 122 */     LinkedQueueAtomicNode<E> head = tail;
/* 123 */     for (int i = 1; i < limit; i++) {
/* 124 */       LinkedQueueAtomicNode<E> temp = newNode(s.get());
...
/* 139 */         LinkedQueueAtomicNode<E> nextNode = newNode(s.get());
