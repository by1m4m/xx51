...
/*     */   
/*  25 */   LZ4HCJavaSafeCompressor() { this(9); }
/*     */   
/*  27 */   LZ4HCJavaSafeCompressor(int compressionLevel) { this.maxAttempts = (1 << compressionLevel - 1);
...
/*  47 */       int v = SafeUtils.readInt(bytes, off);
...
/*  66 */       int v = SafeUtils.readInt(bytes, off);
/*  67 */       addHash(v, off);
/*     */     }
/*     */     
...
/* 111 */         if (LZ4SafeUtils.readIntEquals(buf, ref, off)) {
/* 112 */           delta = off - ref;
/* 113 */           repl = match.len = 4 + LZ4SafeUtils.commonBytes(buf, ref + 4, off + 4, matchLimit);
/* 114 */           match.ref = ref;
/*     */         }
/* 116 */         ref = next(ref);
/*     */       }
/*     */       
/* 119 */       for (int i = 0; i < LZ4HCJavaSafeCompressor.this.maxAttempts; i++) {
/* 120 */         if ((ref < Math.max(this.base, off - 65536 + 1)) || (ref > off)) {
/*     */           break;
/*     */         }
/* 123 */         if (LZ4SafeUtils.readIntEquals(buf, ref, off)) {
/* 124 */           int matchLen = 4 + LZ4SafeUtils.commonBytes(buf, ref + 4, off + 4, matchLimit);
...
/* 142 */           this.hashTable[LZ4Utils.hashHC(SafeUtils.readInt(buf, ptr))] = ptr;
/* 143 */           ptr++;
/* 144 */         } while (ptr < end);
...
/* 158 */       for (int i = 0; i < LZ4HCJavaSafeCompressor.this.maxAttempts; i++) {
/* 159 */         if ((ref < Math.max(this.base, off - 65536 + 1)) || (ref > off)) {
/*     */           break;
/*     */         }
/* 162 */         if (LZ4SafeUtils.readIntEquals(buf, ref, off)) {
/* 163 */           int matchLenForward = 4 + LZ4SafeUtils.commonBytes(buf, ref + 4, off + 4, matchLimit);
/* 164 */           int matchLenBackward = LZ4SafeUtils.commonBytesBackward(buf, ref, off, this.base, startLimit);
...
/*     */       }
/*     */       
/* 198 */       for (int i = 0; i < LZ4HCJavaSafeCompressor.this.maxAttempts; i++) {
...
/* 237 */       for (int i = 0; i < LZ4HCJavaSafeCompressor.this.maxAttempts; i++) {
