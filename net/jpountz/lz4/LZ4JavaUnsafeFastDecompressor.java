...
/*     */     for (;;)
/*     */     {
/*  40 */       int token = UnsafeUtils.readByte(src, sOff) & 0xFF;
/*  41 */       sOff++;
/*     */       
/*     */ 
...
/*  45 */       if (literalLen == 15) {
/*  46 */         byte len = -1;
/*  47 */         while ((len = UnsafeUtils.readByte(src, sOff++)) == -1) {
/*  48 */           literalLen += 255;
/*     */         }
...
/*     */       
/*     */ 
/*  72 */       int matchDec = UnsafeUtils.readShortLE(src, sOff);
/*  73 */       sOff += 2;
...
/*  81 */       if (matchLen == 15) {
/*  82 */         byte len = -1;
/*  83 */         while ((len = UnsafeUtils.readByte(src, sOff++)) == -1) {
/*  84 */           matchLen += 255;
/*     */         }
