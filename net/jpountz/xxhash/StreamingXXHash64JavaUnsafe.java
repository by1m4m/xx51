...
/*  37 */       long v4 = this.v4;
/*     */       
/*  39 */       long h64 = Long.rotateLeft(v1, 1) + Long.rotateLeft(v2, 7) + Long.rotateLeft(v3, 12) + Long.rotateLeft(v4, 18);
/*     */       
...
/*  67 */       h64 ^= (UnsafeUtils.readIntLE(this.memory, off) & 0xFFFFFFFF) * -7046029288634856825L;
