...
/*     */       do {
/*  35 */         v1 += SafeUtils.readIntLE(buf, off) * -2048144777;
/*  36 */         v1 = Integer.rotateLeft(v1, 13);
/*  37 */         v1 *= -1640531535;
/*  38 */         off += 4;
/*     */         
/*  40 */         v2 += SafeUtils.readIntLE(buf, off) * -2048144777;
/*  41 */         v2 = Integer.rotateLeft(v2, 13);
/*  42 */         v2 *= -1640531535;
/*  43 */         off += 4;
/*     */         
/*  45 */         v3 += SafeUtils.readIntLE(buf, off) * -2048144777;
/*  46 */         v3 = Integer.rotateLeft(v3, 13);
/*  47 */         v3 *= -1640531535;
/*  48 */         off += 4;
/*     */         
/*  50 */         v4 += SafeUtils.readIntLE(buf, off) * -2048144777;
...
/*     */     
/*  63 */     while (off <= end - 4) {
/*  64 */       h32 += SafeUtils.readIntLE(buf, off) * -1028477379;
/*  65 */       h32 = Integer.rotateLeft(h32, 17) * 668265263;
/*  66 */       off += 4;
/*     */     }
/*     */     
/*  69 */     while (off < end) {
/*  70 */       h32 += (SafeUtils.readByte(buf, off) & 0xFF) * 374761393;
