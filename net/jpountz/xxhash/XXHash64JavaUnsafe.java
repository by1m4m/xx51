...
/*     */       do {
/*  35 */         v1 += UnsafeUtils.readLongLE(buf, off) * -4417276706812531889L;
/*  36 */         v1 = Long.rotateLeft(v1, 31);
/*  37 */         v1 *= -7046029288634856825L;
/*  38 */         off += 8;
/*     */         
/*  40 */         v2 += UnsafeUtils.readLongLE(buf, off) * -4417276706812531889L;
/*  41 */         v2 = Long.rotateLeft(v2, 31);
/*  42 */         v2 *= -7046029288634856825L;
/*  43 */         off += 8;
/*     */         
/*  45 */         v3 += UnsafeUtils.readLongLE(buf, off) * -4417276706812531889L;
/*  46 */         v3 = Long.rotateLeft(v3, 31);
/*  47 */         v3 *= -7046029288634856825L;
/*  48 */         off += 8;
/*     */         
/*  50 */         v4 += UnsafeUtils.readLongLE(buf, off) * -4417276706812531889L;
...
/*     */     
/*  75 */     while (off <= end - 8) {
/*  76 */       long k1 = UnsafeUtils.readLongLE(buf, off);
...
/*     */     
/*  82 */     if (off <= end - 4) {
/*  83 */       h64 ^= (UnsafeUtils.readIntLE(buf, off) & 0xFFFFFFFF) * -7046029288634856825L;
/*  84 */       h64 = Long.rotateLeft(h64, 23) * -4417276706812531889L + 1609587929392839161L;
/*  85 */       off += 4;
/*     */     }
/*     */     
/*  88 */     while (off < end) {
/*  89 */       h64 ^= (UnsafeUtils.readByte(buf, off) & 0xFF) * 2870177450012600261L;
