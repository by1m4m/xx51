...
/*     */ 
/*     */ 
/*  97 */   private static byte[] base64Alphabet = new byte['ÿ'];
...
/*     */     }
/* 105 */     for (int i = 90; i >= 65; i--) {
/* 106 */       base64Alphabet[i] = ((byte)(i - 65));
/*     */     }
/* 108 */     for (int i = 122; i >= 97; i--) {
/* 109 */       base64Alphabet[i] = ((byte)(i - 97 + 26));
/*     */     }
/* 111 */     for (int i = 57; i >= 48; i--) {
...
/*     */     }
/*     */     
/* 122 */     int i = 26; for (int j = 0; i <= 51; j++) {
/* 123 */       lookUpBase64Alphabet[i] = ((byte)(97 + j));i++;
/*     */     }
/*     */     
/* 126 */     int i = 52; for (int j = 0; i <= 61; j++) {
/* 127 */       lookUpBase64Alphabet[i] = ((byte)(48 + j));i++;
/*     */     }
/*     */     
...
/*     */     
/* 260 */     byte k = 0;byte l = 0;byte b1 = 0;byte b2 = 0;byte b3 = 0;
/*     */     
...
/* 278 */       k = (byte)(b1 & 0x3);
/*     */       
/* 280 */       byte val1 = (b1 & 0xFFFFFF80) == 0 ? (byte)(b1 >> 2) : (byte)(b1 >> 2 ^ 0xC0);
/*     */       
/* 282 */       byte val2 = (b2 & 0xFFFFFF80) == 0 ? (byte)(b2 >> 4) : (byte)(b2 >> 4 ^ 0xF0);
/*     */       
/* 284 */       byte val3 = (b3 & 0xFFFFFF80) == 0 ? (byte)(b3 >> 6) : (byte)(b3 >> 6 ^ 0xFC);
/*     */       
/*     */ 
...
/*     */       
/*     */ 
/* 326 */       byte val1 = (b1 & 0xFFFFFF80) == 0 ? (byte)(b1 >> 2) : (byte)(b1 >> 2 ^ 0xC0);
/*     */       
...
/* 337 */       k = (byte)(b1 & 0x3);
/*     */       
/* 339 */       byte val1 = (b1 & 0xFFFFFF80) == 0 ? (byte)(b1 >> 2) : (byte)(b1 >> 2 ^ 0xC0);
/*     */       
/* 341 */       byte val2 = (b2 & 0xFFFFFF80) == 0 ? (byte)(b2 >> 4) : (byte)(b2 >> 4 ^ 0xF0);
/*     */       
/*     */ 
...
/* 383 */     byte b1 = 0;byte b2 = 0;byte b3 = 0;byte b4 = 0;byte marker0 = 0;byte marker1 = 0;
/*     */     
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\org\apache\commons\codec\binary\Base64.class
