...
/*   46 */   private static final String[] SILENT_START = { "GN", "KN", "PN", "WR", "PS" };
/*      */   
/*   48 */   private static final String[] L_R_N_M_B_H_F_V_W_SPACE = { "L", "R", "N", "M", "B", "H", "F", "V", "W", " " };
/*      */   
/*   50 */   private static final String[] ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER = { "ES", "EP", "EB", "EL", "EY", "IB", "IL", "IN", "IE", "EI", "ER" };
/*      */   
/*   52 */   private static final String[] L_T_K_S_N_M_B_Z = { "L", "T", "K", "S", "N", "M", "B", "Z" };
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 1032 */     private StringBuffer primary = new StringBuffer(DoubleMetaphone.this.getMaxCodeLen());
/* 1033 */     private StringBuffer alternate = new StringBuffer(DoubleMetaphone.this.getMaxCodeLen());
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\org\apache\commons\codec\language\DoubleMetaphone.class
