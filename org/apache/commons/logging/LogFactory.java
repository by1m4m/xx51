...
/*      */     throws LogConfigurationException
/*      */   {
/*  859 */     (ClassLoader)AccessController.doPrivileged(new PrivilegedAction()
/*      */     {
/*      */       public Object run() {
...
/*      */   {
/* 1355 */     (InputStream)AccessController.doPrivileged(new PrivilegedAction() { private final ClassLoader val$loader;
...
/*      */   {
/* 1383 */     PrivilegedAction action = new PrivilegedAction() {
/*      */       private final ClassLoader val$loader;
/*      */       private final String val$name;
/*      */       
/* 1387 */       public Object run() { try { if (this.val$loader != null) {
...
/*      */       
/*      */       public Object run() {
/* 1424 */         try { InputStream stream = this.val$url.openStream();
/* 1425 */           if (stream != null) {
...
/*      */   {
/* 1558 */     (String)AccessController.doPrivileged(new PrivilegedAction() { private final String val$key;
...
/* 1612 */       String classLoaderName; if (thisClassLoader == null) {
...
/* 1714 */       logDiagnostic("[ENV] Security forbids determining the classloader for " + className); return;
/*      */     }
/*      */     
/*      */     ClassLoader classLoader;
/*      */     
...
/* 1745 */       logDiagnostic(prefix + "Security forbids determining the system classloader."); return;
/*      */     }
/*      */     
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\org\apache\commons\logging\LogFactory.class
