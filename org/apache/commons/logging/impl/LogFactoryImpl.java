...
/*      */     throws LogConfigurationException
/*      */   {
/*  664 */     (ClassLoader)AccessController.doPrivileged(new PrivilegedAction()
/*      */     {
/*      */       public Object run() {
...
/*      */   {
/*  683 */     (String)AccessController.doPrivileged(new PrivilegedAction() { private final String val$key;
...
/*      */     try
/*      */     {
/*  700 */       (ClassLoader)AccessController.doPrivileged(new PrivilegedAction() {
...
/* 1066 */           URL url; URL url; if (currentCL != null) {
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\org\apache\commons\logging\impl\LogFactoryImpl.class
