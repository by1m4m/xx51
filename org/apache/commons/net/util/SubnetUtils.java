...
/*     */     
/*     */ 
/*  98 */     private int netmask() { return SubnetUtils.this.netmask; }
/*  99 */     private int network() { return SubnetUtils.this.network; }
/* 100 */     private int address() { return SubnetUtils.this.address; }
/* 101 */     private int broadcast() { return SubnetUtils.this.broadcast; }
/*     */     
/*     */ 
/* 104 */     private long networkLong() { return SubnetUtils.this.network & 0xFFFFFFFF; }
/* 105 */     private long broadcastLong() { return SubnetUtils.this.broadcast & 0xFFFFFFFF; }
/*     */     
/*     */     private int low() {
/* 108 */       return broadcastLong() - networkLong() > 1L ? network() + 1 : SubnetUtils.this.isInclusiveHostCount() ? network() : 0;
/*     */     }
/*     */     
/*     */     private int high()
/*     */     {
/* 113 */       return broadcastLong() - networkLong() > 1L ? broadcast() - 1 : SubnetUtils.this.isInclusiveHostCount() ? broadcast() : 0;
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 135 */       long addLong = address & 0xFFFFFFFF;
/* 136 */       long lowLong = low() & 0xFFFFFFFF;
/* 137 */       long highLong = high() & 0xFFFFFFFF;
/* 138 */       return (addLong >= lowLong) && (addLong <= highLong);
/*     */     }
/*     */     
/*     */     public String getBroadcastAddress() {
/* 142 */       return SubnetUtils.this.format(SubnetUtils.access$500(SubnetUtils.this, broadcast()));
/*     */     }
/*     */     
/*     */     public String getNetworkAddress() {
/* 146 */       return SubnetUtils.this.format(SubnetUtils.access$500(SubnetUtils.this, network()));
/*     */     }
/*     */     
/*     */     public String getNetmask() {
/* 150 */       return SubnetUtils.this.format(SubnetUtils.access$500(SubnetUtils.this, netmask()));
/*     */     }
/*     */     
/*     */     public String getAddress() {
/* 154 */       return SubnetUtils.this.format(SubnetUtils.access$500(SubnetUtils.this, address()));
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 164 */       return SubnetUtils.this.format(SubnetUtils.access$500(SubnetUtils.this, low()));
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 174 */       return SubnetUtils.this.format(SubnetUtils.access$500(SubnetUtils.this, high()));
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/* 203 */       long count = b - n + (SubnetUtils.this.isInclusiveHostCount() ? 1 : -1);
...
/* 212 */       return SubnetUtils.this.toCidrNotation(SubnetUtils.access$600(SubnetUtils.this, SubnetUtils.access$500(SubnetUtils.this, address())), SubnetUtils.access$600(SubnetUtils.this, SubnetUtils.access$500(SubnetUtils.this, netmask())));
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */       }
/* 224 */       int add = low(); for (int j = 0; add <= high(); j++) {
/* 225 */         addresses[j] = SubnetUtils.this.format(SubnetUtils.access$500(SubnetUtils.this, add));add++;
/*     */       }
...
/*     */   {
/* 252 */     return new SubnetInfo(null);
/*     */   }
/*     */   
/*     */ 
