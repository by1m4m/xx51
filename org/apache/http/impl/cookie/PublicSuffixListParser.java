...
/*     */     throws IOException
/*     */   {
/*  66 */     Collection<String> rules = new ArrayList();
/*  67 */     Collection<String> exceptions = new ArrayList();
...
/*  74 */       if ((line.length() != 0) && 
/*  75 */         (!line.startsWith("//"))) {
/*  76 */         if (line.startsWith(".")) { line = line.substring(1);
/*     */         }
...
/* Location:              C:\Users\Lab\Desktop\a.jar!\org\apache\http\impl\cookie\PublicSuffixListParser.class
